...
const getConfigTelemetryDesc = () => {
  ...
  return _i18n.i18n.translate('telemetry.telemetryConfigDescription', {
    defaultMessage: 'Help us improve the OpenSearch Stack by providing usage statistics for basic features. We will not share this data outside of Elastic.'
  });
};
/**
...
const PATH_TO_ADVANCED_SETTINGS = 'management/opensearch-dashboards/settings';
/**
