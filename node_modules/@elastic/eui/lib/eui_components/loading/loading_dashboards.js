...
exports.EuiLoadingDashboards = exports.SIZES = void 0;
...
var EuiLoadingDashboards = function EuiLoadingDashboards(_ref) {
  var _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'm' : _ref$size,
      className = _ref.className,
      rest = _objectWithoutProperties(_ref, ["size", "className"]);

  var classes = (0, _classnames.default)('euiLoadingDashboards', sizeToClassNameMap[size], className);
...
exports.EuiLoadingDashboards = EuiLoadingDashboards;
EuiLoadingDashboards.propTypes = {
