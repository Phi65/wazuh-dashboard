...
var OuiToolTip = /*#__PURE__*/function (_Component) {
  _inherits(OuiToolTip, _Component);
  ...
  function OuiToolTip() {
    ...
    _classCallCheck(this, OuiToolTip);
  ...
  _createClass(OuiToolTip, [{
    ...
    value: function render() {
      ...
      if (visible && (content || title)) {
        tooltip = /*#__PURE__*/_react.default.createElement(_portal.OuiPortal, null, /*#__PURE__*/_react.default.createElement(_tool_tip_popover.OuiToolTipPopover, _extends({
          className: classes,
          style: toolTipStyles,
...
_defineProperty(OuiToolTip, "defaultProps", {
  position: 'top',
  delay: 'regular'
});
