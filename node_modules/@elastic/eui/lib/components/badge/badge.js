...
exports.OuiBadge = exports.ICON_SIDES = exports.COLORS = void 0;
...
var _badge = require("../../eui_components/badge/badge");
...
var visColors = (0, _services.ouiPaletteColorBlindBehindText)();
var colorToHexMap = {
...
var OuiBadge = function OuiBadge(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiBadge', {
  ...
  var closeClassNames = (0, _classnames.default)('ouiBadge__icon', closeButtonProps && closeButtonProps.className);
  ...
  if (iconType) {
    if (iconOnClick) {
      if (!iconOnClickAriaLabel) {
        console.warn('When passing the iconOnClick props to OuiBadge, you must also provide iconOnClickAriaLabel');
      }
      ...
      optionalIcon = /*#__PURE__*/_react.default.createElement("button", {
        ...
        onClick: iconOnClick
      }, /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, _extends({
        type: iconType,
        size: "s",
      ...
      optionalIcon = /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
        type: iconType,
        size: children ? 's' : 'm',
  ...
  if (onClick && !onClickAriaLabel) {
    console.warn('When passing onClick to OuiBadge, you must also provide onClickAriaLabel');
  }
  ...
  if (iconOnClick) {
    ...
    }), optionalIcon)) : /*#__PURE__*/_react.default.createElement(_inner_text.OuiInnerText, null, function (ref, innerText) {
...
function handleInvalidColor(color) {
  ...
  if (!isNamedColor && !isValidColorString) {
    console.warn('OuiBadge expects a valid color. This can either be a three or six ' + "character hex value, rgb(a) value, hsv value, hollow, or one of the following: ".concat(COLORS, ". ") + "Instead got ".concat(color, "."));
  }
}
