...
exports.OuiPage = exports.DIRECTIONS = exports.SIZES = void 0;
...
var _page = require("../../eui_components/page/page");
...
var OuiPage = function OuiPage(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiPage', paddingSizeToClassNameMap[paddingSize], directionToClassNameMap[direction], _defineProperty({
    'ouiPage--grow': grow
  }, "ouiPage--".concat(widthClassName), widthClassName), className);
