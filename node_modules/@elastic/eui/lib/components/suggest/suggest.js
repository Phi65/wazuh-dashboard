...
var OuiSuggest = function OuiSuggest(props) {
  ...
  var suggestionList = suggestions.map(function (item, index) {
    ...
    return /*#__PURE__*/_react.default.createElement(_suggest_item.OuiSuggestItem, _extends({
      key: index
    }, props));
  });

  var suggestInput = /*#__PURE__*/_react.default.createElement(_suggest_input.OuiSuggestInput, _extends({
    status: status,
