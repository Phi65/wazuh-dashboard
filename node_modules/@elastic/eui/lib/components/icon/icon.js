...
exports.OuiIcon = exports.appendIconComponentCache = exports.clearIconComponentCache = exports.SIZES = exports.COLORS = exports.TYPES = void 0;
...
var _icon = require("../../eui_components/icon/icon");
...
var typeToPathMap = {
  ...
  // Undocumented on purpose. Has an extra stroke for OuiColorPicker
  symlink: 'symlink',
...
var OuiIcon = /*#__PURE__*/function (_PureComponent) {
  _inherits(OuiIcon, _PureComponent);

  var _super = _createSuper(OuiIcon);

  function OuiIcon(props) {
    var _this;

    _classCallCheck(this, OuiIcon);
  ...
  _createClass(OuiIcon, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiIcon', sizeToClassNameMap[size], optionalColorClass, {
