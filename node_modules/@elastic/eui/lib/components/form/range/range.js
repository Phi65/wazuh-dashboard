...
var _range = require("../../../eui_components/form/range/range");
...
var OuiRange = /*#__PURE__*/function (_Component) {
  _inherits(OuiRange, _Component);

  var _super = _createSuper(OuiRange);

  function OuiRange() {
    var _this;

    _classCallCheck(this, OuiRange);
  ...
  _createClass(OuiRange, [{
    ...
    value: function render() {
      ...
      var theInput = !!showInput ? /*#__PURE__*/_react.default.createElement(_range_input.OuiRangeInput, _extends({
        id: id,
        min: min,
        max: max,
      ...
      var classes = (0, _classnames.default)('ouiRange', {
      ...
      }), showValue && !!String(value).length && /*#__PURE__*/_react.default.createElement(_range_tooltip.OuiRangeTooltip, {
        compressed: compressed,
        value: value,
        max: max,
        min: min,
...
exports.OuiRange = OuiRange;

_defineProperty(OuiRange, "defaultProps", {
  min: 0,
  max: 100,
  step: 1,
  fullWidth: false,
