...
var OuiCheckboxGroup = function OuiCheckboxGroup(_ref) {
  ...
  var checkboxes = options.map(function (option, index) {
    ...
    return /*#__PURE__*/_react.default.createElement(_checkbox.OuiCheckbox, _extends({
  ...
  if (!!legend) {
    ...
    return /*#__PURE__*/_react.default.createElement(_form_fieldset.OuiFormFieldset, _extends({
      className: className,
      legend: legend
    }, rest), checkboxes);
  }
