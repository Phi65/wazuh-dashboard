...
var _field_text = require("../../../eui_components/form/field_text/field_text");
...
var OuiFieldText = function OuiFieldText(_ref) {
  var id = _ref.id,
      name = _ref.name,
  ...
  var classes = (0, _classnames.default)('ouiFieldText', className, {
...
exports.OuiFieldText = OuiFieldText;
OuiFieldText.propTypes = {
