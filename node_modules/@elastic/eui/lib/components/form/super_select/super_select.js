...
var OuiSuperSelect = /*#__PURE__*/function (_Component) {
  _inherits(OuiSuperSelect, _Component);
  ...
  function OuiSuperSelect() {
    ...
    _classCallCheck(this, OuiSuperSelect);
  ...
  _createClass(OuiSuperSelect, [{
    ...
    value: function render() {
      ...
      var button = /*#__PURE__*/_react.default.createElement(_super_select_control.OuiSuperSelectControl, _extends({
        options: options,
      ...
      var items = options.map(function (option, index) {
        ...
        return /*#__PURE__*/_react.default.createElement(_context_menu.OuiContextMenuItem, _extends({
          key: index,
...
_defineProperty(OuiSuperSelect, "defaultProps", {
  hasDividers: false,
  fullWidth: false,
  compressed: false,
  isInvalid: false,
