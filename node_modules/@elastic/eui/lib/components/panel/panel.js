...
exports.OuiPanel = exports.COLORS = exports.BORDER_RADII = exports.SIZES = exports.panelPaddingValues = void 0;
...
var _panel = require("../../eui_components/panel/panel");
...
var OuiPanel = function OuiPanel(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiPanel', paddingSizeToClassNameMap[paddingSize], borderRadiusToClassNameMap[borderRadius], "ouiPanel--".concat(color), {
