...
var _breadcrumbs = require("../../eui_components/breadcrumbs/breadcrumbs");
...
var limitBreadcrumbs = function limitBreadcrumbs(breadcrumbs, max, allBreadcrumbs) {
  ...
  var OuiBreadcrumbCollapsed = function OuiBreadcrumbCollapsed() {
    ...
    }, /*#__PURE__*/_react.default.createElement(OuiBreadcrumbs, {
...
var OuiBreadcrumbs = function OuiBreadcrumbs(_ref) {
  ...
  var breadcrumbElements = breadcrumbs.map(function (breadcrumb, index) {
    ...
    var breadcrumbClasses = (0, _classnames.default)('ouiBreadcrumb', breadcrumbClassName, {
    ...
    if (!href && !onClick) {
      link = /*#__PURE__*/_react.default.createElement(_inner_text.OuiInnerText, null, function (ref, innerText) {
      ...
      link = /*#__PURE__*/_react.default.createElement(_inner_text.OuiInnerText, null, function (ref, innerText) {
        return /*#__PURE__*/_react.default.createElement(_link.OuiLink, _extends({
          ref: ref,
    ...
    if (!isLastBreadcrumb) {
      separator = /*#__PURE__*/_react.default.createElement(OuiBreadcrumbSeparator, null);
    }
  ...
  var classes = (0, _classnames.default)('ouiBreadcrumbs', className, {
...
exports.OuiBreadcrumbs = OuiBreadcrumbs;
