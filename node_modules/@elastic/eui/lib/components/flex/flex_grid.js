...
exports.OuiFlexGrid = exports.COLUMNS = exports.GUTTER_SIZES = exports.DIRECTIONS = void 0;
...
var _flex_grid = require("../../eui_components/flex/flex_grid");
...
var OuiFlexGrid = function OuiFlexGrid(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiFlexGrid', gutterSize ? gutterSizeToClassNameMap[gutterSize] : undefined, columns != null ? columnsToClassNameMap[columns] : undefined, direction ? directionToClassNameMap[direction] : undefined, {
...
exports.OuiFlexGrid = OuiFlexGrid;
