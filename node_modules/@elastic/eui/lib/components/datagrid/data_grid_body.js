...
exports.OuiDataGridBody = exports.VIRTUALIZED_CONTAINER_CLASS = void 0;
...
var _data_grid_body = require("../../eui_components/datagrid/data_grid_body");
...
var VIRTUALIZED_CONTAINER_CLASS = 'ouiDataGrid__virtualized';
...
var providedPopoverContents = {
  json: function json(_ref) {
    ...
    return /*#__PURE__*/_react.default.createElement(_code.OuiCodeBlock, {
      isCopyable: true,
...
var DefaultColumnFormatter = function DefaultColumnFormatter(_ref2) {
  ...
  return /*#__PURE__*/_react.default.createElement(_text.OuiText, null, children);
};
...
var Cell = function Cell(_ref3) {
  ...
  var classes = (0, _classnames.default)(_defineProperty({
    ...
    'ouiDataGridRowCell--controlColumn': isLeadingControlColumn || isTrailingControlColumn
  }, "ouiDataGridRowCell--".concat(textTransform), textTransform));

  if (isLeadingControlColumn) {
    var leadingColumn = leadingControlColumns[columnIndex];
    var id = leadingColumn.id,
        rowCellRender = leadingColumn.rowCellRender;
    cellContent = /*#__PURE__*/_react.default.createElement(_data_grid_cell.OuiDataGridCell, {
      rowIndex: rowIndex,
...
var OuiDataGridBody = function OuiDataGridBody(props) {
  ...
  var headerRow = (0, _react.useMemo)(function () {
    return /*#__PURE__*/_react.default.createElement(_data_grid_header_row.OuiDataGridHeaderRow, {
      ref: setHeaderRowRef,
  ...
  var footerRow = (0, _react.useMemo)(function () {
    ...
    return /*#__PURE__*/_react.default.createElement(_data_grid_footer_row.OuiDataGridFooterRow, {
      ref: setFooterRowRef,
      leadingControlColumns: leadingControlColumns,
      trailingControlColumns: trailingControlColumns,
      columns: columns,
  ...
  var preventTabbing = (0, _react.useCallback)(function () {
    if (wrapperRef.current) {
      ...
      for (var i = 0; i < tabbables.length; i++) {
        ...
        if (element.getAttribute('role') !== 'gridcell' && !element.dataset['ouigrid-tab-managed']) {
  ...
  return /*#__PURE__*/_react.default.createElement(_mutation_observer.OuiMutationObserver, {
    observerOptions: {
      subtree: true,
      childList: true
    },
...
exports.OuiDataGridBody = OuiDataGridBody;
OuiDataGridBody.propTypes = {
