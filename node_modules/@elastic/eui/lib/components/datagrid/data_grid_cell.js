...
var OuiDataGridCell = /*#__PURE__*/function (_Component) {
  _inherits(OuiDataGridCell, _Component);
  ...
  function OuiDataGridCell() {
    ...
    _classCallCheck(this, OuiDataGridCell);
  ...
  _createClass(OuiDataGridCell, [{
    ...
    value: function render() {
      ...
      var cellClasses = (0, _classnames.default)('ouiDataGridRowCell', (_classNames = {}, _defineProperty(_classNames, "ouiDataGridRowCell--".concat(columnType), columnType), _defineProperty(_classNames, 'ouiDataGridRowCell--open', this.state.popoverIsOpen), _classNames), className);
...
_defineProperty(OuiDataGridCell, "contextType", _data_grid_context.DataGridFocusContext);
