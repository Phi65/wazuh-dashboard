...
var OuiGlobalToastList = /*#__PURE__*/function (_Component) {
  _inherits(OuiGlobalToastList, _Component);
  ...
  function OuiGlobalToastList() {
    ...
    _classCallCheck(this, OuiGlobalToastList);
  ...
  _createClass(OuiGlobalToastList, [{
    ...
    value: function render() {
      ...
      var renderedToasts = toasts.map(function (toast) {
        ...
        }, /*#__PURE__*/_react.default.createElement(_toast.OuiToast, _extends({
...
_defineProperty(OuiGlobalToastList, "defaultProps", {
  toasts: [],
  side: 'right'
});
