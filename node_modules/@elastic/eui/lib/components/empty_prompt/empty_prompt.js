...
var _empty_prompt = require("../../eui_components/empty_prompt/empty_prompt");
...
var OuiEmptyPrompt = function OuiEmptyPrompt(_ref) {
  var icon = _ref.icon,
  ...
  var classes = (0, _classnames.default)('ouiEmptyPrompt', className);
  var iconNode;

  if (icon) {
    iconNode = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, icon, /*#__PURE__*/_react.default.createElement(_spacer.OuiSpacer, {
      size: "m"
    }));
  } else if (iconType) {
    iconNode = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
      type: iconType,
      size: "xxl",
      color: iconColor
  ...
  if (body || title) {
    if (title) {
      titleNode = /*#__PURE__*/_react.default.createElement(_title.OuiTitle, {
        size: titleSize
      }, title);
    }

    if (body) {
      bodyNode = /*#__PURE__*/_react.default.createElement(_text.OuiTextColor, {
        color: "subdued"
      }, title && /*#__PURE__*/_react.default.createElement(_spacer.OuiSpacer, {
        size: "m"
      }), /*#__PURE__*/_react.default.createElement(_text.OuiText, null, body));
    }
  }
  ...
  if (actions) {
    ...
    if (Array.isArray(actions)) {
      actionsRow = /*#__PURE__*/_react.default.createElement(_flex.OuiFlexGroup, {
        gutterSize: "m",
        alignItems: "center",
    ...
    actionsNode = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_spacer.OuiSpacer, {
      size: "l"
    }), actionsRow);
  }
...
exports.OuiEmptyPrompt = OuiEmptyPrompt;
OuiEmptyPrompt.propTypes = {
