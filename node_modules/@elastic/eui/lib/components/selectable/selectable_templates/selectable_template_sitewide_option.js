...
var ouiSelectableTemplateSitewideFormatOptions = function ouiSelectableTemplateSitewideFormatOptions(options) {
  return options.map(function (item) {
    ...
    return _objectSpread(_objectSpread({
      ...
      prepend: item.icon ? /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, _extends({
        color: "subdued",
        size: "l"
      }, item.icon)) : item.prepend,
      append: item.avatar ? /*#__PURE__*/_react.default.createElement(_avatar.OuiAvatar, _extends({
        type: "space",
        size: "s"
...
function renderOptionMeta(meta) {
  ...
  var metas = meta.map(function (meta) {
    ...
    return /*#__PURE__*/_react.default.createElement(_highlight.OuiHighlight, _extends({
