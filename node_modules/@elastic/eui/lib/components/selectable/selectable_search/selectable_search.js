...
var OuiSelectableSearch = /*#__PURE__*/function (_Component) {
  _inherits(OuiSelectableSearch, _Component);
  ...
  function OuiSelectableSearch(props) {
    ...
    _classCallCheck(this, OuiSelectableSearch);
  ...
  _createClass(OuiSelectableSearch, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_form.OuiFieldSearch, _extends({
        className: classes,
...
_defineProperty(OuiSelectableSearch, "defaultProps", {
  defaultValue: ''
});
