...
var OuiSelectableListItem = /*#__PURE__*/function (_Component) {
  _inherits(OuiSelectableListItem, _Component);

  var _super = _createSuper(OuiSelectableListItem);

  function OuiSelectableListItem(props) {
    _classCallCheck(this, OuiSelectableListItem);

    return _super.call(this, props);
  }

  _createClass(OuiSelectableListItem, [{
    key: "render",
    value: function render() {
      ...
      if (append || !!onFocusBadge) {
        ...
        if (onFocusBadge === true) {
          onFocusBadgeNode = /*#__PURE__*/_react.default.createElement(_badge.OuiBadge, _extends({
...
_defineProperty(OuiSelectableListItem, "defaultProps", {
  showIcons: true,
  onFocusBadge: true
});
