...
var OuiSelectableList = /*#__PURE__*/function (_Component) {
  _inherits(OuiSelectableList, _Component);

  var _super = _createSuper(OuiSelectableList);

  _createClass(OuiSelectableList, [{
  ...
  function OuiSelectableList(props) {
    ...
    _classCallCheck(this, OuiSelectableList);
    ...
    _defineProperty(_assertThisInitialized(_this), "ListRow", /*#__PURE__*/(0, _react.memo)(function (_ref) {
      ...
      return /*#__PURE__*/_react.default.createElement(_selectable_list_item.OuiSelectableListItem, _extends({
...
_defineProperty(OuiSelectableList, "defaultProps", {
  rowHeight: 32,
  searchValue: ''
});
