...
Object.defineProperty(exports, "EuiNotificationEventReadButton", {
  enumerable: true,
  get: function get() {
    return _notification_event_read_button.EuiNotificationEventReadButton;
  }
});
exports.OuiNotificationEventReadButton = void 0;
...
var _notification_event_read_button = require("../../eui_components/notification/notification_event_read_button");
...
var OuiNotificationEventReadButton = function OuiNotificationEventReadButton(_ref) {
  var id = _ref.id,
      isRead = _ref.isRead,
  ...
  var classesReadState = (0, _classnames.default)('ouiNotificationEventReadButton', {
    'ouiNotificationEventReadButton--isRead': isRead
  });
  var markAsReadAria = (0, _i18n.useOuiI18n)('ouiNotificationEventReadButton.markAsReadAria', 'Mark {eventName} as read', {
    eventName: eventName
  });
  var markAsUnreadAria = (0, _i18n.useOuiI18n)('ouiNotificationEventReadButton.markAsUnreadAria', 'Mark {eventName} as unread', {
    eventName: eventName
  });
  var markAsRead = (0, _i18n.useOuiI18n)('ouiNotificationEventReadButton.markAsRead', 'Mark as read');
  var markAsUnread = (0, _i18n.useOuiI18n)('ouiNotificationEventReadButton.markAsUnread', 'Mark as unread');
...
exports.OuiNotificationEventReadButton = OuiNotificationEventReadButton;
