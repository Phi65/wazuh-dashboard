...
exports.OuiButtonIcon = exports.SIZES = exports.COLORS = exports.DISPLAYS = void 0;
...
var _button_icon = require("../../../eui_components/button/button_icon/button_icon");
...
var OuiButtonIcon = function OuiButtonIcon(_ref) {
  ...
  if (!rest['aria-label'] && !rest['aria-labelledby'] && !isAriaHidden) {
    console.warn("OuiButtonIcon requires aria-label or aria-labelledby to be specified because icon-only\n      buttons are screen-reader-inaccessible without them.");
  }

  var classes = (0, _classnames.default)('ouiButtonIcon', {
...
exports.OuiButtonIcon = OuiButtonIcon;
OuiButtonIcon.propTypes = {
