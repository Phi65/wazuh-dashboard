...
exports.OuiAccordion = exports.PADDING_SIZES = void 0;
...
var _accordion = require("../../eui_components/accordion/accordion");
...
var OuiAccordion = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiAccordion, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiAccordion', {
      ...
      var buttonClasses = (0, _classnames.default)('ouiAccordion__button', {
      ...
      var iconClasses = (0, _classnames.default)('ouiAccordion__icon', {
        'ouiAccordion__icon-isOpen': isOpen
      });
      var iconWrapperClasses = (0, _classnames.default)('ouiAccordion__iconWrapper', {
        ouiAccordion__iconButton: extraAction && arrowDisplay === 'right'
      });
      var baseIcon;

      if (arrowDisplay !== 'none') {
        baseIcon = /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
      ...
      if (extraAction && !isLoading) {
        ...
        optionalAction = /*#__PURE__*/_react.default.createElement("div", {
          className: "ouiAccordion__optionalAction"
        }, /*#__PURE__*/_react.default.createElement(_loading.OuiLoadingSpinner, null));
      }

      var childrenContent;

      if (isLoading && isLoadingMessage) {
        childrenContent = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_loading.OuiLoadingSpinner, {
          className: "ouiAccordion__spinner"
        }), /*#__PURE__*/_react.default.createElement("span", null, isLoadingMessage && isLoadingMessage !== true ? isLoadingMessage : /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
      ...
      return /*#__PURE__*/_react.default.createElement("div", _extends({
        ...
        className: (0, _classnames.default)('ouiIEFlexWrapFix', buttonContentClassName)
...
exports.OuiAccordion = OuiAccordion;
