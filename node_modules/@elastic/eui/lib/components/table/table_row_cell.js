...
exports.OuiTableRowCell = void 0;
...
var _table_row_cell = require("../../eui_components/table/table_row_cell");
...
var OuiTableRowCell = function OuiTableRowCell(_ref) {
  ...
  var cellClasses = (0, _classnames.default)('ouiTableRowCell', {
  ...
  var mobileContentClasses = (0, _classnames.default)('ouiTableCellContent', className, {
    'ouiTableCellContent--alignRight': mobileOptions.align === _services.RIGHT_ALIGNMENT || align === _services.RIGHT_ALIGNMENT,
    'ouiTableCellContent--alignCenter': mobileOptions.align === _services.CENTER_ALIGNMENT || align === _services.RIGHT_ALIGNMENT,
  ...
  var hideForMobileClasses = 'ouiTableRowCell--hideForMobile';
  var showForMobileClasses = 'ouiTableRowCell--hideForDesktop';
  ...
  if (mobileOptions.show === false || hideForMobile) {
    ...
    return /*#__PURE__*/_react.default.createElement(Element, _extends({
      ...
      className: "ouiTableRowCell__mobileHeader ".concat(showForMobileClasses)
...
exports.OuiTableRowCell = OuiTableRowCell;
