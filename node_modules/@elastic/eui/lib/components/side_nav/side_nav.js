  ...
  function OuiSideNav() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderTree", function (items) {
      ...
      return items.map(function (item) {
        ...
        return /*#__PURE__*/_react.default.createElement(_side_nav_item.OuiSideNavItem, _extends({
          isOpen: isOpen,
    ...
    value: function render() {
      ...
      if (hasHeader) {
        ...
        if (headingScreenReaderOnly) {
          ...
          headingNode = /*#__PURE__*/_react.default.createElement(_title.OuiTitle, _extends({
            size: "xs"
          }, titleProps, {
