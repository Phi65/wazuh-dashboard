...
var OuiPopover = /*#__PURE__*/function (_Component) {
  _inherits(OuiPopover, _Component);

  var _super = _createSuper(OuiPopover);

  _createClass(OuiPopover, null, [{
  ...
  function OuiPopover(props) {
    ...
    _classCallCheck(this, OuiPopover);
    ...
    value: function render() {
      ...
      if (!this.state.suppressingPopover && (isOpen || this.state.isClosing)) {
        ...
        panel = /*#__PURE__*/_react.default.createElement(_portal.OuiPortal, {
          insert: insert
        }, /*#__PURE__*/_react.default.createElement(_focus_trap.OuiFocusTrap, _extends({
        ...
        }), /*#__PURE__*/_react.default.createElement(_panel.OuiPanel, _extends({}, panelProps, {
...
_defineProperty(OuiPopover, "defaultProps", {
  isOpen: false,
  ownFocus: true,
