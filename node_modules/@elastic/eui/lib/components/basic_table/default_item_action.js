...
var DefaultItemAction = function DefaultItemAction(_ref) {
  ...
  if (action.type === 'icon') {
    ...
    button = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_button.OuiButtonIcon, {
      className: className,
    ...
    }), /*#__PURE__*/_react.default.createElement(_accessibility2.OuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("span", {
      id: ariaLabelId
    }, actionContent)));
  } else {
  ...
  return enabled && action.description ? /*#__PURE__*/_react.default.createElement(_tool_tip.OuiToolTip, {
