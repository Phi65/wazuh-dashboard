...
exports.OuiComboBoxInput = void 0;
...
var _combo_box_input = require("../../../eui_components/combo_box/combo_box_input/combo_box_input");
...
var OuiComboBoxInput = /*#__PURE__*/function (_Component) {
  _inherits(OuiComboBoxInput, _Component);

  var _super = _createSuper(OuiComboBoxInput);

  function OuiComboBoxInput() {
    var _this;

    _classCallCheck(this, OuiComboBoxInput);
  ...
  _createClass(OuiComboBoxInput, [{
    ...
    value: function render() {
      ...
      var pills = selectedOptions ? selectedOptions.map(function (option) {
        ...
        return /*#__PURE__*/_react.default.createElement(_combo_box_pill.OuiComboBoxPill, _extends({
          option: option,
          onClose: pillOnClose,
      ...
      if (this.state.hasFocus) {
        ...
        removeOptionMessage = /*#__PURE__*/_react.default.createElement(_accessibility.OuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("span", {
          "aria-live": "assertive",
      ...
      if (placeholder && selectedOptions && !selectedOptions.length && !searchValue) {
        placeholderMessage = /*#__PURE__*/_react.default.createElement("p", {
          className: "ouiComboBoxPlaceholder"
        }, placeholder);
      }
      ...
      if (!!iconProp) {
        var iconClasses = (0, _classnames.default)('ouiComboBoxPill', 'ouiComboBoxIcon');
        icon = /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
      ...
      var wrapClasses = (0, _classnames.default)('ouiComboBox__inputWrap', {
      ...
      return /*#__PURE__*/_react.default.createElement(_form_control_layout.OuiFormControlLayout, _extends({
      ...
      }, icon, !singleSelection || !searchValue ? pills : null, placeholderMessage, /*#__PURE__*/_react.default.createElement(_reactInputAutosize.default, {
  ...
  return OuiComboBoxInput;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiComboBoxInput = OuiComboBoxInput;
OuiComboBoxInput.propTypes = {
