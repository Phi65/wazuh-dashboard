...
export var OuiCollapsibleNavGroup = function OuiCollapsibleNavGroup(_ref) {
  ...
  var classes = classNames('ouiCollapsibleNavGroup', backgroundToClassNameMap[background], {
  ...
  var titleContent = title ? /*#__PURE__*/React.createElement(OuiFlexGroup, {
    gutterSize: "m",
    alignItems: "center",
    responsive: false
  }, iconType && /*#__PURE__*/React.createElement(OuiFlexItem, {
    grow: false
  }, /*#__PURE__*/React.createElement(OuiIcon, _extends({}, iconProps, {
    type: iconType,
    size: iconSize
  }))), /*#__PURE__*/React.createElement(OuiFlexItem, null, /*#__PURE__*/React.createElement(OuiTitle, {
    size: titleSize
  ...
  if (isCollapsible && title) {
    return /*#__PURE__*/React.createElement(OuiAccordion, _extends({
      id: groupID,
      className: classes,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiCollapsibleNavGroup } from '../../../eui_components/collapsible_nav/collapsible_nav_group/collapsible_nav_group';