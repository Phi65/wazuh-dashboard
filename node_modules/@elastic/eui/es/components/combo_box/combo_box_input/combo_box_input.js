...
import { OuiFormControlLayout } from '../../form/form_control_layout';
import { OuiIcon } from '../../icon';
import { OuiComboBoxPill } from './combo_box_pill';
import { htmlIdGenerator } from '../../../services';
export var OuiComboBoxInput = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiComboBoxInput, [{
    ...
    value: function render() {
      ...
      var pills = selectedOptions ? selectedOptions.map(function (option) {
        ...
        return /*#__PURE__*/React.createElement(OuiComboBoxPill, _extends({
          option: option,
          onClose: pillOnClose,
      ...
      if (this.state.hasFocus) {
        ...
        removeOptionMessage = /*#__PURE__*/React.createElement(OuiScreenReaderOnly, null, /*#__PURE__*/React.createElement("span", {
          "aria-live": "assertive",
      ...
      if (!!iconProp) {
        var iconClasses = classNames('ouiComboBoxPill', 'ouiComboBoxIcon');
        icon = /*#__PURE__*/React.createElement(OuiIcon, {
      ...
      var wrapClasses = classNames('ouiComboBox__inputWrap', {
      ...
      }, icon, !singleSelection || !searchValue ? pills : null, placeholderMessage, /*#__PURE__*/React.createElement(AutosizeInput, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiComboBoxInput } from '../../../eui_components/combo_box/combo_box_input/combo_box_input';