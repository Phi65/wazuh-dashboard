...
import { OuiFilterSelectItem } from '../../filter_group/filter_select_item';
import { OuiBadge } from '../../badge/';
var OPTION_CONTENT_CLASSNAME = 'ouiComboBoxOption__content';
var hitEnterBadge = /*#__PURE__*/React.createElement(OuiBadge, {
  className: "ouiComboBoxOption__enterBadge",
  color: "hollow",
  iconType: "returnKey",
  "aria-hidden": "true"
});
export var OuiComboBoxOptionsList = /*#__PURE__*/function (_Component) {
    ...
    _defineProperty(_assertThisInitialized(_this), "ListRow", function (_ref) {
      ...
      if (isGroupLabelOption) {
        return /*#__PURE__*/React.createElement("div", {
          ...
          style: style
        }, /*#__PURE__*/React.createElement(OuiComboBoxTitle, null, label));
      }
      ...
      return /*#__PURE__*/React.createElement(OuiFilterSelectItem, _extends({
        style: style,
      ...
      }, renderOption(option, searchValue, 'ouiComboBoxOption__renderOption')) : /*#__PURE__*/React.createElement(OuiHighlight, {
        search: searchValue,
        className: OPTION_CONTENT_CLASSNAME
  ...
  _createClass(OuiComboBoxOptionsList, [{
    ...
    value: function render() {
      ...
      if (isLoading) {
        emptyStateContent = /*#__PURE__*/React.createElement(OuiFlexGroup, {
          gutterSize: "s",
        ...
        if (onCreateOption && getSelectedOptionForSearchValue) {
          if (delimiter && searchValue.includes(delimiter)) {
            ...
            if (selectedOptionForValue) {
              ...
              emptyStateContent = /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement(OuiI18n, {
      ...
      var emptyState = emptyStateContent ? /*#__PURE__*/React.createElement(OuiText, {
        size: "xs",
      ...
      var classes = classNames('ouiComboBoxOptionsList', 'ouiPopover__panel', 'ouiPopover__panel-isAttached', 'ouiPopover__panel-noArrow', 'ouiPopover__panel-isOpen', "ouiPopover__panel--".concat(position));
      return /*#__PURE__*/React.createElement(OuiPanel, _extends({
        paddingSize: "none",
        hasShadow: false,
        className: classes,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiComboBoxOptionsList } from '../../../eui_components/combo_box/combo_box_options_list/combo_box_options_list';