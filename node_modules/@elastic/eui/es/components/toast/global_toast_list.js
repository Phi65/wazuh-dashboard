...
export var OuiGlobalToastList = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiGlobalToastList, [{
    ...
    value: function render() {
      ...
      var renderedToasts = toasts.map(function (toast) {
        ...
        return /*#__PURE__*/React.createElement(OuiGlobalToastListItem, {
          key: toast.id,
          isDismissed: _this3.state.toastIdToDismissedMap[toast.id]
        }, /*#__PURE__*/React.createElement(OuiToast, _extends({
          onClose: _this3.dismissToast.bind(_this3, toast),
          onFocus: _this3.onMouseEnter,
          onBlur: _this3.onMouseLeave
        }, rest), text));
      });
      var classes = classNames('ouiGlobalToastList', side ? sideToClassNameMap[side] : null, className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiGlobalToastList } from '../../eui_components/toast/global_toast_list';