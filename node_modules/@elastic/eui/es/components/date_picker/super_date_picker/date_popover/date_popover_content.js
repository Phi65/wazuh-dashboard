...
import { OuiTabbedContent } from '../../../tabs';
...
export var OuiDatePopoverContent = function OuiDatePopoverContent(_ref) {
  ...
  var renderTabs = [{
    ...
    name: 'Absolute',
    content: /*#__PURE__*/React.createElement(OuiAbsoluteTab, {
    ...
    name: 'Relative',
    content: /*#__PURE__*/React.createElement(OuiRelativeTab, {
      dateFormat: dateFormat,
      locale: locale,
    ...
    id: DATE_MODES.NOW,
    name: 'Now',
    content: /*#__PURE__*/React.createElement(OuiText, {
      size: "s",
      color: "subdued",
      className: "ouiDatePopoverContent__padded--large"
    }, /*#__PURE__*/React.createElement("p", null, "Setting the time to \"now\" means that on every refresh this time will be set to the time of the refresh."), /*#__PURE__*/React.createElement(OuiButton, {
  ...
  return /*#__PURE__*/React.createElement(OuiTabbedContent, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiDatePopoverContent } from '../../../../eui_components/date_picker/super_date_picker/date_popover/date_popover_content';