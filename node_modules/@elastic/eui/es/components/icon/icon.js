...
export var OuiIcon = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(OuiIcon, [{
    ...
    value: function render() {
      ...
      var classes = classNames('ouiIcon', sizeToClassNameMap[size], optionalColorClass, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiIcon } from '../../eui_components/icon/icon';