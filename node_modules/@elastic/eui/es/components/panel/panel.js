...
export var OuiPanel = function OuiPanel(_ref) {
  ...
  var classes = classNames('ouiPanel', paddingSizeToClassNameMap[paddingSize], borderRadiusToClassNameMap[borderRadius], "ouiPanel--".concat(color), {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiPanel } from '../../eui_components/panel/panel';