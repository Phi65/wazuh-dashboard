...
var highlight = function highlight(searchSubject, searchValue, isStrict, highlightAll) {
  ...
  if (highlightAll) {
    ...
    return /*#__PURE__*/React.createElement(Fragment, null, chunks.map(function (chunk) {
      ...
      if (highlight) {
        return /*#__PURE__*/React.createElement(OuiMark, {
          key: start
        }, value);
      }
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, preMatch, /*#__PURE__*/React.createElement(OuiMark, null, match), postMatch);
};
...
export var OuiHighlight = function OuiHighlight(_ref) {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiHighlight } from '../../eui_components/highlight/highlight';