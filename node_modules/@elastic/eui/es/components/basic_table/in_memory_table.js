...
import { OuiBasicTable } from './basic_table';
...
export var OuiInMemoryTable = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiInMemoryTable, [{
    ...
    value: function renderSearchBar() {
      ...
      if (search) {
        ...
        return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OuiSearchBar, _extends({
          onChange: this.onQueryChange
        }, searchBarProps)), /*#__PURE__*/React.createElement(OuiSpacer, {
          size: "l"
        }));
      }
    }
    ...
    value: function getItems() {
      ...
      var matchingItems = query ? OuiSearchBar.Query.execute(query, items, executeQueryOptions) : items;
    ...
    value: function render() {
      ...
      /*#__PURE__*/
      // @ts-ignore complex relationship between pagination's existence and criteria, the code logic ensures this is correctly maintained
      React.createElement(OuiBasicTable, _extends({
        ref: this.tableRef,
        items: items,
        itemId: itemId,
        rowProps: rowProps,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiInMemoryTable } from '../../eui_components/basic_table/in_memory_table';