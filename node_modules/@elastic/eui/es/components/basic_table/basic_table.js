...
import { OuiTable, OuiTableBody, OuiTableFooter, OuiTableFooterCell, OuiTableHeader, OuiTableHeaderCell, OuiTableHeaderCellCheckbox, OuiTableHeaderMobile, OuiTableRow, OuiTableRowCell, OuiTableRowCellCheckbox, OuiTableSortMobile } from '../table';
...
export var OuiBasicTable = /*#__PURE__*/function (_Component) {
  ...
  function OuiBasicTable(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSelectAll", function (isMobile) {
      ...
      return /*#__PURE__*/React.createElement(OuiI18n, {
        ...
        return /*#__PURE__*/React.createElement(OuiCheckbox, {
  ...
  _createClass(OuiBasicTable, [{
    ...
    value: function render() {
      ...
      var classes = classNames('ouiBasicTable', {
    ...
    value: function renderTable() {
      ...
      var mobileHeader = responsive ? /*#__PURE__*/React.createElement(OuiTableHeaderMobile, null, /*#__PURE__*/React.createElement(OuiFlexGroup, {
        responsive: false,
        justifyContent: "spaceBetween",
        alignItems: "baseline"
      }, /*#__PURE__*/React.createElement(OuiFlexItem, {
        grow: false
      }, this.renderSelectAll(true)), /*#__PURE__*/React.createElement(OuiFlexItem, {
        grow: false
      ...
      return /*#__PURE__*/React.createElement("div", null, mobileHeader, /*#__PURE__*/React.createElement(OuiTable, {
        id: this.tableId,
    ...
    value: function renderTableMobileSort() {
      ...
      return items.length ? /*#__PURE__*/React.createElement(OuiTableSortMobile, {
        items: items
      }) : null;
    }
  }, {
    ...
    value: function renderTableCaption() {
      ...
      if (tableCaption) {
        if (pagination) {
          captionElement = /*#__PURE__*/React.createElement(OuiI18n, {
      ...
      return /*#__PURE__*/React.createElement(OuiScreenReaderOnly, null, /*#__PURE__*/React.createElement("caption", {
        className: "ouiTableCaption"
      }, /*#__PURE__*/React.createElement(OuiDelayRender, null, captionElement)));
    }
  }, {
    key: "renderTableHead",
    value: function renderTableHead() {
      ...
      if (selection) {
        headers.push( /*#__PURE__*/React.createElement(OuiTableHeaderCellCheckbox, {
      ...
      columns.forEach(function (column, index) {
        ...
        if (column.actions) {
          headers.push( /*#__PURE__*/React.createElement(OuiTableHeaderCell, {
        ...
        if (!column.field) {
          ...
          headers.push( /*#__PURE__*/React.createElement(OuiTableHeaderCell, _extends({
      ...
      return /*#__PURE__*/React.createElement(OuiTableHeader, null, headers);
    }
  }, {
    ...
    value: function renderTableFooter() {
      ...
      if (selection) {
        ...
        footers.push( /*#__PURE__*/React.createElement(OuiTableFooterCell, {
      ...
      return footers.length && hasDefinedFooter ? /*#__PURE__*/React.createElement(OuiTableFooter, null, footers) : null;
    }
  }, {
    key: "renderTableBody",
    value: function renderTableBody() {
      ...
      return /*#__PURE__*/React.createElement(OuiTableBody, {
    ...
    value: function renderErrorBody(error) {
      ...
      return /*#__PURE__*/React.createElement(OuiTableBody, null, /*#__PURE__*/React.createElement(OuiTableRow, null, /*#__PURE__*/React.createElement(OuiTableRowCell, {
        align: "center",
        colSpan: colSpan,
    ...
    value: function renderItemRow(item, rowIndex) {
      ...
      var expandedRow = hasExpandedRow ? /*#__PURE__*/React.createElement(OuiTableRow, {
        id: expandedRowId,
        isExpandedRow: true,
        isSelectable: isSelectable
      }, /*#__PURE__*/React.createElement(OuiTableRowCell, {
      ...
      var row = /*#__PURE__*/React.createElement(OuiTableRow, _extends({
      ...
      }, rowProps.onClick ? /*#__PURE__*/React.createElement(OuiKeyboardAccessible, null, row) : row, expandedRow);
    }
  }, {
    ...
    value: function renderItemSelectionCell(itemId, item, selected) {
      ...
      return /*#__PURE__*/React.createElement(OuiTableRowCellCheckbox, {
        key: key
    ...
    value: function renderItemActionsCell(itemId, item, column, columnIndex) {
      ...
      return /*#__PURE__*/React.createElement(OuiTableRowCell, {
        showOnHover: true,
        key: key,
        align: "right",
        textOnly: false,
    ...
    value: function renderItemCell(item, column, key, content, setScopeRow) {
      ...
      return /*#__PURE__*/React.createElement(OuiTableRowCell, _extends({
        key: key,
        align: columnAlign,
    ...
    value: function renderPaginationBar() {
      ...
      if (!error && pagination && pagination.totalItemCount > 0) {
        ...
        if (tableCaption) {
          ariaLabel = /*#__PURE__*/React.createElement(OuiI18n, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiBasicTable } from '../../eui_components/basic_table/basic_table';