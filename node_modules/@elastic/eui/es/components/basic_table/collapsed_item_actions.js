    ...
    value: function render() {
      ...
      var controls = actions.reduce(function (controls, action, index) {
        ...
        if (actionIsCustomItemAction(action)) {
          ...
          controls.push( /*#__PURE__*/React.createElement(OuiContextMenuItem, {
            key: key,
      ...
      var popoverButton = /*#__PURE__*/React.createElement(OuiI18n, {
      ...
      var withTooltip = !allDisabled && /*#__PURE__*/React.createElement(OuiI18n, {
        token: "ouiCollapsedItemActions.allActions",
        default: "All actions"
      }, function (allActions) {
