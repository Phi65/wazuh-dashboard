...
export var DefaultItemAction = function DefaultItemAction(_ref) {
  ...
  if (action.type === 'icon') {
    ...
    button = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OuiButtonIcon, {
      className: className,
  ...
  return enabled && action.description ? /*#__PURE__*/React.createElement(OuiToolTip, {
