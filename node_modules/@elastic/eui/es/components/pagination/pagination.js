...
export var OuiPagination = function OuiPagination(_ref) {
  ...
  var PaginationButton = function PaginationButton(_ref2) {
    ...
    var button = /*#__PURE__*/React.createElement(OuiPaginationButton, _extends({
  ...
  var classes = classNames('ouiPagination', className);
  ...
  var previousButton = /*#__PURE__*/React.createElement(OuiI18n, {
  ...
  if (firstPageInRange > 0) {
    ...
    if (firstPageInRange > 1 && firstPageInRange !== 2) {
      firstPageButtons.push( /*#__PURE__*/React.createElement(OuiI18n, {
  ...
  if (lastPageInRange < pageCount) {
    if (lastPageInRange + 1 === pageCount - 1) {
      ...
      lastPageButtons.push( /*#__PURE__*/React.createElement(OuiI18n, {
        key: "endingEllipses",
  ...
  var nextButton = /*#__PURE__*/React.createElement(OuiI18n, {
  ...
  if (compressed) {
    ...
    return /*#__PURE__*/React.createElement("nav", _extends({
      className: classes
    }, rest), previousButton, /*#__PURE__*/React.createElement(OuiHideFor, {
      sizes: ['xs', 's']
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiPagination } from '../../eui_components/pagination/pagination';