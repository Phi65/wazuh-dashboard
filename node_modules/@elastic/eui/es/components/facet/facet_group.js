...
export var OuiFacetGroup = function OuiFacetGroup(_ref) {
  ...
  var classes = classNames('ouiFacetGroup', layoutToClassNameMap[layout], gutterSizeToClassNameMap[gutterSize], className);
  var direction = layout === 'vertical' ? 'column' : 'row';
  var wrap = layout === 'vertical' ? false : true;
  return /*#__PURE__*/React.createElement(OuiFlexGroup, _extends({
    className: classes,
    direction: direction,
    wrap: wrap,
    gutterSize: "none"
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiFacetGroup } from '../../eui_components/facet/facet_group';