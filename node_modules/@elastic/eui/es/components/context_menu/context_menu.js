...
export var OuiContextMenu = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiContextMenu, [{
    ...
    value: function renderItems() {
      ...
      return items.map(function (item, index) {
        if (isItemSeparator(item)) {
          ...
          return /*#__PURE__*/React.createElement(OuiHorizontalRule, _extends({
            key: _key,
            margin: "none"
          }, _rest));
        }
        ...
        return /*#__PURE__*/React.createElement(OuiContextMenuItem, _extends({
    ...
    value: function renderPanel(panelId, transitionType) {
      ...
      return /*#__PURE__*/React.createElement(OuiContextMenuPanel, {
        key: panelId,
    ...
    value: function render() {
      ...
      var classes = classNames('ouiContextMenu', size && sizeToClassNameMap[size], className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiContextMenu } from '../../eui_components/context_menu/context_menu';