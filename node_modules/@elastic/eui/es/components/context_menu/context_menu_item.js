...
export var OuiContextMenuItem = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiContextMenuItem, [{
    ...
    value: function render() {
      ...
      if (icon) {
        switch (_typeof(icon)) {
          case 'string':
            iconInstance = /*#__PURE__*/React.createElement(OuiIcon, {
              type: icon,
              size: "m",
      ...
      if (hasPanel) {
        arrow = /*#__PURE__*/React.createElement(OuiIcon, {
          type: "arrowRight",
          size: "m",
      ...
      var classes = classNames('ouiContextMenuItem', size && sizeToClassNameMap[size], className, {
        'ouiContextMenuItem-isDisabled': disabled
      });
      var layoutClasses = classNames('ouiContextMenu__itemLayout', layoutAlignToClassNames[layoutAlign]);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiContextMenuItem } from '../../eui_components/context_menu/context_menu_item';