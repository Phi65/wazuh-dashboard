...
export var OuiContextMenuPanel = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiContextMenuPanel, [{
    ...
    value: function render() {
      ...
      if (title) {
        var titleClasses = classNames('ouiContextMenuPanelTitle', size && titleSizeToClassNameMap[size]);
      ...
      var classes = classNames('ouiContextMenuPanel', className, transitionDirection && transitionType && transitionDirectionAndTypeToClassNameMap[transitionDirection] ? transitionDirectionAndTypeToClassNameMap[transitionDirection][transitionType] : undefined);
      var content = items && items.length ? items.map(function (MenuItem, index) {
        ...
        return MenuItem.type === OuiContextMenuItem ? /*#__PURE__*/cloneElement(MenuItem, cloneProps) : MenuItem;
      }) : children;
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiContextMenuPanel } from '../../eui_components/context_menu/context_menu_panel';