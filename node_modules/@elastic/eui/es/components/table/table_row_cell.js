...
export var OuiTableRowCell = function OuiTableRowCell(_ref) {
  ...
  var cellClasses = classNames('ouiTableRowCell', {
  ...
  var mobileContentClasses = classNames('ouiTableCellContent', className, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiTableRowCell } from '../../eui_components/table/table_row_cell';