...
export var OuiTableHeaderCellCheckbox = function OuiTableHeaderCellCheckbox(_ref) {
  ...
  var classes = classNames('ouiTableHeaderCellCheckbox', className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiTableHeaderCellCheckbox } from '../../eui_components/table/table_header_cell_checkbox';