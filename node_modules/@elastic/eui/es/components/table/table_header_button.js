...
export var OuiTableHeaderButton = function OuiTableHeaderButton(_ref) {
  var children = _ref.children,
      className = _ref.className,
      iconType = _ref.iconType,
      rest = _objectWithoutProperties(_ref, ["children", "className", "iconType"]);

  var classes = classNames('ouiTableHeaderButton', className); // Add an icon to the button if one exists.
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    className: classes
  }, rest), /*#__PURE__*/React.createElement(OuiInnerText, null, function (ref, innerText) {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiTableHeaderButton } from '../../eui_components/table/table_header_button';