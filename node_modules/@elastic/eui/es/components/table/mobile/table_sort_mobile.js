...
export var OuiTableSortMobile = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiTableSortMobile, [{
    ...
    value: function render() {
      ...
      var classes = classNames('ouiTableSortMobile', className);
      var mobileSortButton = /*#__PURE__*/React.createElement(OuiButtonEmpty, {
        iconType: "arrowDown",
        iconSide: "right",
      ...
      var mobileSortPopover = /*#__PURE__*/React.createElement(OuiPopover, _extends({
        button: mobileSortButton,
        isOpen: this.state.isPopoverOpen,
        closePopover: this.closePopover,
        anchorPosition: anchorPosition || 'downRight',
        panelPaddingSize: "none"
      }, rest), /*#__PURE__*/React.createElement(OuiContextMenuPanel, {
        style: {
          minWidth: 200
        },
        items: items && items.length ? items.map(function (item) {
          return /*#__PURE__*/React.createElement(OuiTableSortMobileItem, {
            key: item.key,
            onSort: item.onSort,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiTableSortMobile } from '../../../eui_components/table/mobile/table_sort_mobile';