...
export var OuiDataGridControlHeaderCell = function OuiDataGridControlHeaderCell(props) {
  ...
  var HeaderCellRender = controlColumn.headerCellRender,
      ...
      id = controlColumn.id;
  var classes = classnames('ouiDataGridHeaderCell', className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiDataGridControlHeaderCell } from '../../eui_components/datagrid/data_grid_control_header_cell';