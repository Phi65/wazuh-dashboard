...
function renderPagination(props, controls) {
  ...
  return /*#__PURE__*/React.createElement(OuiI18n, {
    ...
    return /*#__PURE__*/React.createElement(OuiI18n, {
      ...
      }, /*#__PURE__*/React.createElement(OuiTablePagination, _extends({
...
export var OuiDataGrid = function OuiDataGrid(props) {
  ...
  var classes = classNames('ouiDataGrid', fontSizesToClassMap[gridStyles.fontSize], bordersToClassMap[gridStyles.border], headerToClassMap[gridStyles.header], footerToClassMap[gridStyles.footer], rowHoverToClassMap[gridStyles.rowHover], cellPaddingsToClassMap[gridStyles.cellPadding], {
  ...
  var controlBtnClasses = classNames('ouiDataGrid__controlBtn', {
  ...
  var fullScreenSelector = /*#__PURE__*/React.createElement(OuiI18n, {
    ...
    return /*#__PURE__*/React.createElement(OuiButtonEmpty, {
      size: "xs",
      iconType: "fullScreen",
      color: "text",
  ...
  var ariaLabel = useOuiI18n('ouiDataGrid.ariaLabel', '{label}; Page {page} of {pageCount}.', {
    label: rest['aria-label'],
    page: pagination ? pagination.pageIndex + 1 : 0,
    pageCount: pagination ? Math.ceil(props.rowCount / pagination.pageSize) : 0
  });
  var ariaLabelledBy = useOuiI18n('ouiDataGrid.ariaLabelledBy', 'Page {page} of {pageCount}.', {
    page: pagination ? pagination.pageIndex + 1 : 0,
    pageCount: pagination ? Math.ceil(props.rowCount / pagination.pageSize) : 0
  ...
  return /*#__PURE__*/React.createElement(DataGridFocusContext.Provider, {
  ...
  }, inMemory ? /*#__PURE__*/React.createElement(OuiDataGridInMemoryRenderer, {
    inMemory: inMemory,
    ...
    role: "grid",
    id: gridId
  }, wrappingDivFocusProps, gridAriaProps), /*#__PURE__*/React.createElement(OuiDataGridBody, {
...
OuiDataGrid.propTypes = {
  ...
  schemaDetectors: PropTypes.arrayOf(PropTypes.shape({
    ...
    /**
       ...
       */
    color: PropTypes.oneOfType([PropTypes.oneOfType([PropTypes.oneOf(["ouiColorVis0", "ouiColorVis1", "ouiColorVis2", "ouiColorVis3", "ouiColorVis4", "ouiColorVis5", "ouiColorVis6", "ouiColorVis7", "ouiColorVis8", "ouiColorVis9", "gray"]).isRequired, PropTypes.string.isRequired]).isRequired, PropTypes.string.isRequired]),
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiDataGrid } from '../../eui_components/datagrid/data_grid';