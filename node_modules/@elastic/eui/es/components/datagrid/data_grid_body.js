...
import { OuiDataGridHeaderRow } from './data_grid_header_row';
import { OuiMutationObserver, useMutationObserver } from '../observer/mutation_observer';
import { OuiText } from '../text';
import { DataGridSortingContext, DataGridWrapperRowsContext } from './data_grid_context';
import { useResizeObserver } from '../observer/resize_observer';
export var VIRTUALIZED_CONTAINER_CLASS = 'ouiDataGrid__virtualized';
...
var providedPopoverContents = {
  json: function json(_ref) {
    ...
    return /*#__PURE__*/React.createElement(OuiCodeBlock, {
      isCopyable: true,
...
var Cell = function Cell(_ref3) {
  ...
  if (isLeadingControlColumn) {
    ...
    cellContent = /*#__PURE__*/React.createElement(OuiDataGridCell, {
      rowIndex: rowIndex,
...
export var OuiDataGridBody = function OuiDataGridBody(props) {
  ...
  var headerRow = useMemo(function () {
    return /*#__PURE__*/React.createElement(OuiDataGridHeaderRow, {
      ref: setHeaderRowRef,
  ...
  var footerRow = useMemo(function () {
    ...
    return /*#__PURE__*/React.createElement(OuiDataGridFooterRow, {
      ref: setFooterRowRef,
      leadingControlColumns: leadingControlColumns,
      trailingControlColumns: trailingControlColumns,
      columns: columns,
  ...
  return /*#__PURE__*/React.createElement(OuiMutationObserver, {
    observerOptions: {
      subtree: true,
      childList: true
    },
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiDataGridBody } from '../../eui_components/datagrid/data_grid_body';