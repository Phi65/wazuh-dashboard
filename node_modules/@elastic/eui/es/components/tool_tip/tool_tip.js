...
export var OuiToolTip = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiToolTip, [{
    ...
    value: function render() {
      ...
      var classes = classNames('ouiToolTip', positionsToClassNameMap[this.state.calculatedPosition], className);
      var anchorClasses = classNames('ouiToolTipAnchor', display ? displayToClassNameMap[display] : null, anchorClassName);
      var tooltip;

      if (visible && (content || title)) {
        tooltip = /*#__PURE__*/React.createElement(OuiPortal, null, /*#__PURE__*/React.createElement(OuiToolTipPopover, _extends({
          className: classes,
          style: toolTipStyles,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiToolTip } from '../../eui_components/tool_tip/tool_tip';