...
export var OuiIconTip = function OuiIconTip(_ref) {
  ...
  return /*#__PURE__*/React.createElement(OuiToolTip, _extends({
    position: position,
    delay: delay
  }, rest), /*#__PURE__*/React.createElement(OuiIcon, _extends({
    tabIndex: 0,
    type: type,
    color: color,
    size: size,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiIconTip } from '../../eui_components/tool_tip/icon_tip';