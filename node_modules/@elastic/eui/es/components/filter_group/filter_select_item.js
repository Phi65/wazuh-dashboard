...
export var OuiFilterSelectItem = /*#__PURE__*/function (_Component) {
  _inherits(OuiFilterSelectItem, _Component);
  ...
  function OuiFilterSelectItem() {
    ...
    _classCallCheck(this, OuiFilterSelectItem);
  ...
  _createClass(OuiFilterSelectItem, [{
    key: "render",
    value: function render() {
      ...
      var classes = classNames('ouiFilterSelectItem', {
      ...
      if (showIcons) {
        ...
        iconNode = /*#__PURE__*/React.createElement(OuiFlexItem, {
          grow: false
...
_defineProperty(OuiFilterSelectItem, "defaultProps", {
  showIcons: true
});
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiFilterSelectItem } from '../../eui_components/filter_group/filter_select_item';