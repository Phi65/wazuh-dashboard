...
export var OuiHealth = function OuiHealth(_ref) {
  ...
  var classes = classNames('ouiHealth', textSize ? sizeToClassNameMap[textSize] : null, className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiHealth } from '../../eui_components/health/health';