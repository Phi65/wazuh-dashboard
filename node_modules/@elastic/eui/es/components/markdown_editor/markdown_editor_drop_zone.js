...
export var OuiMarkdownEditorDropZone = function OuiMarkdownEditorDropZone(props) {
  ...
  var classes = classNames('ouiMarkdownEditorDropZone', {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, getRootProps(), {
    className: classes
  }), children, /*#__PURE__*/React.createElement(OuiMarkdownEditorFooter, {
...
export { EuiMarkdownEditorDropZone } from '../../eui_components/markdown_editor/markdown_editor_drop_zone';