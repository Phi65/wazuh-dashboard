 ...
 * under the License.
 */
export var ouiDragDropReorder = function ouiDragDropReorder(list, startIndex, endIndex) {
...
export var ouiDragDropMove = function ouiDragDropMove(sourceList, destinationList, dropResultSource, dropResultDestination) {
  var _ref;
...
export var ouiDragDropCopy = function ouiDragDropCopy(sourceList, destinationList, dropResultSource, dropResultDestination, idModification) {
  var _ref2;
...
export { euiDragDropReorder, euiDragDropMove, euiDragDropCopy } from '../../eui_components/drag_and_drop/services';