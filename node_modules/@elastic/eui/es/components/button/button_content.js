...
export var OuiButtonContent = function OuiButtonContent(_ref) {
  ...
  if (isLoading) {
    buttonIcon = /*#__PURE__*/React.createElement(OuiLoadingSpinner, {
      className: "ouiButtonContent__spinner",
      size: "m"
    });
  } else if (iconType) {
    buttonIcon = /*#__PURE__*/React.createElement(OuiIcon, {
  ...
  var contentClassNames = classNames('ouiButtonContent', iconSide ? iconSideToClassNameMap[iconSide] : null, contentProps && contentProps.className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiButtonContent } from '../../eui_components/button/button_content';