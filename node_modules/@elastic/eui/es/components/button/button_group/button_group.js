...
export var OuiButtonGroup = function OuiButtonGroup(_ref) {
  ...
  var classes = classNames('ouiButtonGroup', "ouiButtonGroup".concat(groupSizeToClassNameMap[buttonSize]), "ouiButtonGroup".concat(colorToClassNameMap[resolvedColor]), {
  ...
  return /*#__PURE__*/React.createElement("fieldset", _extends({
    ...
    disabled: isDisabled
  }), /*#__PURE__*/React.createElement(OuiScreenReaderOnly, null, /*#__PURE__*/React.createElement("legend", null, legend)), /*#__PURE__*/React.createElement("div", {
    className: "ouiButtonGroup__buttons"
  }, options.map(function (option, index) {
    return /*#__PURE__*/React.createElement(OuiButtonGroupButton, _extends({
      key: index,
      name: nameIfSingle,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiButtonGroup } from '../../../eui_components/button/button_group/button_group';