 ...
 */
var OuiButtonDisplay = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var contentClassNames = classNames('ouiButton__content', contentProps && contentProps.className);
  var textClassNames = classNames('ouiButton__text', textProps && textProps.className);
...
export var OuiButton = function OuiButton(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(OuiButtonDisplay, _extends({
    element: element,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiButton } from '../../eui_components/button/button';