...
export var OuiTabbedContent = /*#__PURE__*/function (_Component) {
  _inherits(OuiTabbedContent, _Component);
  ...
  function OuiTabbedContent(props) {
    ...
    _classCallCheck(this, OuiTabbedContent);
  ...
  _createClass(OuiTabbedContent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", _extends({
        className: className
      }, rest), /*#__PURE__*/React.createElement(OuiTabs, {
        ref: this.tabsRef,
        expand: expand,
        display: display,
        size: size,
        ...
        return /*#__PURE__*/React.createElement(OuiTab, props, name);
...
_defineProperty(OuiTabbedContent, "defaultProps", {
  autoFocus: 'initial'
});
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiTabbedContent } from '../../../eui_components/tabs/tabbed_content/tabbed_content';