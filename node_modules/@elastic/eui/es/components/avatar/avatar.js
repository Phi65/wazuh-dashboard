...
export var OuiAvatar = function OuiAvatar(_ref) {
  ...
  var classes = classNames('ouiAvatar', sizeToClassNameMap[size], typeToClassNameMap[type], {
  ...
  if (!imageUrl && !iconType) {
    ...
    content = /*#__PURE__*/React.createElement(OuiIcon, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiAvatar } from '../../eui_components/avatar/avatar';