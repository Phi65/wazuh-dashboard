...
export var OuiInputPopover = function OuiInputPopover(_ref) {
  ...
  var classes = classnames('ouiInputPopover', {
    'ouiInputPopover--fullWidth': fullWidth
  }, className);
  return /*#__PURE__*/React.createElement(OuiPopover, _extends({
    ownFocus: false,
    button: /*#__PURE__*/React.createElement(OuiResizeObserver, {
      onResize: onResize
    }, function (resizeRef) {
    ...
    panelRef: panelRef,
    className: classes
  }, props), /*#__PURE__*/React.createElement(OuiFocusTrap, {
