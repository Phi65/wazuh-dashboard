...
export var OuiPopover = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiPopover, [{
    ...
    value: function render() {
      ...
      var classes = classNames('ouiPopover', anchorPosition ? anchorPositionToClassNameMap[anchorPosition] : null, display ? displayToClassNameMap[display] : null, {
        'ouiPopover-isOpen': this.state.isOpening
      }, className);
      var anchorClasses = classNames('ouiPopover__anchor', anchorClassName);
      var panelClasses = classNames('ouiPopover__panel', "ouiPopover__panel--".concat(this.state.arrowPosition), {
      ...
      if (!this.state.suppressingPopover && (isOpen || this.state.isClosing)) {
        ...
        if (ownFocus) {
          ...
          focusTrapScreenReaderText = /*#__PURE__*/React.createElement(OuiScreenReaderOnly, null, /*#__PURE__*/React.createElement("p", {
            id: descriptionId
        ...
        var arrowClassNames = classNames('ouiPopover__panelArrow', "ouiPopover__panelArrow--".concat(this.state.arrowPosition));
        var returnFocus = this.state.isOpenStable ? returnFocusConfig : false;
        panel = /*#__PURE__*/React.createElement(OuiPortal, {
          insert: insert
        }, /*#__PURE__*/React.createElement(OuiFocusTrap, _extends({
        ...
        }), /*#__PURE__*/React.createElement(OuiPanel, _extends({}, panelProps, {
        ...
        }, arrowChildren), focusTrapScreenReaderText, /*#__PURE__*/React.createElement(OuiMutationObserver, {
          observerOptions: {
            attributes: true,
      ...
      if (ownFocus) {
        ...
        return /*#__PURE__*/React.createElement(OuiOutsideClickDetector, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiPopover } from '../../eui_components/popover/popover';