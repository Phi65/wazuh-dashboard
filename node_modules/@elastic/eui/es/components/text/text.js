...
export var OuiText = function OuiText(_ref) {
  ...
  var classes = classNames('ouiText', textSizeToClassNameMap[size], className, {
    'ouiText--constrainedWidth': !grow
  });
  var optionallyAlteredText;

  if (color) {
    optionallyAlteredText = /*#__PURE__*/React.createElement(OuiTextColor, {
      color: color,
      component: "div"
    }, children);
  }
  ...
  if (textAlign) {
    optionallyAlteredText = /*#__PURE__*/React.createElement(OuiTextAlign, {
      textAlign: textAlign
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiText } from '../../eui_components/text/text';