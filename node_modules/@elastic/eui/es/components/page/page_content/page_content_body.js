...
export var OuiPageContentBody = function OuiPageContentBody(_ref) {
  ...
  var classes = classNames('ouiPageContentBody', paddingSizeToClassNameMap[paddingSize], _defineProperty({}, "ouiPage--".concat(widthClassName), widthClassName), className);
