...
export var OuiPageHeaderContent = function OuiPageHeaderContent(_ref) {
  ...
  var classes = classNames('ouiPageHeaderContent');
  var descriptionNode;

  if (description) {
    descriptionNode = /*#__PURE__*/React.createElement(React.Fragment, null, (pageTitle || tabs) && /*#__PURE__*/React.createElement(OuiSpacer, null), /*#__PURE__*/React.createElement(OuiText, {
      grow: false
  ...
  if (pageTitle) {
    var icon = iconType ? /*#__PURE__*/React.createElement(OuiIcon, _extends({
      size: "xl"
    }, iconProps, {
      type: iconType,
      className: classNames('ouiPageHeaderContent__titleIcon', iconProps === null || iconProps === void 0 ? void 0 : iconProps.className)
    })) : undefined;
    pageTitleNode = /*#__PURE__*/React.createElement(OuiTitle, {
      size: "l"
  ...
  if (tabs) {
    var renderTabs = function renderTabs() {
      return tabs.map(function (tab, index) {
        ...
        return /*#__PURE__*/React.createElement(OuiTab, _extends({
          key: index
        }, tabRest), label);
      });
    };

    tabsNode = /*#__PURE__*/React.createElement(React.Fragment, null, pageTitleNode && /*#__PURE__*/React.createElement(OuiSpacer, null), /*#__PURE__*/React.createElement(OuiTabs, _extends({}, tabsProps, {
      display: "condensed",
      size: "l"
    }), renderTabs()));
  }

  var childrenNode = children && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OuiSpacer, null), children);
  ...
  if (rightSideItems && rightSideItems.length) {
    ...
    rightSideFlexItem = /*#__PURE__*/React.createElement(OuiFlexItem, {
      grow: false
    }, /*#__PURE__*/React.createElement(OuiFlexGroup, _extends({
      wrap: true,
      responsive: false
    }, rightSideGroupProps, {
      className: classNames('ouiPageHeaderContent__rightSideItems', rightSideGroupProps === null || rightSideGroupProps === void 0 ? void 0 : rightSideGroupProps.className)
    }), wrapWithFlex()));
  }
  ...
  return alignItems === 'top' || isResponsiveBreakpoint ? /*#__PURE__*/React.createElement("div", _extends({
    ...
    gutterSize: "l"
  }, isResponsiveBreakpoint && responsive === 'reverse' ? /*#__PURE__*/React.createElement(React.Fragment, null, rightSideFlexItem, /*#__PURE__*/React.createElement(OuiFlexItem, null, leftSideOrder)) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OuiFlexItem, null, leftSideOrder), rightSideFlexItem)), bottomContentNode) : /*#__PURE__*/React.createElement("div", _extends({
    className: classes
  }, rest), /*#__PURE__*/React.createElement(OuiFlexGroup, {
    responsive: !!responsive,
    className: "ouiPageHeaderContent__top",
    ...
    gutterSize: "l"
  }, /*#__PURE__*/React.createElement(OuiFlexItem, null, leftSideOrder, bottomContentNode), rightSideFlexItem));
};
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiPageHeaderContent } from '../../../eui_components/page/page_header/page_header_content';