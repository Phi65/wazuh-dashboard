...
export var OuiPageHeader = function OuiPageHeader(_ref) {
  ...
  var classes = classNames('ouiPageHeader', paddingSizeToClassNameMap[paddingSize], _defineProperty({
  ...
  return /*#__PURE__*/React.createElement("header", _extends({
    className: classes,
    style: newStyle || style
  }, rest), /*#__PURE__*/React.createElement(OuiPageHeaderContent, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiPageHeader } from '../../../eui_components/page/page_header/page_header';