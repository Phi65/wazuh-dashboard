...
export var OuiPage = function OuiPage(_ref) {
  ...
  var classes = classNames('ouiPage', paddingSizeToClassNameMap[paddingSize], directionToClassNameMap[direction], _defineProperty({
    'ouiPage--grow': grow
