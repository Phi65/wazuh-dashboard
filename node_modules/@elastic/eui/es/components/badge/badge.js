...
import { ouiPaletteColorBlindBehindText, getSecureRelForTarget, isColorDark } from '../../services';
...
var visColors = ouiPaletteColorBlindBehindText();
var colorToHexMap = {
...
export var OuiBadge = function OuiBadge(_ref) {
  ...
  var classes = classNames('ouiBadge', {
  ...
  var closeClassNames = classNames('ouiBadge__icon', closeButtonProps && closeButtonProps.className);
  ...
  if (iconType) {
    if (iconOnClick) {
      ...
      optionalIcon = /*#__PURE__*/React.createElement(OuiIcon, {
        type: iconType,
        size: children ? 's' : 'm',
  ...
  if (iconOnClick) {
    ...
    }), optionalIcon)) : /*#__PURE__*/React.createElement(OuiInnerText, null, function (ref, innerText) {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiBadge } from '../../eui_components/badge/badge';