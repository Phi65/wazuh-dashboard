...
export var OuiColorPalettePicker = function OuiColorPalettePicker(_ref) {
  ...
  var getPalette = function getPalette(_ref2) {
    ...
    return type === 'gradient' ? /*#__PURE__*/React.createElement(OuiColorPaletteDisplay, {
      type: type,
      palette: palette
    }) : /*#__PURE__*/React.createElement(OuiColorPaletteDisplay, {
      type: type,
      palette: palette
    });
  };
  ...
  return /*#__PURE__*/React.createElement(OuiSuperSelect, _extends({
    className: className,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiColorPalettePicker } from '../../../eui_components/color_picker/color_palette_picker/color_palette_picker';