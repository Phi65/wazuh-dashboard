...
import { OuiFieldText, OuiFormControlLayout, OuiFormRow, OuiRange } from '../form';
...
export var OuiColorPicker = function OuiColorPicker(_ref) {
  var _ref8;
  ...
  var testSubjAnchor = classNames('ouiColorPickerAnchor', dataTestSubj);
  ...
  var classes = classNames('ouiColorPicker', className);
  var popoverClass = 'ouiColorPicker__popoverAnchor';
  var panelClasses = classNames('ouiColorPicker__popoverPanel', {
  ...
  var inputClasses = classNames('ouiColorPicker__input', {
  ...
  var inlineInput = secondaryInputDisplay !== 'none' && /*#__PURE__*/React.createElement(OuiI18n, {
    ...
    return /*#__PURE__*/React.createElement(OuiFormRow, {
    ...
    }, /*#__PURE__*/React.createElement(OuiFieldText, {
      compressed: true,
  ...
  var composite = /*#__PURE__*/React.createElement(React.Fragment, null, secondaryInputDisplay === 'top' && /*#__PURE__*/React.createElement(React.Fragment, null, inlineInput, /*#__PURE__*/React.createElement(OuiSpacer, {
    size: "s"
  })), showPicker && /*#__PURE__*/React.createElement("div", {
    onKeyDown: handleOnKeyDown
  }, /*#__PURE__*/React.createElement(OuiSaturation, {
    id: id,
    color: usableHsv,
    hex: chromaColor ? chromaColor.hex() : undefined,
    onChange: handleColorSelection,
    ref: satruationRef
  }), /*#__PURE__*/React.createElement(OuiHue, {
    id: id,
    hue: usableHsv[0],
    hex: chromaColor ? chromaColor.hex() : undefined,
    onChange: handleHueSelection
  })), showSwatches && /*#__PURE__*/React.createElement(OuiFlexGroup, {
    wrap: true,
    responsive: false,
    gutterSize: "s",
    role: "listbox"
    ...
    return /*#__PURE__*/React.createElement(OuiFlexItem, {
      ...
      return /*#__PURE__*/React.createElement(OuiColorPickerSwatch, {
  ...
  })), secondaryInputDisplay === 'bottom' && /*#__PURE__*/React.createElement(React.Fragment, null, mode !== 'picker' && /*#__PURE__*/React.createElement(OuiSpacer, {
    size: "s"
  }), inlineInput), showAlpha && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OuiSpacer, {
    size: "s"
  }), /*#__PURE__*/React.createElement(OuiI18n, {
    token: "ouiColorPicker.alphaLabel",
    default: "Alpha channel (opacity) value"
  }, function (alphaLabel) {
    return /*#__PURE__*/React.createElement(OuiRange, {
  ...
  if (button) {
    ...
    buttonOrInput = /*#__PURE__*/React.createElement(OuiFormControlLayout, {
      icon: !readOnly ? {
        type: 'arrowDown',
        side: 'right'
      } : undefined,
      ...
      return /*#__PURE__*/React.createElement(OuiFieldText, {
  ...
  return display === 'inline' ? /*#__PURE__*/React.createElement("div", {
    className: classes
  }, composite) : /*#__PURE__*/React.createElement(OuiPopover, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiColorPicker } from '../../eui_components/color_picker/color_picker';