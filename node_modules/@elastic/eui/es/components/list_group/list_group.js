...
import { OuiListGroupItem } from './list_group_item';
...
export var OuiListGroup = function OuiListGroup(_ref) {
  ...
  var classes = classNames('ouiListGroup', {
  ...
  if (listItems) {
    childrenOrListItems = listItems.map(function (item, index) {
      return [/*#__PURE__*/React.createElement(OuiListGroupItem, _extends({
