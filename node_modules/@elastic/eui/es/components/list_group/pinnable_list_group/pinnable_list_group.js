...
export var OuiPinnableListGroup = function OuiPinnableListGroup(_ref) {
  ...
  var classes = classNames('ouiPinnableListGroup', className); // Alter listItems object with extra props
  ...
  var getNewListItems = function getNewListItems(pinExtraActionLabel, pinnedExtraActionLabel) {
    return listItems.map(function (item) {
      ...
      itemProps.className = classNames('ouiPinnableListGroup__item', item.className); // Add the pinning action unless the item has it's own extra action
  ...
  return /*#__PURE__*/React.createElement(OuiI18n, {
    ...
    return /*#__PURE__*/React.createElement(OuiListGroup, _extends({
      className: classes,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiPinnableListGroup } from '../../../eui_components/list_group/pinnable_list_group/pinnable_list_group';