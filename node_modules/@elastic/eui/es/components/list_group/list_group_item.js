...
export var OuiListGroupItem = function OuiListGroupItem(_ref) {
  ...
  var classes = classNames('ouiListGroupItem', sizeToClassNameMap[size], colorToClassNameMap[color], {
  ...
  if (iconType) {
    iconNode = /*#__PURE__*/React.createElement(OuiIcon, _extends({
      color: "inherit" // forces the icon to inherit its parent color

    }, iconProps, {
      type: iconType,
      className: classNames('ouiListGroupItem__icon', iconProps === null || iconProps === void 0 ? void 0 : iconProps.className)
    }));
  ...
  if (extraAction) {
    ...
    var extraActionClasses = classNames('ouiListGroupItem__extraAction', {
      'ouiListGroupItem__extraAction-alwaysShow': alwaysShow
    }, _className);
    extraActionNode = /*#__PURE__*/React.createElement(OuiButtonIcon, _extends({
  ...
  if (showToolTip) {
    itemContent = /*#__PURE__*/React.createElement("li", {
      className: classes
    }, /*#__PURE__*/React.createElement(OuiToolTip, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiListGroupItem } from '../../eui_components/list_group/list_group_item';