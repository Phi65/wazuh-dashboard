...
export var OuiFieldText = function OuiFieldText(_ref) {
  var id = _ref.id,
      name = _ref.name,
  ...
  var classes = classNames('ouiFieldText', className, {
  ...
  var control = /*#__PURE__*/React.createElement(OuiValidatableControl, {
    isInvalid: isInvalid
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiFieldText } from '../../../eui_components/form/field_text/field_text';