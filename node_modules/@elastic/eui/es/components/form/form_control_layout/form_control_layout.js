...
import { OuiFormControlLayoutIcons } from './form_control_layout_icons';
import { OuiFormLabel } from '../form_label';
export { ICON_SIDES } from './form_control_layout_icons';
export var OuiFormControlLayout = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiFormControlLayout, [{
    ...
    value: function render() {
      ...
      var classes = classNames('ouiFormControlLayout', {
      ...
      }, children, /*#__PURE__*/React.createElement(OuiFormControlLayoutIcons, {
        icon: icon,
        clear: clear,
    ...
    value: function createFormLabel(side, string, inputId) {
      return /*#__PURE__*/React.createElement(OuiFormLabel, {
        htmlFor: inputId,
    ...
    value: function createSideNode(side, node, key) {
      return /*#__PURE__*/cloneElement(node, {
        className: classNames("ouiFormControlLayout__".concat(side), node.props.className),
        key: key
      });
    }
  }]);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiFormControlLayout } from '../../../eui_components/form/form_control_layout/form_control_layout';