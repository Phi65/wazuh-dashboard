...
export var OuiCheckbox = /*#__PURE__*/function (_Component) {
  _inherits(OuiCheckbox, _Component);
  ...
  function OuiCheckbox() {
    ...
    _classCallCheck(this, OuiCheckbox);
  ...
  _createClass(OuiCheckbox, [{
    ...
    value: function render() {
      ...
      var classes = classNames('ouiCheckbox', type && typeToClassNameMap[type], {
        'ouiCheckbox--noLabel': !label,
        'ouiCheckbox--compressed': compressed
      }, className);
      var labelClasses = classNames('ouiCheckbox__label', labelProps === null || labelProps === void 0 ? void 0 : labelProps.className);
      var optionalLabel;
...
_defineProperty(OuiCheckbox, "defaultProps", {
  checked: false,
  disabled: false,
  indeterminate: false,
  compressed: false
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiCheckbox } from '../../../eui_components/form/checkbox/checkbox';