...
export var OuiCheckboxGroup = function OuiCheckboxGroup(_ref) {
  ...
  var checkboxes = options.map(function (option, index) {
    ...
    return /*#__PURE__*/React.createElement(OuiCheckbox, _extends({
  ...
  if (!!legend) {
    ...
    return /*#__PURE__*/React.createElement(OuiFormFieldset, _extends({
      className: className,
      legend: legend
    }, rest), checkboxes);
  }
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiCheckboxGroup } from '../../../eui_components/form/checkbox/checkbox_group';