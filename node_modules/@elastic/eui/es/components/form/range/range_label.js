...
export var OuiRangeLabel = function OuiRangeLabel(_ref) {
  var children = _ref.children,
      disabled = _ref.disabled,
      _ref$side = _ref.side,
      side = _ref$side === void 0 ? 'max' : _ref$side;
  var classes = classNames('ouiRangeLabel', "ouiRangeLabel--".concat(side), {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiRangeLabel } from '../../../eui_components/form/range/range_label';