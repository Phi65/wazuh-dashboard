...
export var OuiRange = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiRange, [{
    ...
    value: function render() {
      ...
      var theInput = !!showInput ? /*#__PURE__*/React.createElement(OuiRangeInput, _extends({
        id: id,
        min: min,
        max: max,
      ...
      var classes = classNames('ouiRange', {
      ...
      }), showValue && !!String(value).length && /*#__PURE__*/React.createElement(OuiRangeTooltip, {
        compressed: compressed,
        value: value,
        max: max,
        min: min,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiRange } from '../../../eui_components/form/range/range';