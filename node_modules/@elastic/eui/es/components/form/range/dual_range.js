...
export var OuiDualRange = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiDualRange, [{
    ...
    value: function render() {
      ...
      var minInput = !!showInput ? /*#__PURE__*/React.createElement(OuiRangeInput // Overridable props
      , _extends({
      ...
      var maxInput = !!showInput ? /*#__PURE__*/React.createElement(OuiRangeInput // Overridable props
      , _extends({
        "aria-describedby": this.props['aria-describedby'],
        "aria-label": this.props['aria-label']
      }, maxInputProps, {
      ...
      var classes = classNames('ouiDualRange', className);
      ...
      var theRange = /*#__PURE__*/React.createElement(OuiRangeWrapper, {
        className: classes,
        fullWidth: fullWidth,
        compressed: compressed
      ...
      })), showLabels && /*#__PURE__*/React.createElement(OuiRangeLabel, {
        side: "min",
        disabled: disabled
      }, min), /*#__PURE__*/React.createElement(OuiRangeTrack, {
        compressed: compressed,
        disabled: disabled,
        max: max,
        min: min,
      ...
      }, /*#__PURE__*/React.createElement(OuiRangeSlider, _extends({
        ...
        onFocus: onFocus,
        onBlur: onBlur
      }, rest)), showRange && this.isValid && /*#__PURE__*/React.createElement(OuiRangeHighlight, {
        compressed: compressed,
        hasFocus: this.state.hasFocus,
        showTicks: showTicks,
        min: Number(min),
      ...
      }), this.state.rangeSliderRefAvailable && /*#__PURE__*/React.createElement(React.Fragment, null, isDraggable && this.isValid && /*#__PURE__*/React.createElement(OuiRangeDraggable, {
        min: min,
        max: max,
        ...
        "aria-describedby": this.props['aria-describedby'],
        "aria-label": this.props['aria-label']
      }), /*#__PURE__*/React.createElement(OuiRangeThumb, {
        min: min,
        max: Number(this.upperValue),
        value: this.lowerValue,
        disabled: disabled,
      ...
      var thePopover = showInputOnly ? /*#__PURE__*/React.createElement(OuiInputPopover, {
        className: "ouiRange__popover",
        input: /*#__PURE__*/React.createElement(OuiFormControlLayoutDelimited, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiDualRange } from '../../../eui_components/form/range/dual_range';