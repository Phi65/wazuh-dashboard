...
export { LEVEL_COLORS };
export var OuiRangeTrack = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiRangeTrack, [{
    ...
    value: function render() {
      ...
      var trackClasses = classNames('ouiRangeTrack', {
      ...
      }, rest), levels && !!levels.length && /*#__PURE__*/React.createElement(OuiRangeLevels, {
        compressed: compressed,
        levels: levels,
        max: max,
        min: min,
        showTicks: showTicks
      }), tickSequence && /*#__PURE__*/React.createElement(OuiRangeTicks, {
        disabled: disabled,
        compressed: compressed,
        onChange: onChange,
        ticks: ticks,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiRangeTrack } from '../../../eui_components/form/range/range_track';