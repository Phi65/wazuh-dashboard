...
export var OuiFieldPassword = function OuiFieldPassword(_ref) {
  ...
  var _useOuiI18n = useOuiI18n(['ouiFieldPassword.showPassword', 'ouiFieldPassword.maskPassword'], ['Show password as plain text. Note: this will visually expose your password on the screen.', 'Mask password']),
  ...
  if (type === 'dual') {
    ...
    var visibilityToggle = /*#__PURE__*/React.createElement(OuiButtonIcon, _extends({
  ...
  var classes = classNames('ouiFieldPassword', {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiFieldPassword } from '../../../eui_components/form/field_password/field_password';