...
export var OuiSuperSelect = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OuiSuperSelect, [{
    ...
    value: function render() {
      ...
      var popoverClasses = classNames('ouiSuperSelect', popoverClassName);
      var buttonClasses = classNames({
        'ouiSuperSelect--isOpen__button': this.state.isPopoverOpen
      }, className);
      var itemClasses = classNames('ouiSuperSelect__item', {
        'ouiSuperSelect__item--hasDividers': hasDividers
      }, itemClassName);
      var button = /*#__PURE__*/React.createElement(OuiSuperSelectControl, _extends({
        options: options,
      ...
      return /*#__PURE__*/React.createElement(OuiInputPopover, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiSuperSelect } from '../../../eui_components/form/super_select/super_select';