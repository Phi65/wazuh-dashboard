...
export var OuiFormLegend = function OuiFormLegend(_ref) {
  ...
  var classes = classNames('ouiFormLegend', {
  ...
  return /*#__PURE__*/React.createElement("legend", _extends({
    className: classes
  }, rest), isLegendHidden ? /*#__PURE__*/React.createElement(OuiScreenReaderOnly, null, /*#__PURE__*/React.createElement("span", null, children)) : children);
};
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiFormLegend } from '../../../eui_components/form/form_fieldset/form_legend';