...
var limitBreadcrumbs = function limitBreadcrumbs(breadcrumbs, max, allBreadcrumbs) {
  ...
  var OuiBreadcrumbCollapsed = function OuiBreadcrumbCollapsed() {
    ...
    var ellipsisButton = /*#__PURE__*/React.createElement(OuiI18n, {
      token: "ouiBreadcrumbs.collapsedBadge.ariaLabel",
      default: "Show collapsed breadcrumbs"
    }, function (ariaLabel) {
      return /*#__PURE__*/React.createElement(OuiLink, {
    ...
    return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(OuiPopover, {
    ...
    }, /*#__PURE__*/React.createElement(OuiBreadcrumbs, {
      className: "ouiBreadcrumbs__inPopover",
      breadcrumbs: overflowBreadcrumbs,
      responsive: false,
      truncate: false,
      max: 0
    })), /*#__PURE__*/React.createElement(OuiBreadcrumbSeparator, null));
  };

  if (max < breadcrumbs.length) {
    breadcrumbsAtStart.push( /*#__PURE__*/React.createElement(OuiBreadcrumbCollapsed, {
      key: "collapsed"
    }));
  }
...
export var OuiBreadcrumbs = function OuiBreadcrumbs(_ref) {
  ...
  var breadcrumbElements = breadcrumbs.map(function (breadcrumb, index) {
    ...
    var breadcrumbClasses = classNames('ouiBreadcrumb', breadcrumbClassName, {
    ...
    if (!href && !onClick) {
      link = /*#__PURE__*/React.createElement(OuiInnerText, null, function (ref, innerText) {
      ...
      link = /*#__PURE__*/React.createElement(OuiInnerText, null, function (ref, innerText) {
        return /*#__PURE__*/React.createElement(OuiLink, _extends({
          ref: ref,
    ...
    if (!isLastBreadcrumb) {
      separator = /*#__PURE__*/React.createElement(OuiBreadcrumbSeparator, null);
    }
  ...
  var classes = classNames('ouiBreadcrumbs', className, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiBreadcrumbs } from '../../eui_components/breadcrumbs/breadcrumbs';