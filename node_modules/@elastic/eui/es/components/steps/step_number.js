...
export var OuiStepNumber = function OuiStepNumber(_ref) {
  ...
  var classes = classNames('ouiStepNumber', status ? statusToClassNameMap[status] : undefined, {
  ...
  var numberOrIcon = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OuiScreenReaderOnly, null, /*#__PURE__*/React.createElement("span", null, screenReaderText)), /*#__PURE__*/React.createElement("span", {
    className: "ouiStepNumber__number",
    "aria-hidden": "true"
  }, number));

  if (status === 'complete') {
    numberOrIcon = /*#__PURE__*/React.createElement(OuiIcon, {
      type: "check",
    ...
    numberOrIcon = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OuiScreenReaderOnly, null, /*#__PURE__*/React.createElement("span", null, screenReaderText)), /*#__PURE__*/React.createElement(OuiLoadingSpinner, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiStepNumber } from '../../eui_components/steps/step_number';