...
export var OuiFlexItem = function OuiFlexItem(_ref) {
  ...
  var classes = classNames('ouiFlexItem', _defineProperty({
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiFlexItem } from '../../eui_components/flex/flex_item';