...
export var OuiFlexGrid = function OuiFlexGrid(_ref) {
  ...
  var classes = classNames('ouiFlexGrid', gutterSize ? gutterSizeToClassNameMap[gutterSize] : undefined, columns != null ? columnsToClassNameMap[columns] : undefined, direction ? directionToClassNameMap[direction] : undefined, {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiFlexGrid } from '../../eui_components/flex/flex_grid';