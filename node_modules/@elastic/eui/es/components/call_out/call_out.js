...
export var OuiCallOut = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var classes = classNames('ouiCallOut', colorToClassNameMap[color], sizeToClassNameMap[size], className);
  var headerIcon;
  ...
  if (children && size === 's') {
    optionalChildren = /*#__PURE__*/React.createElement(OuiText, {
      size: "xs",
      color: "default"
    }, children);
  } else if (children) {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiCallOut } from '../../eui_components/call_out/call_out';