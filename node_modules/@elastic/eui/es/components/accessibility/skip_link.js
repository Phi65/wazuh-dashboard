...
export var OuiSkipLink = function OuiSkipLink(_ref) {
  ...
  var classes = classNames('ouiSkipLink', ["ouiSkipLink--".concat(position)], className); // Create the `href` from `destinationId`
  ...
  return /*#__PURE__*/React.createElement(OuiScreenReaderOnly, {
    showOnFocus: true
  }, /*#__PURE__*/React.createElement(OuiButton, _extends({
    className: classes,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiSkipLink } from '../../eui_components/accessibility/skip_link';