...
export var OuiAspectRatio = function OuiAspectRatio(_ref) {
  ...
  var classes = classNames('ouiAspectRatio', className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiAspectRatio } from '../../eui_components/aspect_ratio/aspect_ratio';