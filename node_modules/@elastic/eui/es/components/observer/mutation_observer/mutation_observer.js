...
export var OuiMutationObserver = /*#__PURE__*/function (_OuiObserver) {
  _inherits(OuiMutationObserver, _OuiObserver);
  ...
  function OuiMutationObserver() {
    ...
    _classCallCheck(this, OuiMutationObserver);
    ...
    _defineProperty(_assertThisInitialized(_this), "name", 'OuiMutationObserver');
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiMutationObserver } from '../../../eui_components/observer/mutation_observer/mutation_observer';