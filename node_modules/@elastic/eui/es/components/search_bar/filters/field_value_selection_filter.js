...
export var FieldValueSelectionFilter = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FieldValueSelectionFilter, [{
    ...
    value: function render() {
      ...
      var button = /*#__PURE__*/React.createElement(OuiFilterButton, {
        iconType: "arrowDown",
        iconSide: "right",
    ...
    value: function renderSearchBox() {
      ...
      if (this.state.options && this.state.options.all.length >= threshold) {
        ...
        return /*#__PURE__*/React.createElement(OuiPopoverTitle, {
          paddingSize: "s"
        }, /*#__PURE__*/React.createElement(OuiFieldSearch, {
    ...
    value: function renderContent(field, query, config, multiSelect) {
      ...
      this.state.options.shown.forEach(function (option, index) {
        ...
        var item = /*#__PURE__*/React.createElement(OuiFilterSelectItem, {
          key: index,
          checked: checked,
          onClick: onClick,
    ...
    value: function renderLoader() {
      ...
      }, /*#__PURE__*/React.createElement(OuiLoadingChart, {
        size: "m"
