...
export var OuiResizableButton = function OuiResizableButton(_ref) {
  ...
  var resizerId = useRef(id || generatePanelId());
  ...
  var classes = classNames('ouiResizableButton', {
...
export function ouiResizableButtonWithControls(controls) {
  return function (props) {
    return /*#__PURE__*/React.createElement(OuiResizableButton, _extends({}, controls, props));
  };
}
/* OUI -> EUI Aliases: Build-Time */

/* OUI -> EUI Aliases: Build-Time */
export { EuiResizableButton, euiResizableButtonWithControls } from '../../eui_components/resizable_container/resizable_button';