...
export var OuiResizablePanel = function OuiResizablePanel(_ref) {
  ...
  var _useOuiResizableConta = useOuiResizableContainerContext(),
  ...
  var classes = classNames('ouiResizablePanel', paddingSizeToClassNameMap[wrapperPadding], {
  ...
  var panelClasses = classNames('ouiResizablePanel__content', {
  ...
  var toggleButtonAriaLabel = useOuiI18n('ouiResizablePanel.toggleButtonAriaLabel', 'Press to toggle this panel');
  ...
  if ((isCollapsible || modeType === 'custom') && hasLeftToggle) {
    ...
    theToggle = /*#__PURE__*/React.createElement(OuiResizableCollapseButton, {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, wrapperProps, {
    ...
    style: styles,
    className: classes
  }), hasVisibleToggle && hasLeftToggle && theToggle, /*#__PURE__*/React.createElement(OuiPanel, _extends({
...
export function ouiResizablePanelWithControls(controls) {
  return function (props) {
    return /*#__PURE__*/React.createElement(OuiResizablePanel, _extends({}, controls, props));
  };
}
/* OUI -> EUI Aliases: Build-Time */

/* OUI -> EUI Aliases: Build-Time */
export { EuiResizablePanel, euiResizablePanelWithControls } from '../../eui_components/resizable_container/resizable_panel';