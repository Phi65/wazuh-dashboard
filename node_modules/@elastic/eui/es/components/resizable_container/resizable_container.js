...
import { ouiResizableButtonWithControls } from './resizable_button';
import { ouiResizablePanelWithControls, getModeType } from './resizable_panel';
...
export var OuiResizableContainer = function OuiResizableContainer(_ref) {
  ...
  var classes = classNames('ouiResizableContainer', {
  ...
  var OuiResizableButton = useCallback(ouiResizableButtonWithControls({
    onKeyDown: onKeyDown,
  ...
  var OuiResizablePanel = useCallback(ouiResizablePanelWithControls({
    isHorizontal: isHorizontal,
    registration: {
  ...
  return /*#__PURE__*/React.createElement(OuiResizableContainerContextProvider, {
    registry: {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiResizableContainer } from '../../eui_components/resizable_container/resizable_container';