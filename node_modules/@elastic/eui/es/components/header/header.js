...
import { OuiHeaderSectionItem, OuiHeaderSection } from './header_section';
import { OuiHeaderBreadcrumbs } from './header_breadcrumbs';

function createHeaderSection(sections, border) {
  return sections.map(function (section, index) {
    return /*#__PURE__*/React.createElement(OuiHeaderSectionItem, {
      key: index,
      border: border
    }, section);
  });
...
export var OuiHeader = function OuiHeader(_ref) {
  ...
  var classes = classNames('ouiHeader', "ouiHeader--".concat(theme), "ouiHeader--".concat(position), className);
  useEffect(function () {
    if (position === 'fixed') {
  ...
  if (sections) {
    ...
    contents = sections.map(function (section, index) {
      ...
      if (section.items) {
        ...
        content.push( /*#__PURE__*/React.createElement(OuiHeaderSection, {
      ...
      if (section.breadcrumbs) {
        ...
        React.createElement(OuiHeaderBreadcrumbs, _extends({
