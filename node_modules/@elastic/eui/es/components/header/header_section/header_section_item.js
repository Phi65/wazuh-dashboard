...
export var OuiHeaderSectionItem = function OuiHeaderSectionItem(_ref) {
  ...
  var classes = classNames('ouiHeaderSectionItem', borderToClassNameMap[border], className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiHeaderSectionItem } from '../../../eui_components/header/header_section/header_section_item';