...
export var OuiHeaderLink = function OuiHeaderLink(_ref) {
  var isActive = _ref.isActive,
      className = _ref.className,
      rest = _objectWithoutProperties(_ref, ["isActive", "className"]);

  var classes = classNames('ouiHeaderLink', {
  ...
  return /*#__PURE__*/React.createElement(OuiButtonEmpty, props);
};
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiHeaderLink } from '../../../eui_components/header/header_links/header_link';