...
export var OuiHorizontalRule = function OuiHorizontalRule(_ref) {
  ...
  var classes = classNames('ouiHorizontalRule', sizeToClassNameMap[size], marginToClassNameMap[margin], className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiHorizontalRule } from '../../eui_components/horizontal_rule/horizontal_rule';