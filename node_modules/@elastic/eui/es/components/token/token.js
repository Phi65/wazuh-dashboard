...
export var OuiToken = function OuiToken(_ref) {
  ...
  var classes = classNames('ouiToken', colorClass, shapeToClassMap[finalShape], fillToClassMap[finalFill], sizeToClassMap[size], className);
...
OuiToken.propTypes = {
  ...
  /**
     ...
     * Default: `gray`
     */
  color: PropTypes.oneOfType([PropTypes.oneOf(["ouiColorVis0", "ouiColorVis1", "ouiColorVis2", "ouiColorVis3", "ouiColorVis4", "ouiColorVis5", "ouiColorVis6", "ouiColorVis7", "ouiColorVis8", "ouiColorVis9", "gray"]).isRequired, PropTypes.string.isRequired]),
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiToken } from '../../eui_components/token/token';