...
export var OuiCardSelect = function OuiCardSelect(_ref) {
  ...
  var selectClasses = classNames('ouiCardSelect', "ouiCardSelect--".concat(ouiCardSelectableColor(color, isSelected)), className);
...
function ouiCardSelectableText(isSelected, isDisabled, children) {
  ...
  if (isSelected) {
    text = /*#__PURE__*/React.createElement(OuiI18n, {
...
export function ouiCardSelectableColor(color, isSelected) {
  var calculatedColor;
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiCardSelect, euiCardSelectableColor } from '../../eui_components/card/card_select';