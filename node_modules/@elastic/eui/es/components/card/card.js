...
import { OuiCardSelect, ouiCardSelectableColor } from './card_select';
...
export var OuiCard = function OuiCard(_ref) {
  ...
  var selectableColorClass = selectable ? "ouiCard--isSelectable--".concat(ouiCardSelectableColor(selectable.color, selectable.isSelected)) : undefined;
  var classes = classNames('ouiCard', textAlignToClassNameMap[textAlign], layoutToClassNameMap[layout], {
  ...
  if (betaBadgeLabel) {
    ...
    }, /*#__PURE__*/React.createElement(OuiBetaBadge, _extends({
      id: optionalBetaBadgeID
    }, betaBadgeProps, {
      label: betaBadgeLabel,
      title: betaBadgeTitle,
      tooltipContent: betaBadgeTooltipContent,
      className: classNames('ouiCard__betaBadge', betaBadgeProps === null || betaBadgeProps === void 0 ? void 0 : betaBadgeProps.className)
  ...
  if (selectable) {
    optionalSelectButton = /*#__PURE__*/React.createElement(OuiCardSelect, _extends({
  ...
  return /*#__PURE__*/React.createElement(OuiPanel, _extends({
    ...
    size: titleSize
  }, /*#__PURE__*/React.createElement(TitleElement, null, theTitle)), description && /*#__PURE__*/React.createElement(OuiText, {
    id: ariaDesc,
    size: "s",
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiCard } from '../../eui_components/card/card';