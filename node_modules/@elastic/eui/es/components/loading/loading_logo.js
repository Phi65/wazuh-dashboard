...
export var OuiLoadingLogo = function OuiLoadingLogo(_ref) {
  ...
  var classes = classNames('ouiLoadingLogo', sizeToClassNameMap[size], className);
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiLoadingLogo } from '../../eui_components/loading/loading_logo';