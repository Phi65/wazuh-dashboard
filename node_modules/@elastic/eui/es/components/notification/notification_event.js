...
import { OuiNotificationEventMessages } from './notification_event_messages';
...
export var OuiNotificationEvent = function OuiNotificationEvent(_ref) {
  var id = _ref.id,
      type = _ref.type,
  ...
  var classes = classNames('ouiNotificationEvent', {
    'ouiNotificationEvent--withReadState': typeof isRead === 'boolean'
  });
  var classesTitle = classNames('ouiNotificationEvent__title', {
  ...
  return /*#__PURE__*/React.createElement("article", {
  ...
  }, !!onRead ? /*#__PURE__*/React.createElement(OuiNotificationEventReadButton, {
    isRead: isRead,
    ...
    eventName: title,
    id: id
  }) : /*#__PURE__*/React.createElement(OuiNotificationEventReadIcon, {
    id: id,
    isRead: isRead,
    eventName: title
  })), /*#__PURE__*/React.createElement("div", {
    className: "ouiNotificationEvent__content"
  }, /*#__PURE__*/React.createElement(OuiNotificationEventMeta, {
    id: id,
    type: type,
    severity: severity,
    ...
    eventName: title
  }), onClickTitle ? /*#__PURE__*/React.createElement(OuiLink, _extends({
    onClick: function onClick() {
      return onClickTitle(id);
    }
  }, titleProps), /*#__PURE__*/createElement(headingLevel, null, title)) : /*#__PURE__*/createElement(headingLevel, titleProps, title), /*#__PURE__*/React.createElement(OuiNotificationEventMessages, {
    messages: messages,
    eventName: title
  }), onClickPrimaryAction && primaryAction && /*#__PURE__*/React.createElement("div", {
    className: "ouiNotificationEvent__primaryAction"
  }, /*#__PURE__*/React.createElement(OuiButtonEmpty, _extends({
    flush: "left",
    size: "s"
  }, primaryActionProps, {
    onClick: function onClick() {
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiNotificationEvent } from '../../eui_components/notification/notification_event';