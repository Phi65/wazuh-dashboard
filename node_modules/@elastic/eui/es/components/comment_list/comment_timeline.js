...
export var OuiCommentTimeline = function OuiCommentTimeline(_ref) {
  var className = _ref.className,
      timelineIcon = _ref.timelineIcon,
      _ref$type = _ref.type,
      type = _ref$type === void 0 ? 'regular' : _ref$type;
  var classes = classNames('ouiCommentTimeline', className);
  ...
  if (typeof timelineIcon === 'string') {
    iconRender = /*#__PURE__*/React.createElement(OuiIcon, {
