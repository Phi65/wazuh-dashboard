...
export var OuiCommentList = function OuiCommentList(_ref) {
  var children = _ref.children,
      className = _ref.className,
      comments = _ref.comments,
      rest = _objectWithoutProperties(_ref, ["children", "className", "comments"]);

  var classes = classNames('ouiCommentList', className);
  var commentElements = null;

  if (comments) {
    commentElements = comments.map(function (item, index) {
      return /*#__PURE__*/React.createElement(OuiComment, _extends({
        key: index
      }, item));
    });
  }
