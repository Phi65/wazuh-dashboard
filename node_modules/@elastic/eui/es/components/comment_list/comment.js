...
export var OuiComment = function OuiComment(_ref) {
  ...
  var classes = classNames('ouiComment', typeToClassNameMap[type], {
    'ouiComment--hasBody': children
  }, className);
  return /*#__PURE__*/React.createElement("div", _extends({
    className: classes
  }, rest), /*#__PURE__*/React.createElement(OuiCommentTimeline, {
    type: type,
    timelineIcon: timelineIcon
  }), /*#__PURE__*/React.createElement(OuiCommentEvent, {
    username: username,
    actions: actions,
    event: event,
    timestamp: timestamp,
