...
import { OuiSuggestInput } from './suggest_input';
export var OuiSuggest = function OuiSuggest(props) {
  ...
  var suggestionList = suggestions.map(function (item, index) {
    ...
    return /*#__PURE__*/React.createElement(OuiSuggestItem, _extends({
      key: index
    }, props));
  });
  var suggestInput = /*#__PURE__*/React.createElement(OuiSuggestInput, _extends({
    status: status,
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiSuggest } from '../../eui_components/suggest/suggest';