...
export var OuiEmptyPrompt = function OuiEmptyPrompt(_ref) {
  var icon = _ref.icon,
  ...
  var classes = classNames('ouiEmptyPrompt', className);
  var iconNode;

  if (icon) {
    iconNode = /*#__PURE__*/React.createElement(React.Fragment, null, icon, /*#__PURE__*/React.createElement(OuiSpacer, {
      size: "m"
    }));
  } else if (iconType) {
    iconNode = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OuiIcon, {
      type: iconType,
      size: "xxl",
      color: iconColor
  ...
  if (body || title) {
    if (title) {
      titleNode = /*#__PURE__*/React.createElement(OuiTitle, {
        size: titleSize
      }, title);
    }

    if (body) {
      bodyNode = /*#__PURE__*/React.createElement(OuiTextColor, {
        color: "subdued"
      }, title && /*#__PURE__*/React.createElement(OuiSpacer, {
        size: "m"
      }), /*#__PURE__*/React.createElement(OuiText, null, body));
    }
  }
  ...
  if (actions) {
    ...
    if (Array.isArray(actions)) {
      actionsRow = /*#__PURE__*/React.createElement(OuiFlexGroup, {
        gutterSize: "m",
        alignItems: "center",
    ...
    actionsNode = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OuiSpacer, {
      size: "l"
    }), actionsRow);
  }
...
/* OUI -> EUI Aliases: Build-Time */
export { EuiEmptyPrompt } from '../../eui_components/empty_prompt/empty_prompt';