...
exports.OuiPageHeaderContent = exports.ALIGN_ITEMS = void 0;
...
var _page_header_content = require("../../../eui_components/page/page_header/page_header_content");
...
var OuiPageHeaderContent = function OuiPageHeaderContent(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiPageHeaderContent');
  var descriptionNode;

  if (description) {
    descriptionNode = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (pageTitle || tabs) && /*#__PURE__*/_react.default.createElement(_spacer.OuiSpacer, null), /*#__PURE__*/_react.default.createElement(_text.OuiText, {
      grow: false
  ...
  if (pageTitle) {
    var icon = iconType ? /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, (0, _extends2.default)({
      size: "xl"
    }, iconProps, {
      type: iconType,
      className: (0, _classnames.default)('ouiPageHeaderContent__titleIcon', iconProps === null || iconProps === void 0 ? void 0 : iconProps.className)
    })) : undefined;
    pageTitleNode = /*#__PURE__*/_react.default.createElement(_title.OuiTitle, {
      size: "l"
  ...
  if (tabs) {
    var renderTabs = function renderTabs() {
      return tabs.map(function (tab, index) {
        ...
        return /*#__PURE__*/_react.default.createElement(_tabs.OuiTab, (0, _extends2.default)({
          key: index
        }, tabRest), label);
      });
    };

    tabsNode = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, pageTitleNode && /*#__PURE__*/_react.default.createElement(_spacer.OuiSpacer, null), /*#__PURE__*/_react.default.createElement(_tabs.OuiTabs, (0, _extends2.default)({}, tabsProps, {
      display: "condensed",
      size: "l"
    }), renderTabs()));
  }

  var childrenNode = children && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_spacer.OuiSpacer, null), children);

  var bottomContentNode;

  if (childrenNode || tabsNode && pageTitleNode) {
    bottomContentNode = /*#__PURE__*/_react.default.createElement("div", {
      className: "ouiPageHeaderContent__bottom"
  ...
  if (rightSideItems && rightSideItems.length) {
    ...
    rightSideFlexItem = /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, {
      grow: false
    }, /*#__PURE__*/_react.default.createElement(_flex.OuiFlexGroup, (0, _extends2.default)({
      wrap: true,
      responsive: false
    }, rightSideGroupProps, {
      className: (0, _classnames.default)('ouiPageHeaderContent__rightSideItems', rightSideGroupProps === null || rightSideGroupProps === void 0 ? void 0 : rightSideGroupProps.className)
    }), wrapWithFlex()));
  }
  ...
  return alignItems === 'top' || isResponsiveBreakpoint ? /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({
    ...
    gutterSize: "l"
  }, isResponsiveBreakpoint && responsive === 'reverse' ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, rightSideFlexItem, /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, null, leftSideOrder)) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, null, leftSideOrder), rightSideFlexItem)), bottomContentNode) : /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({
    className: classes
  }, rest), /*#__PURE__*/_react.default.createElement(_flex.OuiFlexGroup, {
    responsive: !!responsive,
    className: "ouiPageHeaderContent__top",
    ...
    gutterSize: "l"
  }, /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, null, leftSideOrder, bottomContentNode), rightSideFlexItem));
};
/* OUI -> EUI Aliases: Build-Time */


exports.OuiPageHeaderContent = OuiPageHeaderContent;
