...
exports.OuiPageHeader = exports.PADDING_SIZES = void 0;
...
var _page_header = require("../../../eui_components/page/page_header/page_header");
...
var OuiPageHeader = function OuiPageHeader(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiPageHeader', paddingSizeToClassNameMap[paddingSize], (0, _defineProperty2.default)({
  ...
  }, "ouiPage--".concat(widthClassName), widthClassName), "ouiPageHeader--".concat(alignItems !== null && alignItems !== void 0 ? alignItems : 'center'), className);
  ...
  return /*#__PURE__*/_react.default.createElement("header", (0, _extends2.default)({
    className: classes,
    style: newStyle || style
  }, rest), /*#__PURE__*/_react.default.createElement(_page_header_content.OuiPageHeaderContent, {
...
exports.OuiPageHeader = OuiPageHeader;
