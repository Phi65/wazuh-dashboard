...
Object.defineProperty(exports, "EuiPopover", {
  enumerable: true,
  get: function get() {
    return _popover2.EuiPopover;
  }
});
exports.OuiPopover = exports.DISPLAY = exports.ANCHOR_POSITIONS = void 0;
...
var _popover2 = require("../../eui_components/popover/popover");
...
var OuiPopover = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiPopover, _Component);

  var _super = _createSuper(OuiPopover);

  (0, _createClass2.default)(OuiPopover, null, [{
  ...
  function OuiPopover(props) {
    var _this;

    (0, _classCallCheck2.default)(this, OuiPopover);
  ...
  (0, _createClass2.default)(OuiPopover, [{
    key: "updateFocus",
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiPopover', anchorPosition ? anchorPositionToClassNameMap[anchorPosition] : null, display ? displayToClassNameMap[display] : null, {
        'ouiPopover-isOpen': this.state.isOpening
      }, className);
      var anchorClasses = (0, _classnames.default)('ouiPopover__anchor', anchorClassName);
      var panelClasses = (0, _classnames.default)('ouiPopover__panel', "ouiPopover__panel--".concat(this.state.arrowPosition), {
      ...
      if (!this.state.suppressingPopover && (isOpen || this.state.isClosing)) {
        ...
        if (ownFocus) {
          ...
          focusTrapScreenReaderText = /*#__PURE__*/_react.default.createElement(_accessibility.OuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("p", {
            id: descriptionId
        ...
        var arrowClassNames = (0, _classnames.default)('ouiPopover__panelArrow', "ouiPopover__panelArrow--".concat(this.state.arrowPosition));
        var returnFocus = this.state.isOpenStable ? returnFocusConfig : false;
        panel = /*#__PURE__*/_react.default.createElement(_portal.OuiPortal, {
          insert: insert
        }, /*#__PURE__*/_react.default.createElement(_focus_trap.OuiFocusTrap, (0, _extends2.default)({
        ...
        }), /*#__PURE__*/_react.default.createElement(_panel.OuiPanel, (0, _extends2.default)({}, panelProps, {
        ...
        }, arrowChildren), focusTrapScreenReaderText, /*#__PURE__*/_react.default.createElement(_mutation_observer.OuiMutationObserver, {
          observerOptions: {
            attributes: true,
      ...
      if (ownFocus) {
        ...
        return /*#__PURE__*/_react.default.createElement(_outside_click_detector.OuiOutsideClickDetector, {
...
exports.OuiPopover = OuiPopover;
(0, _defineProperty2.default)(OuiPopover, "defaultProps", {
  isOpen: false,
  ownFocus: true,
