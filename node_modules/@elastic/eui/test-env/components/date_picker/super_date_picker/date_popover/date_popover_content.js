...
exports.OuiDatePopoverContent = void 0;
...
var _date_popover_content = require("../../../../eui_components/date_picker/super_date_picker/date_popover/date_popover_content");
 ...
 * under the License.
 */
var OuiDatePopoverContent = function OuiDatePopoverContent(_ref) {
  ...
  var renderTabs = [{
    ...
    name: 'Absolute',
    content: /*#__PURE__*/_react.default.createElement(_absolute_tab.OuiAbsoluteTab, {
    ...
    name: 'Relative',
    content: /*#__PURE__*/_react.default.createElement(_relative_tab.OuiRelativeTab, {
      dateFormat: dateFormat,
      locale: locale,
    ...
    name: 'Now',
    content: /*#__PURE__*/_react.default.createElement(_text.OuiText, {
      size: "s",
      color: "subdued",
      className: "ouiDatePopoverContent__padded--large"
    }, /*#__PURE__*/_react.default.createElement("p", null, "Setting the time to \"now\" means that on every refresh this time will be set to the time of the refresh."), /*#__PURE__*/_react.default.createElement(_button.OuiButton, {
  ...
  return /*#__PURE__*/_react.default.createElement(_tabs.OuiTabbedContent, {
...
exports.OuiDatePopoverContent = OuiDatePopoverContent;
OuiDatePopoverContent.propTypes = {
