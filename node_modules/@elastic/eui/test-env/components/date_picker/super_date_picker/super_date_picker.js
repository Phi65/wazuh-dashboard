...
exports.OuiSuperDatePicker = void 0;
...
var _super_date_picker = require("../../../eui_components/date_picker/super_date_picker/super_date_picker");
...
var OuiSuperDatePicker = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiSuperDatePicker, _Component);

  var _super = _createSuper(OuiSuperDatePicker);

  function OuiSuperDatePicker() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiSuperDatePicker);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderDatePickerRange", function () {
      ...
      if (isAutoRefreshOnly) {
        return /*#__PURE__*/_react.default.createElement(_date_picker_range.OuiDatePickerRange, {
          ...
          className: "ouiSuperDatePicker__prettyFormat"
      ...
      if (showPrettyDuration && !isStartDatePopoverOpen && !isEndDatePopoverOpen) {
        return /*#__PURE__*/_react.default.createElement(_date_picker_range.OuiDatePickerRange, {
          ...
          className: (0, _classnames.default)('ouiSuperDatePicker__prettyFormat', {
          ...
          className: "ouiSuperDatePicker__prettyFormatLink"
      ...
      return /*#__PURE__*/_react.default.createElement(_context.OuiI18nConsumer, null, function (_ref4) {
        var contextLocale = _ref4.locale;
        return /*#__PURE__*/_react.default.createElement(_date_picker_range.OuiDatePickerRange, {
          className: "ouiDatePickerRange--inGroup",
          iconType: false,
          isCustom: true,
          startDateControl: /*#__PURE__*/_react.default.createElement(_date_popover_button.OuiDatePopoverButton, {
          ...
          endDateControl: /*#__PURE__*/_react.default.createElement(_date_popover_button.OuiDatePopoverButton, {
            position: "end",
            needsUpdating: hasChanged,
            isInvalid: isInvalid,
            isDisabled: isDisabled,
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderUpdateButton", function () {
      ...
      return /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, {
        grow: false
      }, /*#__PURE__*/_react.default.createElement(_super_update_button.OuiSuperUpdateButton, (0, _extends2.default)({
  ...
  (0, _createClass2.default)(OuiSuperDatePicker, [{
    key: "render",
    value: function render() {
      ...
      var quickSelect = /*#__PURE__*/_react.default.createElement(_quick_select_popover.OuiQuickSelectPopover, {
      ...
      var flexWrapperClasses = (0, _classnames.default)('ouiSuperDatePicker__flexWrapper', {
      ...
      return /*#__PURE__*/_react.default.createElement(_flex.OuiFlexGroup, {
        gutterSize: "s",
        responsive: false,
        className: flexWrapperClasses
      }, /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, null, /*#__PURE__*/_react.default.createElement(_form.OuiFormControlLayout, {
  ...
  return OuiSuperDatePicker;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiSuperDatePicker = OuiSuperDatePicker;
(0, _defineProperty2.default)(OuiSuperDatePicker, "defaultProps", {
