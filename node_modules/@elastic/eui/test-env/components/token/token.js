...
exports.OuiToken = exports.COLORS = exports.FILLS = exports.SHAPES = exports.SIZES = void 0;
...
var _token = require("../../eui_components/token/token");
...
var OuiToken = function OuiToken(_ref) {
  ...
  var finalFill = finalDisplay.fill || 'light'; // Color can be a named space via ouiColorVis
  ...
  var classes = (0, _classnames.default)('ouiToken', colorClass, shapeToClassMap[finalShape], fillToClassMap[finalFill], sizeToClassMap[size], className);
...
OuiToken.propTypes = {
  ...
  /**
     ...
     * Default: `gray`
     */
  color: _propTypes.default.oneOfType([_propTypes.default.oneOf(["ouiColorVis0", "ouiColorVis1", "ouiColorVis2", "ouiColorVis3", "ouiColorVis4", "ouiColorVis5", "ouiColorVis6", "ouiColorVis7", "ouiColorVis8", "ouiColorVis9", "gray"]).isRequired, _propTypes.default.string.isRequired]),
