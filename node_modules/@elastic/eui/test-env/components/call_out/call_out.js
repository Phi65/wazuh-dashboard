...
exports.OuiCallOut = exports.HEADINGS = exports.COLORS = void 0;
...
var _call_out = require("../../eui_components/call_out/call_out");
...
var OuiCallOut = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var classes = (0, _classnames.default)('ouiCallOut', colorToClassNameMap[color], sizeToClassNameMap[size], className);
  var headerIcon;
  ...
  if (children && size === 's') {
    optionalChildren = /*#__PURE__*/_react.default.createElement(_text.OuiText, {
      size: "xs",
      color: "default"
    }, children);
  } else if (children) {
...
exports.OuiCallOut = OuiCallOut;
OuiCallOut.propTypes = {
