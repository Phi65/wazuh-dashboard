...
exports.OuiFieldPassword = void 0;
...
var _field_password = require("../../../eui_components/form/field_password/field_password");
 ...
 * under the License.
 */
var OuiFieldPassword = function OuiFieldPassword(_ref) {
  ...
  var _useOuiI18n = (0, _i18n.useOuiI18n)(['ouiFieldPassword.showPassword', 'ouiFieldPassword.maskPassword'], ['Show password as plain text. Note: this will visually expose your password on the screen.', 'Mask password']),
      _useOuiI18n2 = (0, _slicedToArray2.default)(_useOuiI18n, 2),
      showPasswordLabel = _useOuiI18n2[0],
      maskPasswordLabel = _useOuiI18n2[1]; // Setup the inputRef to auto-focus when toggling visibility
  ...
  if (type === 'dual') {
    ...
    var visibilityToggle = /*#__PURE__*/_react.default.createElement(_button.OuiButtonIcon, (0, _extends2.default)({
  ...
  var classes = (0, _classnames.default)('ouiFieldPassword', {
...
exports.OuiFieldPassword = OuiFieldPassword;
