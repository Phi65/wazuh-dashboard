...
exports.OuiFormControlLayout = void 0;
...
var _form_control_layout = require("../../../eui_components/form/form_control_layout/form_control_layout");
...
var OuiFormControlLayout = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiFormControlLayout, _Component);

  var _super = _createSuper(OuiFormControlLayout);

  function OuiFormControlLayout() {
    (0, _classCallCheck2.default)(this, OuiFormControlLayout);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(OuiFormControlLayout, [{
    key: "render",
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiFormControlLayout', {
      ...
      }, children, /*#__PURE__*/_react.default.createElement(_form_control_layout_icons.OuiFormControlLayoutIcons, {
        icon: icon,
        clear: clear,
    ...
    value: function createFormLabel(side, string, inputId) {
      return /*#__PURE__*/_react.default.createElement(_form_label.OuiFormLabel, {
        htmlFor: inputId,
        className: "ouiFormControlLayout__".concat(side)
      }, string);
    }
  }, {
    key: "createSideNode",
    value: function createSideNode(side, node, key) {
      return /*#__PURE__*/(0, _react.cloneElement)(node, {
        className: (0, _classnames.default)("ouiFormControlLayout__".concat(side), node.props.className),
        key: key
      });
    }
  }]);
  return OuiFormControlLayout;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiFormControlLayout = OuiFormControlLayout;
OuiFormControlLayout.propTypes = {
