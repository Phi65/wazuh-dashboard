...
var _radio_group = require("../../../eui_components/form/radio/radio_group");
 ...
 * under the License.
 */
var OuiRadioGroup = function OuiRadioGroup(_ref) {
  ...
  var radios = options.map(function (option, index) {
    ...
    return /*#__PURE__*/_react.default.createElement(_radio.OuiRadio, (0, _extends2.default)({
      className: (0, _classnames.default)('ouiRadioGroup__item', optionClass),
      key: index,
      name: name,
...
exports.OuiRadioGroup = OuiRadioGroup;
OuiRadioGroup.propTypes = {
