...
var _super_select = require("../../../eui_components/form/super_select/super_select");
...
var OuiSuperSelect = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiSuperSelect, _Component);

  var _super = _createSuper(OuiSuperSelect);

  function OuiSuperSelect() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiSuperSelect);
  ...
  (0, _createClass2.default)(OuiSuperSelect, [{
    ...
    value: function render() {
      ...
      var popoverClasses = (0, _classnames.default)('ouiSuperSelect', popoverClassName);
      var buttonClasses = (0, _classnames.default)({
        'ouiSuperSelect--isOpen__button': this.state.isPopoverOpen
      }, className);
      var itemClasses = (0, _classnames.default)('ouiSuperSelect__item', {
        'ouiSuperSelect__item--hasDividers': hasDividers
      }, itemClassName);

      var button = /*#__PURE__*/_react.default.createElement(_super_select_control.OuiSuperSelectControl, (0, _extends2.default)({
        options: options,
      ...
      var items = options.map(function (option, index) {
        ...
        return /*#__PURE__*/_react.default.createElement(_context_menu.OuiContextMenuItem, (0, _extends2.default)({
          key: index,
      ...
      return /*#__PURE__*/_react.default.createElement(_popover.OuiInputPopover, {
  ...
  return OuiSuperSelect;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiSuperSelect = OuiSuperSelect;
(0, _defineProperty2.default)(OuiSuperSelect, "defaultProps", {
  hasDividers: false,
  fullWidth: false,
  compressed: false,
  isInvalid: false,
