...
exports.OuiCheckboxGroup = void 0;
...
var _checkbox_group = require("../../../eui_components/form/checkbox/checkbox_group");
 ...
 * under the License.
 */
var OuiCheckboxGroup = function OuiCheckboxGroup(_ref) {
  ...
  var checkboxes = options.map(function (option, index) {
    ...
    return /*#__PURE__*/_react.default.createElement(_checkbox.OuiCheckbox, (0, _extends2.default)({
      className: (0, _classnames.default)('ouiCheckboxGroup__item', optionClass),
      key: index,
  ...
  if (!!legend) {
    ...
    return /*#__PURE__*/_react.default.createElement(_form_fieldset.OuiFormFieldset, (0, _extends2.default)({
      className: className,
      legend: legend
    }, rest), checkboxes);
  }
...
exports.OuiCheckboxGroup = OuiCheckboxGroup;
