...
Object.defineProperty(exports, "EuiRangeHighlight", {
  enumerable: true,
  get: function get() {
    return _range_highlight.EuiRangeHighlight;
  }
});
exports.OuiRangeHighlight = void 0;
...
var _range_highlight = require("../../../eui_components/form/range/range_highlight");
 ...
 * under the License.
 */
var OuiRangeHighlight = function OuiRangeHighlight(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiRangeHighlight', {
    'ouiRangeHighlight--hasTicks': showTicks,
    'ouiRangeHighlight--compressed': compressed
  }, className);
  var progressClasses = (0, _classnames.default)('ouiRangeHighlight__progress', {
...
exports.OuiRangeHighlight = OuiRangeHighlight;
