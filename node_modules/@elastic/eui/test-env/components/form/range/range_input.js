...
Object.defineProperty(exports, "EuiRangeInput", {
  enumerable: true,
  get: function get() {
    return _range_input.EuiRangeInput;
  }
});
exports.OuiRangeInput = void 0;
...
var _range_input = require("../../../eui_components/form/range/range_input");
 ...
 * under the License.
 */
var OuiRangeInput = function OuiRangeInput(_ref) {
  var min = _ref.min,
      max = _ref.max,
      step = _ref.step,
      value = _ref.value,
  ...
  return /*#__PURE__*/_react.default.createElement(_field_number.OuiFieldNumber, (0, _extends2.default)({
    name: name,
    className: "ouiRangeInput ouiRangeInput--".concat(side),
    min: Number(min),
    max: Number(max),
    step: step,
...
exports.OuiRangeInput = OuiRangeInput;
