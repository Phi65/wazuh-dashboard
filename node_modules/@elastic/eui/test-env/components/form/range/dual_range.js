...
var _dual_range = require("../../../eui_components/form/range/dual_range");
...
var OuiDualRange = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiDualRange, _Component);

  var _super = _createSuper(OuiDualRange);

  function OuiDualRange() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiDualRange);
  ...
  (0, _createClass2.default)(OuiDualRange, [{
    ...
    value: function render() {
      ...
      var minInput = !!showInput ? /*#__PURE__*/_react.default.createElement(_range_input.OuiRangeInput // Overridable props
      , (0, _extends2.default)({
      ...
      var maxInput = !!showInput ? /*#__PURE__*/_react.default.createElement(_range_input.OuiRangeInput // Overridable props
      , (0, _extends2.default)({
        "aria-describedby": this.props['aria-describedby'],
        "aria-label": this.props['aria-label']
      }, maxInputProps, {
      ...
      var classes = (0, _classnames.default)('ouiDualRange', className);
      ...
      var theRange = /*#__PURE__*/_react.default.createElement(_range_wrapper.OuiRangeWrapper, {
        className: classes,
        fullWidth: fullWidth,
        compressed: compressed
        ...
        className: showTicks || ticks ? 'ouiRange__slimHorizontalSpacer' : 'ouiRange__horizontalSpacer'
      })), showLabels && /*#__PURE__*/_react.default.createElement(_range_label.OuiRangeLabel, {
        side: "min",
        disabled: disabled
      }, min), /*#__PURE__*/_react.default.createElement(_range_track.OuiRangeTrack, {
        compressed: compressed,
        disabled: disabled,
        max: max,
        min: min,
      ...
      }, /*#__PURE__*/_react.default.createElement(_range_slider.OuiRangeSlider, (0, _extends2.default)({
        className: "ouiDualRange__slider",
        ...
        onFocus: onFocus,
        onBlur: onBlur
      }, rest)), showRange && this.isValid && /*#__PURE__*/_react.default.createElement(_range_highlight.OuiRangeHighlight, {
        compressed: compressed,
        hasFocus: this.state.hasFocus,
        showTicks: showTicks,
        min: Number(min),
      ...
      }), this.state.rangeSliderRefAvailable && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, isDraggable && this.isValid && /*#__PURE__*/_react.default.createElement(_range_draggable.OuiRangeDraggable, {
        min: min,
        max: max,
        ...
        "aria-describedby": this.props['aria-describedby'],
        "aria-label": this.props['aria-label']
      }), /*#__PURE__*/_react.default.createElement(_range_thumb.OuiRangeThumb, {
        min: min,
        max: Number(this.upperValue),
        value: this.lowerValue,
        disabled: disabled,
      ...
      var thePopover = showInputOnly ? /*#__PURE__*/_react.default.createElement(_popover.OuiInputPopover, {
        className: "ouiRange__popover",
        input: /*#__PURE__*/_react.default.createElement(_form_control_layout.OuiFormControlLayoutDelimited, {
...
exports.OuiDualRange = OuiDualRange;
(0, _defineProperty2.default)(OuiDualRange, "defaultProps", {
  min: 0,
  max: 100,
  step: 1,
  fullWidth: false,
