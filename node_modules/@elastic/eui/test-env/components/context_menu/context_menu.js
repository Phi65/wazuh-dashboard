...
exports.OuiContextMenu = exports.SIZES = void 0;
...
var _context_menu = require("../../eui_components/context_menu/context_menu");
...
var OuiContextMenu = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiContextMenu, _Component);

  var _super = _createSuper(OuiContextMenu);

  (0, _createClass2.default)(OuiContextMenu, null, [{
  ...
  function OuiContextMenu(props) {
    var _this;

    (0, _classCallCheck2.default)(this, OuiContextMenu);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "mapIdsToRenderedItems", function () {
      ...
      var idToRenderedItemsMap = {}; // Pre-rendering the items lets us check reference equality inside of OuiContextMenuPanel.
  ...
  (0, _createClass2.default)(OuiContextMenu, [{
    ...
    value: function renderItems() {
      ...
      return items.map(function (item, index) {
        if (isItemSeparator(item)) {
          ...
          return /*#__PURE__*/_react.default.createElement(_horizontal_rule.OuiHorizontalRule, (0, _extends2.default)({
            key: _key,
            margin: "none"
          }, _rest));
        }
        ...
        return /*#__PURE__*/_react.default.createElement(_context_menu_item.OuiContextMenuItem, (0, _extends2.default)({
    ...
    value: function renderPanel(panelId, transitionType) {
      ...
      return /*#__PURE__*/_react.default.createElement(_context_menu_panel.OuiContextMenuPanel, {
        key: panelId,
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiContextMenu', size && sizeToClassNameMap[size], className);
  ...
  return OuiContextMenu;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiContextMenu = OuiContextMenu;
(0, _defineProperty2.default)(OuiContextMenu, "defaultProps", {
  panels: [],
  size: 'm'
});
