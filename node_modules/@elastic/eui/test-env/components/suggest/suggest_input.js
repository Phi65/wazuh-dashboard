...
exports.OuiSuggestInput = void 0;
...
var _suggest_input = require("../../eui_components/suggest/suggest_input");
...
var OuiSuggestInput = function OuiSuggestInput(props) {
  ...
  var classes = (0, _classnames.default)('ouiSuggestInput', className); // OuiFieldText's append accepts an array of elements so start by creating an empty array

  var appendArray = [];

  var statusElement = (status === 'saved' || status === 'unsaved') && /*#__PURE__*/_react.default.createElement(_tool_tip.OuiToolTip, {
    position: "left",
  ...
  var customInput = /*#__PURE__*/_react.default.createElement(_form.OuiFieldText, (0, _extends2.default)({
    value: value,
    fullWidth: true,
...
exports.OuiSuggestInput = OuiSuggestInput;
OuiSuggestInput.propTypes = {
