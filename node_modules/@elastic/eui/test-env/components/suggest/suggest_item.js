...
exports.OuiSuggestItem = exports.DISPLAYS = exports.COLORS = void 0;
...
var _suggest_item = require("../../eui_components/suggest/suggest_item");
...
var OuiSuggestItem = function OuiSuggestItem(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiSuggestItem', {
    'ouiSuggestItem-isClickable': onClick
  }, className);
  var colorClass = '';
  var labelDisplayCalculated = !description ? 'expand' : labelDisplay;
  var labelClassNames = (0, _classnames.default)('ouiSuggestItem__label', labelDisplayToClassMap[labelDisplayCalculated], (0, _defineProperty2.default)({}, "ouiSuggestItem__label--width".concat(labelWidth), labelDisplay === 'fixed'));
  var descriptionClassNames = (0, _classnames.default)('ouiSuggestItem__description', descriptionDisplayToClassMap[descriptionDisplay]);
  ...
  var innerContent = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("span", {
    className: "ouiSuggestItem__type ".concat(colorClass)
...
exports.OuiSuggestItem = OuiSuggestItem;
OuiSuggestItem.propTypes = {
