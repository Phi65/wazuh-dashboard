...
var _suggest = require("../../eui_components/suggest/suggest");
...
var OuiSuggest = function OuiSuggest(props) {
  ...
  var suggestionList = suggestions.map(function (item, index) {
    ...
    return /*#__PURE__*/_react.default.createElement(_suggest_item.OuiSuggestItem, (0, _extends2.default)({
      key: index
    }, props));
  });

  var suggestInput = /*#__PURE__*/_react.default.createElement(_suggest_input.OuiSuggestInput, (0, _extends2.default)({
    status: status,
...
exports.OuiSuggest = OuiSuggest;
OuiSuggest.propTypes = {
...
_suggest_input.OuiSuggestInput.defaultProps = {
  status: 'unchanged'
};
