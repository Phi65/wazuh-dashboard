...
exports.OuiSelectableListItem = void 0;
...
var _selectable_list_item = require("../../../eui_components/selectable/selectable_list/selectable_list_item");
...
var OuiSelectableListItem = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiSelectableListItem, _Component);

  var _super = _createSuper(OuiSelectableListItem);

  function OuiSelectableListItem(props) {
    (0, _classCallCheck2.default)(this, OuiSelectableListItem);
    return _super.call(this, props);
  }

  (0, _createClass2.default)(OuiSelectableListItem, [{
    key: "render",
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiSelectableListItem', {
      ...
      if (showIcons) {
        ...
        optionIcon = /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
      ...
      if (allowExclusions && checked === 'on') {
        state = /*#__PURE__*/_react.default.createElement(_accessibility.OuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
          token: "ouiSelectableListItem.includedOption",
          default: "Included option."
        })));
        instruction = /*#__PURE__*/_react.default.createElement(_accessibility.OuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
      ...
      if (prepend) {
        prependNode = /*#__PURE__*/_react.default.createElement("span", {
          className: "ouiSelectableListItem__prepend"
        }, prepend);
      }
      ...
      if (append || !!onFocusBadge) {
        ...
        if (onFocusBadge === true) {
          onFocusBadgeNode = /*#__PURE__*/_react.default.createElement(_badge.OuiBadge, (0, _extends2.default)({
          ...
          onFocusBadgeNode = /*#__PURE__*/_react.default.createElement(_badge.OuiBadge, (0, _extends2.default)({
            className: (0, _classnames.default)('ouiSelectableListItem__onFocusBadge', _className)
        ...
        if (append || isFocused && !disabled) {
          appendNode = /*#__PURE__*/_react.default.createElement("span", {
            className: "ouiSelectableListItem__append"
      ...
      return /*#__PURE__*/_react.default.createElement("li", (0, _extends2.default)({
        ...
        className: "ouiSelectableListItem__content"
      }, optionIcon, prependNode, /*#__PURE__*/_react.default.createElement("span", {
        className: "ouiSelectableListItem__text"
      }, state, children, instruction), appendNode));
    }
  }]);
  return OuiSelectableListItem;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiSelectableListItem = OuiSelectableListItem;
(0, _defineProperty2.default)(OuiSelectableListItem, "defaultProps", {
  showIcons: true,
  onFocusBadge: true
});
OuiSelectableListItem.propTypes = {
