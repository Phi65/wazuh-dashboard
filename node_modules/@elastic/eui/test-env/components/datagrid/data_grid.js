...
var _data_grid = require("../../eui_components/datagrid/data_grid");
  ...
  return /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
    ...
    return /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        className: "ouiDataGrid__pagination"
      }, /*#__PURE__*/_react.default.createElement(_table_pagination.OuiTablePagination, (0, _extends2.default)({
...
var OuiDataGrid = function OuiDataGrid(props) {
  ...
  var handleHeaderChange = (0, _react.useCallback)(function (headerRow) {
    ...
    var managed = headerRow.querySelectorAll('[data-ouigrid-tab-managed]');
  ...
  var classes = (0, _classnames.default)('ouiDataGrid', fontSizesToClassMap[gridStyles.fontSize], bordersToClassMap[gridStyles.border], headerToClassMap[gridStyles.header], footerToClassMap[gridStyles.footer], rowHoverToClassMap[gridStyles.rowHover], cellPaddingsToClassMap[gridStyles.cellPadding], {
  ...
  var fullScreenSelector = /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
    tokens: ['ouiDataGrid.fullScreenButton', 'ouiDataGrid.fullScreenButtonActive'],
    ...
    return /*#__PURE__*/_react.default.createElement(_button.OuiButtonEmpty, {
      size: "xs",
      iconType: "fullScreen",
      color: "text",
  ...
  var ariaLabel = (0, _i18n.useOuiI18n)('ouiDataGrid.ariaLabel', '{label}; Page {page} of {pageCount}.', {
    label: rest['aria-label'],
    page: pagination ? pagination.pageIndex + 1 : 0,
    pageCount: pagination ? Math.ceil(props.rowCount / pagination.pageSize) : 0
  });
  var ariaLabelledBy = (0, _i18n.useOuiI18n)('ouiDataGrid.ariaLabelledBy', 'Page {page} of {pageCount}.', {
    page: pagination ? pagination.pageIndex + 1 : 0,
    pageCount: pagination ? Math.ceil(props.rowCount / pagination.pageSize) : 0
  ...
  return /*#__PURE__*/_react.default.createElement(_data_grid_context.DataGridFocusContext.Provider, {
    ...
    className: "ouiDataGrid__overflow"
  }, inMemory ? /*#__PURE__*/_react.default.createElement(_data_grid_inmemory_renderer.OuiDataGridInMemoryRenderer, {
    inMemory: inMemory,
    ...
    role: "grid",
    id: gridId
  }, wrappingDivFocusProps, gridAriaProps), /*#__PURE__*/_react.default.createElement(_data_grid_body.OuiDataGridBody, {
...
exports.OuiDataGrid = OuiDataGrid;
OuiDataGrid.propTypes = {
