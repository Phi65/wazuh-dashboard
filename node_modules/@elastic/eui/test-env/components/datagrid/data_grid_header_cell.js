...
Object.defineProperty(exports, "EuiDataGridHeaderCell", {
  enumerable: true,
  get: function get() {
    return _data_grid_header_cell.EuiDataGridHeaderCell;
  }
});
exports.OuiDataGridHeaderCell = void 0;
...
var _data_grid_header_cell = require("../../eui_components/datagrid/data_grid_header_cell");
 ...
 * under the License.
 */
var OuiDataGridHeaderCell = function OuiDataGridHeaderCell(props) {
  ...
  var sortString;
  var actionButtonAriaLabel = (0, _i18n.useOuiI18n)('ouiDataGridHeaderCell.headerActions', 'Header actions');
  ...
  var classes = (0, _classnames2.default)('ouiDataGridHeaderCell', (0, _defineProperty2.default)({}, "ouiDataGridHeaderCell--".concat(columnType), columnType), className);
  ...
  var enableInteractives = (0, _react.useCallback)(function () {
    if (headerRef.current) {
      var interactiveElements = headerRef.current.querySelectorAll('[data-ouigrid-tab-managed]');
  ...
  var disableInteractives = (0, _react.useCallback)(function () {
    if (headerRef.current) {
      ...
      if (tababbles.length > 1) {
        console.warn("OuiDataGridHeaderCell expects at most 1 tabbable element, ".concat(tababbles.length, " found instead"));
      }
  ...
  (0, _react.useEffect)(function () {
    if (headerRef.current) {
      ...
      if (isFocused) {
        var interactives = headerRef.current.querySelectorAll('[data-ouigrid-tab-managed]');
  ...
  var sortingArrow = sortedColumn ? /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
  ...
  return /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({
  ...
  }), column.isResizable !== false && width != null ? /*#__PURE__*/_react.default.createElement(_data_grid_column_resizer.OuiDataGridColumnResizer, {
    columnId: id,
    columnWidth: width,
    setColumnWidth: setColumnWidth
  }) : null, sorting && sorting.columns.length >= 2 && /*#__PURE__*/_react.default.createElement(_accessibility2.OuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("div", {
    id: screenReaderId
    ...
    className: "ouiDataGridHeaderCell__content"
  }, display || displayAsText || id)) : /*#__PURE__*/_react.default.createElement(_popover.OuiPopover, {
    ...
    button: /*#__PURE__*/_react.default.createElement("button", {
      ...
      className: "ouiDataGridHeaderCell__content"
    }, display || displayAsText || id), /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
  ...
  }, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_list_group.OuiListGroup, {
...
exports.OuiDataGridHeaderCell = OuiDataGridHeaderCell;
OuiDataGridHeaderCell.propTypes = {
