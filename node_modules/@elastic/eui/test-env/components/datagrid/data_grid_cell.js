...
exports.OuiDataGridCell = void 0;
...
var _data_grid_cell = require("../../eui_components/datagrid/data_grid_cell");
...
var OuiDataGridCellContent = /*#__PURE__*/(0, _react.memo)(function (props) {
  ...
  var screenReaderPosition = /*#__PURE__*/_react.default.createElement(_accessibility.OuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
...
OuiDataGridCellContent.propTypes = {
...
var OuiDataGridCell = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiDataGridCell, _Component);

  var _super = _createSuper(OuiDataGridCell);

  function OuiDataGridCell() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiDataGridCell);
  ...
  (0, _createClass2.default)(OuiDataGridCell, [{
    ...
    value: function render() {
      ...
      var cellClasses = (0, _classnames.default)('ouiDataGridRowCell', (_classNames = {}, (0, _defineProperty2.default)(_classNames, "ouiDataGridRowCell--".concat(columnType), columnType), (0, _defineProperty2.default)(_classNames, 'ouiDataGridRowCell--open', this.state.popoverIsOpen), _classNames), className);
      ...
      var anchorContent = /*#__PURE__*/_react.default.createElement(_focus_trap.OuiFocusTrap, {
        ...
        className: "ouiDataGridRowCell__expandFlex ".concat(this.props.rowHeightsOptions ? 'ouiDataGridRowCell__alignBaseLine' : '')
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: !this.props.rowHeightsOptions ? 'ouiDataGridRowCell__expandContent' : 'ouiDataGridRowCell__contentByHeight'
      }, /*#__PURE__*/_react.default.createElement(OuiDataGridCellContent, cellContentProps))));
      ...
      if (isExpandable || column && column.cellActions) {
        if (showCellButtons) {
          anchorContent = /*#__PURE__*/_react.default.createElement("div", {
            ...
            className: !this.props.rowHeightsOptions ? 'ouiDataGridRowCell__expandContent' : 'ouiDataGridRowCell__contentByHeight'
          }, /*#__PURE__*/_react.default.createElement(OuiDataGridCellContent, cellContentProps)), showCellButtons && /*#__PURE__*/_react.default.createElement(_data_grid_cell_buttons.OuiDataGridCellButtons, {
            rowIndex: rowIndex,
            column: column,
      ...
      if (isExpandable || column && column.cellActions) {
        if (this.state.popoverIsOpen) {
          innerContent = /*#__PURE__*/_react.default.createElement("div", {
            className: !this.props.rowHeightsOptions ? 'ouiDataGridRowCell__content' : 'ouiDataGridRowCell__contentByHeight'
          }, /*#__PURE__*/_react.default.createElement(_data_grid_cell_popover.OuiDataGridCellPopover, {
  ...
  return OuiDataGridCell;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiDataGridCell = OuiDataGridCell;
(0, _defineProperty2.default)(OuiDataGridCell, "contextType", _data_grid_context.DataGridFocusContext);
OuiDataGridCell.propTypes = {
  rowIndex: _propTypes.default.number.isRequired,
  visibleRowIndex: _propTypes.default.number.isRequired,
  colIndex: _propTypes.default.number.isRequired,
  column: _propTypes.default.shape({
