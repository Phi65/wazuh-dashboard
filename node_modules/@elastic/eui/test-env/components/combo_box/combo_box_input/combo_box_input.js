...
var OuiComboBoxInput = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiComboBoxInput, _Component);
  ...
  function OuiComboBoxInput() {
    ...
    (0, _classCallCheck2.default)(this, OuiComboBoxInput);
  ...
  (0, _createClass2.default)(OuiComboBoxInput, [{
    ...
    value: function render() {
      ...
      var pills = selectedOptions ? selectedOptions.map(function (option) {
        ...
        return /*#__PURE__*/_react.default.createElement(_combo_box_pill.OuiComboBoxPill, (0, _extends2.default)({
          option: option,
          onClose: pillOnClose,
