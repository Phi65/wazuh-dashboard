...
var _combo_box = require("../../eui_components/combo_box/combo_box");
...
var OuiComboBox = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiComboBox, _Component);

  var _super = _createSuper(OuiComboBox);

  function OuiComboBox() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiComboBox);
  ...
  (0, _createClass2.default)(OuiComboBox, [{
    ...
    value: function render() {
      var _this$props8 = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props8, ["data-test-subj", "async", "className", "compressed", "customOptionText", "fullWidth", "icon", "id", "inputRef", "isClearable", "isDisabled", "isInvalid", "isLoading", "noSuggestions", "onBlur", "onChange", "onCreateOption", "onSearchChange", "options", "placeholder", "renderOption", "rowHeight", "selectedOptions", "singleSelection", "prepend", "sortMatchesBy", "delimiter", "append", "autoFocus"]);
      ...
      var classes = (0, _classnames.default)('ouiComboBox', className, {
      ...
      if (!noSuggestions && isListOpen) {
        ...
        optionsList = /*#__PURE__*/_react.default.createElement(_portal.OuiPortal, null, /*#__PURE__*/_react.default.createElement(_combo_box_options_list.OuiComboBoxOptionsList, {
      ...
      return (
        ...
        _react.default.createElement("div", (0, _extends2.default)({}, rest, {
          ...
          role: "combobox"
        }), /*#__PURE__*/_react.default.createElement(_combo_box_input.OuiComboBoxInput, {
...
exports.OuiComboBox = OuiComboBox;
(0, _defineProperty2.default)(OuiComboBox, "defaultProps", {
  async: false,
  compressed: false,
  fullWidth: false,
  isClearable: true,
