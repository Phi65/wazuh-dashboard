...
exports.OuiComboBoxOptionsList = void 0;
...
var _combo_box_options_list = require("../../../eui_components/combo_box/combo_box_options_list/combo_box_options_list");
...
var OPTION_CONTENT_CLASSNAME = 'ouiComboBoxOption__content';

var hitEnterBadge = /*#__PURE__*/_react.default.createElement(_badge.OuiBadge, {
...
var OuiComboBoxOptionsList = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiComboBoxOptionsList, _Component);

  var _super = _createSuper(OuiComboBoxOptionsList);

  function OuiComboBoxOptionsList() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiComboBoxOptionsList);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "ListRow", function (_ref) {
      ...
      if (isGroupLabelOption) {
        return /*#__PURE__*/_react.default.createElement("div", {
          ...
          style: style
        }, /*#__PURE__*/_react.default.createElement(_combo_box_title.OuiComboBoxTitle, null, label));
      }
      ...
      return /*#__PURE__*/_react.default.createElement(_filter_select_item.OuiFilterSelectItem, (0, _extends2.default)({
        style: style,
        ...
        className: "ouiComboBoxOption__contentWrapper"
      }, renderOption ? /*#__PURE__*/_react.default.createElement("span", {
        className: OPTION_CONTENT_CLASSNAME
      }, renderOption(option, searchValue, 'ouiComboBoxOption__renderOption')) : /*#__PURE__*/_react.default.createElement(_highlight.OuiHighlight, {
        search: searchValue,
        className: OPTION_CONTENT_CLASSNAME
  ...
  (0, _createClass2.default)(OuiComboBoxOptionsList, [{
    ...
    value: function render() {
      ...
      if (isLoading) {
        emptyStateContent = /*#__PURE__*/_react.default.createElement(_flex.OuiFlexGroup, {
          gutterSize: "s",
        ...
        if (onCreateOption && getSelectedOptionForSearchValue) {
          if (delimiter && searchValue.includes(delimiter)) {
            emptyStateContent = /*#__PURE__*/_react.default.createElement("div", {
              ...
              className: "ouiComboBoxOption__emptyStateText"
            }, /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
            ...
            if (selectedOptionForValue) {
              ...
              emptyStateContent = /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
      ...
      var emptyState = emptyStateContent ? /*#__PURE__*/_react.default.createElement(_text.OuiText, {
        size: "xs",
        className: "ouiComboBoxOptionsList__empty"
      ...
      var classes = (0, _classnames.default)('ouiComboBoxOptionsList', 'ouiPopover__panel', 'ouiPopover__panel-isAttached', 'ouiPopover__panel-noArrow', 'ouiPopover__panel-isOpen', "ouiPopover__panel--".concat(position));
      return /*#__PURE__*/_react.default.createElement(_panel.OuiPanel, (0, _extends2.default)({
        paddingSize: "none",
        hasShadow: false,
        className: classes,
        ...
        className: "ouiComboBoxOptionsList__rowWrap"
      }, emptyState || optionsList));
    }
  }]);
  return OuiComboBoxOptionsList;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiComboBoxOptionsList = OuiComboBoxOptionsList;
(0, _defineProperty2.default)(OuiComboBoxOptionsList, "defaultProps", {
  'data-test-subj': '',
  rowHeight: 29 // row height of default option renderer

});
OuiComboBoxOptionsList.propTypes = {
