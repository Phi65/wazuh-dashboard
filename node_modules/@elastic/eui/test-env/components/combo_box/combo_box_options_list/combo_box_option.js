...
exports.OuiComboBoxOption = void 0;
...
var _combo_box_option = require("../../../eui_components/combo_box/combo_box_options_list/combo_box_option");
...
var OuiComboBoxOption = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiComboBoxOption, _Component);

  var _super = _createSuper(OuiComboBoxOption);

  function OuiComboBoxOption() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiComboBoxOption);
  ...
  (0, _createClass2.default)(OuiComboBoxOption, [{
    key: "render",
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiComboBoxOption', className, {
  ...
  return OuiComboBoxOption;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiComboBoxOption = OuiComboBoxOption;
OuiComboBoxOption.propTypes = {
