...
exports.OuiBottomBar = exports.POSITIONS = exports.paddingSizeToClassNameMap = void 0;
...
var _bottom_bar = require("../../eui_components/bottom_bar/bottom_bar");
...
var OuiBottomBar = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var classes = (0, _classnames.default)('ouiBottomBar', "ouiBottomBar--".concat(position), paddingSizeToClassNameMap[paddingSize], className);
  ...
  var bar = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
    ...
    return (
      ...
      _react.default.createElement("section", (0, _extends2.default)({
        ...
        ref: setRef,
        style: newStyle
      }, rest), /*#__PURE__*/_react.default.createElement(_accessibility.OuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("h2", null, landmarkHeading ? landmarkHeading : screenReaderHeading)), children)
    );
  ...
  return usePortal ? /*#__PURE__*/_react.default.createElement(_portal.OuiPortal, null, bar) : bar;
});
exports.OuiBottomBar = OuiBottomBar;
