...
var _comment_list = require("../../eui_components/comment_list/comment_list");
 ...
 * under the License.
 */
var OuiCommentList = function OuiCommentList(_ref) {
  var children = _ref.children,
      className = _ref.className,
      comments = _ref.comments,
      rest = (0, _objectWithoutProperties2.default)(_ref, ["children", "className", "comments"]);
  var classes = (0, _classnames.default)('ouiCommentList', className);
  var commentElements = null;

  if (comments) {
    commentElements = comments.map(function (item, index) {
      return /*#__PURE__*/_react.default.createElement(_comment.OuiComment, (0, _extends2.default)({
        key: index
      }, item));
    });
  }
...
exports.OuiCommentList = OuiCommentList;
OuiCommentList.propTypes = {
