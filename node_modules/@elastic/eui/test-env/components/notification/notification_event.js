...
exports.OuiNotificationEvent = void 0;
...
var _notification_event = require("../../eui_components/notification/notification_event");
 ...
 * under the License.
 */
var OuiNotificationEvent = function OuiNotificationEvent(_ref) {
  var id = _ref.id,
      type = _ref.type,
  ...
  var classes = (0, _classnames.default)('ouiNotificationEvent', {
    'ouiNotificationEvent--withReadState': typeof isRead === 'boolean'
  });
  var classesTitle = (0, _classnames.default)('ouiNotificationEvent__title', {
  ...
  return /*#__PURE__*/_react.default.createElement("article", {
    ...
    className: "ouiNotificationEvent__readButton"
  }, !!onRead ? /*#__PURE__*/_react.default.createElement(_notification_event_read_button.OuiNotificationEventReadButton, {
    isRead: isRead,
    ...
    eventName: title,
    id: id
  }) : /*#__PURE__*/_react.default.createElement(_notification_event_read_icon.OuiNotificationEventReadIcon, {
    id: id,
    isRead: isRead,
    eventName: title
  })), /*#__PURE__*/_react.default.createElement("div", {
    className: "ouiNotificationEvent__content"
  }, /*#__PURE__*/_react.default.createElement(_notification_event_meta.OuiNotificationEventMeta, {
    id: id,
    type: type,
    severity: severity,
    ...
    eventName: title
  }), onClickTitle ? /*#__PURE__*/_react.default.createElement(_link.OuiLink, (0, _extends2.default)({
    onClick: function onClick() {
      return onClickTitle(id);
    }
  }, titleProps), /*#__PURE__*/(0, _react.createElement)(headingLevel, null, title)) : /*#__PURE__*/(0, _react.createElement)(headingLevel, titleProps, title), /*#__PURE__*/_react.default.createElement(_notification_event_messages.OuiNotificationEventMessages, {
    messages: messages,
    eventName: title
  }), onClickPrimaryAction && primaryAction && /*#__PURE__*/_react.default.createElement("div", {
    className: "ouiNotificationEvent__primaryAction"
  }, /*#__PURE__*/_react.default.createElement(_button.OuiButtonEmpty, (0, _extends2.default)({
    flush: "left",
    size: "s"
  }, primaryActionProps, {
    onClick: function onClick() {
...
exports.OuiNotificationEvent = OuiNotificationEvent;
OuiNotificationEvent.propTypes = {
  /**
