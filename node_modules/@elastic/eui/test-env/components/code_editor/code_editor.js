...
var _code_editor = require("../../eui_components/code_editor/code_editor");
...
var OuiCodeEditor = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiCodeEditor, _Component);
  ...
  function OuiCodeEditor() {
    ...
    (0, _classCallCheck2.default)(this, OuiCodeEditor);
  ...
  (0, _createClass2.default)(OuiCodeEditor, [{
    key: "stopEditing",
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiCodeEditorWrapper', {
        'ouiCodeEditorWrapper-isEditing': this.state.isEditing
      });
      var promptClasses = (0, _classnames.default)('ouiCodeEditorKeyboardHint', {
      ...
      var prompt = /*#__PURE__*/_react.default.createElement("button", {
        ...
        className: "ouiText"
      }, isReadOnly ? /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
...
exports.OuiCodeEditor = OuiCodeEditor;
(0, _defineProperty2.default)(OuiCodeEditor, "defaultProps", {
  setOptions: {}
});
