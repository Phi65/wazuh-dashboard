...
exports.OuiGlobalToastList = exports.TOAST_FADE_OUT_MS = exports.SIDES = void 0;
...
var _global_toast_list = require("../../eui_components/toast/global_toast_list");
...
var OuiGlobalToastList = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiGlobalToastList, _Component);

  var _super = _createSuper(OuiGlobalToastList);

  function OuiGlobalToastList() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiGlobalToastList);
  ...
  (0, _createClass2.default)(OuiGlobalToastList, [{
    ...
    value: function render() {
      ...
      var renderedToasts = toasts.map(function (toast) {
        ...
        return /*#__PURE__*/_react.default.createElement(_global_toast_list_item.OuiGlobalToastListItem, {
          key: toast.id,
          isDismissed: _this3.state.toastIdToDismissedMap[toast.id]
        }, /*#__PURE__*/_react.default.createElement(_toast.OuiToast, (0, _extends2.default)({
          onClose: _this3.dismissToast.bind(_this3, toast),
          onFocus: _this3.onMouseEnter,
          onBlur: _this3.onMouseLeave
        }, rest), text));
      });
      var classes = (0, _classnames.default)('ouiGlobalToastList', side ? sideToClassNameMap[side] : null, className);
  ...
  return OuiGlobalToastList;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiGlobalToastList = OuiGlobalToastList;
(0, _defineProperty2.default)(OuiGlobalToastList, "defaultProps", {
  toasts: [],
  side: 'right'
});
OuiGlobalToastList.propTypes = {
