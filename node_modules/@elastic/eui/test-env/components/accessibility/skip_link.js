...
exports.OuiSkipLink = exports.POSITIONS = void 0;
...
var _skip_link = require("../../eui_components/accessibility/skip_link");
...
var OuiSkipLink = function OuiSkipLink(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiSkipLink', ["ouiSkipLink--".concat(position)], className); // Create the `href` from `destinationId`
  ...
  return /*#__PURE__*/_react.default.createElement(_screen_reader.OuiScreenReaderOnly, {
    showOnFocus: true
  }, /*#__PURE__*/_react.default.createElement(_button.OuiButton, (0, _extends2.default)({
    className: classes,
...
exports.OuiSkipLink = OuiSkipLink;
OuiSkipLink.propTypes = {
