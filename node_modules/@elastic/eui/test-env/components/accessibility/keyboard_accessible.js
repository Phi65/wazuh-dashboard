...
exports.OuiKeyboardAccessible = void 0;
...
var _keyboard_accessible = require("../../eui_components/accessibility/keyboard_accessible");
...
var OuiKeyboardAccessible = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiKeyboardAccessible, _Component);

  var _super = _createSuper(OuiKeyboardAccessible);

  function OuiKeyboardAccessible() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiKeyboardAccessible);
  ...
  (0, _createClass2.default)(OuiKeyboardAccessible, [{
    key: "render",
    value: function render() {
      return this.applyKeyboardAccessibility(this.props.children);
    }
  }]);
  return OuiKeyboardAccessible;
}(_react.Component); // @ts-ignore defining this as a static on OuiKeyboardAccessible breaks the
// tests


exports.OuiKeyboardAccessible = OuiKeyboardAccessible;
