...
var _search_bar = require("../../eui_components/search_bar/search_bar");
...
var OuiSearchBar = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiSearchBar, _Component);

  var _super = _createSuper(OuiSearchBar);

  function OuiSearchBar(props) {
    var _this;

    (0, _classCallCheck2.default)(this, OuiSearchBar);
  ...
  (0, _createClass2.default)(OuiSearchBar, [{
    ...
    value: function render() {
      ...
      var filtersBar = !filters ? undefined : /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, {
        className: "ouiSearchBar__filtersHolder",
        grow: false
      }, /*#__PURE__*/_react.default.createElement(_search_filters.OuiSearchFilters, {
        filters: filters,
        query: query,
      ...
      return /*#__PURE__*/_react.default.createElement(_flex.OuiFlexGroup, {
        ...
        alignItems: "center",
        wrap: true
      }, toolsLeftEl, /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, {
        className: "ouiSearchBar__searchHolder",
        grow: true
      }, /*#__PURE__*/_react.default.createElement(_search_box.OuiSearchBox, (0, _extends2.default)({}, box, {
        query: queryText,
...
exports.OuiSearchBar = OuiSearchBar;
(0, _defineProperty2.default)(OuiSearchBar, "Query", _query2.Query);
