...
var GRANULARITY_KEY = '__oui_granularity';
var FORMAT_KEY = '__oui_format';
...
var dateFormat = Object.freeze({
  ...
  print: function print(date) {
    ...
    var ouiDate = date;
    var now = utc();
    var format = ouiDate[FORMAT_KEY];

    if (!format) {
      return date.format(_format.dateFormatAliases.iso8601);
    }

    var granularity = ouiDate[GRANULARITY_KEY] || defaultGranularity;
