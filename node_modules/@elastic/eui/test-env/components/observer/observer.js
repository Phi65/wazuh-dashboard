...
Object.defineProperty(exports, "EuiObserver", {
  enumerable: true,
  get: function get() {
    return _observer.EuiObserver;
  }
});
exports.OuiObserver = void 0;
...
var _observer = require("../../eui_components/observer/observer");
...
var OuiObserver = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiObserver, _Component);

  var _super = _createSuper(OuiObserver);

  function OuiObserver() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiObserver);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "name", 'OuiObserver');
  ...
  (0, _createClass2.default)(OuiObserver, [{
...
exports.OuiObserver = OuiObserver;