...
exports.OuiDescriptionList = exports.TEXT_STYLES = exports.ALIGNMENTS = exports.TYPES = void 0;
...
var _description_list = require("../../eui_components/description_list/description_list");
...
var OuiDescriptionList = function OuiDescriptionList(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiDescriptionList', type ? typesToClassNameMap[type] : undefined, align ? alignmentsToClassNameMap[align] : undefined, textStyle ? textStylesToClassNameMap[textStyle] : undefined, {
  ...
  if (listItems) {
    childrenOrListItems = listItems.map(function (item, index) {
      return [/*#__PURE__*/_react.default.createElement(_description_list_title.OuiDescriptionListTitle, (0, _extends2.default)({
        key: "title-".concat(index)
      }, titleProps), item.title), /*#__PURE__*/_react.default.createElement(_description_list_description.OuiDescriptionListDescription, (0, _extends2.default)({
...
exports.OuiDescriptionList = OuiDescriptionList;
