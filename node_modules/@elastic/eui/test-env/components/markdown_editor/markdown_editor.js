...
exports.OuiMarkdownEditor = void 0;
...
var _markdown_editor = require("../../eui_components/markdown_editor/markdown_editor");
...
var OuiMarkdownEditor = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var toolbarPlugins = (0, _toConsumableArray2.default)(uiPlugins); // @ts-ignore __originatedFromOui is a custom property

  if (!uiPlugins.__originatedFromOui) {
    toolbarPlugins.unshift(MarkdownTooltip.plugin);
    console.warn('Deprecation warning: uiPlugins passed to OuiMarkdownEditor does not include the tooltip plugin, which has been added for you. This automatic inclusion has been deprecated and will be removed in the future, see https://github.com/elastic/eui/pull/4383');
  }
  ...
  var classes = (0, _classnames.default)('ouiMarkdownEditor', {
  ...
  return /*#__PURE__*/_react.default.createElement(_markdown_context.OuiMarkdownContext.Provider, {
    value: contextValue
  }, /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({
    className: classes
  }, rest), /*#__PURE__*/_react.default.createElement(_markdown_editor_toolbar.OuiMarkdownEditorToolbar, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_markdown_format.OuiMarkdownFormat, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_markdown_editor_drop_zone.OuiMarkdownEditorDropZone, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_resize_observer.OuiResizeObserver, {
    onResize: onResize
  }, function (resizeRef) {
    return /*#__PURE__*/_react.default.createElement(_markdown_editor_text_area.OuiMarkdownEditorTextArea, (0, _extends2.default)({
  ...
  })), pluginEditorPlugin && /*#__PURE__*/_react.default.createElement(_modal.OuiModal, {
...
exports.OuiMarkdownEditor = OuiMarkdownEditor;
OuiMarkdownEditor.propTypes = {
