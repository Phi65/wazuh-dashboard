...
exports.ouiCardSelectableColor = ouiCardSelectableColor;
...
var _card_select = require("../../eui_components/card/card_select");
 ...
 * under the License.
 */
var OuiCardSelect = function OuiCardSelect(_ref) {
  ...
  var child = ouiCardSelectableText(isSelected, isDisabled, children);
  var selectClasses = (0, _classnames.default)('ouiCardSelect', "ouiCardSelect--".concat(ouiCardSelectableColor(color, isSelected)), className);
  return /*#__PURE__*/_react.default.createElement(_button_empty.OuiButtonEmpty, (0, _extends2.default)({
...
exports.OuiCardSelect = OuiCardSelect;
OuiCardSelect.propTypes = {
...
function ouiCardSelectableText(isSelected, isDisabled, children) {
  if (children) {
    return children;
  }
  ...
  if (isSelected) {
    text = /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
      token: "ouiCardSelect.selected",
      default: "Selected"
    });
  } else if (isDisabled) {
    text = /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
      token: "ouiCardSelect.unavailable",
      default: "Unavailable"
    });
  } else {
    text = /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
      token: "ouiCardSelect.select",
      default: "Select"
    });
  }
...
function ouiCardSelectableColor(color, isSelected) {
  var calculatedColor;
