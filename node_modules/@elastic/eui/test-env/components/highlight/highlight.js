...
var _highlight = require("../../eui_components/highlight/highlight");
...
var highlight = function highlight(searchSubject, searchValue, isStrict, highlightAll) {
  ...
  if (highlightAll) {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, chunks.map(function (chunk) {
      ...
      if (highlight) {
        return /*#__PURE__*/_react.default.createElement(_mark.OuiMark, {
          key: start
        }, value);
      }
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, preMatch, /*#__PURE__*/_react.default.createElement(_mark.OuiMark, null, match), postMatch);
};
...
var OuiHighlight = function OuiHighlight(_ref) {
...
exports.OuiHighlight = OuiHighlight;
OuiHighlight.propTypes = {
