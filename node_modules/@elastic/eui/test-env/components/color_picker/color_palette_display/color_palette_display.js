...
exports.OuiColorPaletteDisplay = exports.SIZES = void 0;
...
var _color_palette_display = require("../../../eui_components/color_picker/color_palette_display/color_palette_display");
...
var OuiColorPaletteDisplay = function OuiColorPaletteDisplay(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiColorPaletteDisplay', className, sizeToClassNameMap[size]);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, type === 'fixed' ? /*#__PURE__*/_react.default.createElement(_color_palette_display_fixed.OuiColorPaletteDisplayFixed, (0, _extends2.default)({
    className: classes,
    palette: palette
  }, rest)) : /*#__PURE__*/_react.default.createElement(_color_palette_display_gradient.OuiColorPaletteDisplayGradient, (0, _extends2.default)({
    className: classes,
    palette: palette
  }, rest)));
};
...
exports.OuiColorPaletteDisplay = OuiColorPaletteDisplay;
