...
exports.OuiToolTip = exports.POSITIONS = void 0;
...
var _tool_tip = require("../../eui_components/tool_tip/tool_tip");
...
var OuiToolTip = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiToolTip, _Component);

  var _super = _createSuper(OuiToolTip);

  function OuiToolTip() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiToolTip);
  ...
  (0, _createClass2.default)(OuiToolTip, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiToolTip', positionsToClassNameMap[this.state.calculatedPosition], className);
      var anchorClasses = (0, _classnames.default)('ouiToolTipAnchor', display ? displayToClassNameMap[display] : null, anchorClassName);
      var tooltip;

      if (visible && (content || title)) {
        tooltip = /*#__PURE__*/_react.default.createElement(_portal.OuiPortal, null, /*#__PURE__*/_react.default.createElement(_tool_tip_popover.OuiToolTipPopover, (0, _extends2.default)({
          className: classes,
          style: toolTipStyles,
...
exports.OuiToolTip = OuiToolTip;
(0, _defineProperty2.default)(OuiToolTip, "defaultProps", {
  position: 'top',
  delay: 'regular'
});
