...
Object.defineProperty(exports, "EuiToolTipPopover", {
  enumerable: true,
  get: function get() {
    return _tool_tip_popover.EuiToolTipPopover;
  }
});
exports.OuiToolTipPopover = void 0;
...
var _tool_tip_popover = require("../../eui_components/tool_tip/tool_tip_popover");
...
var OuiToolTipPopover = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiToolTipPopover, _Component);

  var _super = _createSuper(OuiToolTipPopover);

  function OuiToolTipPopover() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiToolTipPopover);
  ...
  (0, _createClass2.default)(OuiToolTipPopover, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiToolTipPopover', className);
      var optionalTitle;

      if (title) {
        optionalTitle = /*#__PURE__*/_react.default.createElement("div", {
          className: "ouiToolTip__title"
        }, title);
      }
  ...
  return OuiToolTipPopover;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiToolTipPopover = OuiToolTipPopover;
OuiToolTipPopover.propTypes = {
