...
var _delay_render = require("../../eui_components/delay_render/delay_render");
...
var OuiDelayRender = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiDelayRender, _Component);

  var _super = _createSuper(OuiDelayRender);

  function OuiDelayRender(props) {
    var _this;

    (0, _classCallCheck2.default)(this, OuiDelayRender);
  ...
  (0, _createClass2.default)(OuiDelayRender, [{
    key: "shouldUpdate",
  ...
  return OuiDelayRender;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiDelayRender = OuiDelayRender;
(0, _defineProperty2.default)(OuiDelayRender, "defaultProps", {
  delay: 500
});
OuiDelayRender.propTypes = {
