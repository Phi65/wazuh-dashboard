...
var _delay_hide = require("../../eui_components/delay_hide/delay_hide");
...
var OuiDelayHide = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiDelayHide, _Component);

  var _super = _createSuper(OuiDelayHide);

  function OuiDelayHide() {
    var _this;

    (0, _classCallCheck2.default)(this, OuiDelayHide);
  ...
  (0, _createClass2.default)(OuiDelayHide, [{
...
exports.OuiDelayHide = OuiDelayHide;
(0, _defineProperty2.default)(OuiDelayHide, "defaultProps", {
  hide: false,
