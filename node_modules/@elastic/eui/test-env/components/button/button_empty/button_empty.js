...
exports.OuiButtonEmpty = exports.FLUSH_TYPES = exports.SIZES = exports.COLORS = void 0;
...
var _button_empty = require("../../../eui_components/button/button_empty/button_empty");
...
var OuiButtonEmpty = function OuiButtonEmpty(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiButtonEmpty', colorToClassNameMap[color], size ? sizeToClassNameMap[size] : null, flush ? flushTypeToClassNameMap[flush] : null, {
    'ouiButtonEmpty-isDisabled': buttonIsDisabled
  }, className);
  var contentClassNames = (0, _classnames.default)('ouiButtonEmpty__content', contentProps && contentProps.className);
  var textClassNames = (0, _classnames.default)('ouiButtonEmpty__text', textProps && textProps.className);
...
exports.OuiButtonEmpty = OuiButtonEmpty;
OuiButtonEmpty.propTypes = {
