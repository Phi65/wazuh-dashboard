...
Object.defineProperty(exports, "EuiButtonContent", {
  enumerable: true,
  get: function get() {
    return _button_content.EuiButtonContent;
  }
});
exports.OuiButtonContent = exports.ICON_SIDES = void 0;
...
var _button_content = require("../../eui_components/button/button_content");
...
var OuiButtonContent = function OuiButtonContent(_ref) {
  ...
  if (isLoading) {
    buttonIcon = /*#__PURE__*/_react.default.createElement(_loading.OuiLoadingSpinner, {
      className: "ouiButtonContent__spinner",
      size: "m"
    });
  } else if (iconType) {
    buttonIcon = /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
  ...
  var contentClassNames = (0, _classnames.default)('ouiButtonContent', iconSide ? iconSideToClassNameMap[iconSide] : null, contentProps && contentProps.className);
...
exports.OuiButtonContent = OuiButtonContent;
OuiButtonContent.propTypes = {
  /**
