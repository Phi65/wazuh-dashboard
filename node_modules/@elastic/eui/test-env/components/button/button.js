...
exports.OuiButton = exports.OuiButtonDisplay = exports.SIZES = exports.sizeToClassNameMap = exports.COLORS = exports.colorToClassNameMap = void 0;
...
var _button = require("../../eui_components/button/button");
 ...
 */
var OuiButtonDisplay = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var contentClassNames = (0, _classnames.default)('ouiButton__content', contentProps && contentProps.className);
  var textClassNames = (0, _classnames.default)('ouiButton__text', textProps && textProps.className);

  var innerNode = /*#__PURE__*/_react.default.createElement(_button_content.OuiButtonContent, (0, _extends2.default)({
    isLoading: isLoading,
    iconType: iconType,
    iconSide: iconSide,
...
exports.OuiButtonDisplay = OuiButtonDisplay;
OuiButtonDisplay.propTypes = {
...
var OuiButton = function OuiButton(_ref2) {
  ...
  return /*#__PURE__*/_react.default.createElement(OuiButtonDisplay, (0, _extends2.default)({
    element: element,
