...
exports.OuiImage = exports.SIZES = void 0;
...
var _image = require("../../eui_components/image/image");
...
var OuiImage = function OuiImage(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiImage', {
  ...
  var allowFullScreenButtonClasses = 'ouiImage__button'; // when the button is not custom we need it to go full width
  ...
  if (typeof size === 'string' && size !== 'original' && SIZES.includes(size)) {
    allowFullScreenButtonClasses = "".concat(allowFullScreenButtonClasses, " ouiImage__button--fullWidth");
  } else {
  ...
  if (caption) {
    optionalCaption = /*#__PURE__*/_react.default.createElement("figcaption", {
      ...
      className: "ouiImage__caption"
    }, caption);
  }

  var allowFullScreenIcon = /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
    type: "fullScreen",
    color: fullScreenIconColorMap[fullScreenIconColor],
    className: "ouiImage__icon"
  });

  var fullScreenDisplay = /*#__PURE__*/_react.default.createElement(_overlay_mask.OuiOverlayMask, {
    ...
    type: "button",
    "aria-label": (0, _i18n.useOuiI18n)('ouiImage.closeImage', 'Close full screen {alt} image', {
      alt: alt
    }),
  ...
  }, rest))), optionalCaption), /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
    type: "cross",
    color: "default",
    className: "ouiImage-isFullScreenCloseIcon"
  }))));

  var fullscreenLabel = (0, _i18n.useOuiI18n)('ouiImage.openImage', 'Open full screen {alt} image', {
    alt: alt
  });
