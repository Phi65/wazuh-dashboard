    ...
    value: function render() {
      ...
      var controls = actions.reduce(function (controls, action, index) {
        ...
        if (actionIsCustomItemAction(action)) {
          ...
          controls.push( /*#__PURE__*/_react.default.createElement(_context_menu.OuiContextMenuItem, {
            key: key,
      ...
      var popoverButton = /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
        token: "ouiCollapsedItemActions.allActions",
        default: "All actions"
      }, function (allActions) {
      ...
      var withTooltip = !allDisabled && /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
        token: "ouiCollapsedItemActions.allActions",
        default: "All actions"
      }, function (allActions) {
