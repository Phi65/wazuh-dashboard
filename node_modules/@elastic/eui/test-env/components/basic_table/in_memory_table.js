...
exports.OuiInMemoryTable = void 0;
...
var _in_memory_table = require("../../eui_components/basic_table/in_memory_table");
...
function isOuiSearchBarProps(x) {
...
var getQueryFromSearch = function getQueryFromSearch(search, defaultQuery) {
  ...
  return (0, _predicate.isString)(query) ? _search_bar.OuiSearchBar.Query.parse(query) : query;
};
...
var getInitialPagination = function getInitialPagination(pagination) {
  ...
  if (!hidePerPageOptions && initialPageSize && (!pageSizeOptions || !pageSizeOptions.includes(initialPageSize))) {
    throw new Error("OuiInMemoryTable received initialPageSize ".concat(initialPageSize, ", which wasn't provided within pageSizeOptions."));
  }
...
var OuiInMemoryTable = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiInMemoryTable, _Component);

  var _super = _createSuper(OuiInMemoryTable);

  (0, _createClass2.default)(OuiInMemoryTable, null, [{
  ...
  function OuiInMemoryTable(props) {
    var _this;

    (0, _classCallCheck2.default)(this, OuiInMemoryTable);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onTableChange", function (_ref2) {
      ...
      var reportedSortName = sortName; // OuiBasicTable returns the column's `field` if it exists instead of `name`,
  ...
  (0, _createClass2.default)(OuiInMemoryTable, [{
    key: "setSelection",
    ...
    value: function renderSearchBar() {
      ...
      if (search) {
        ...
        return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_search_bar.OuiSearchBar, (0, _extends2.default)({
          onChange: this.onQueryChange
        }, searchBarProps)), /*#__PURE__*/_react.default.createElement(_spacer.OuiSpacer, {
          size: "l"
        }));
      }
    }
    ...
    value: function getItems() {
      ...
      var matchingItems = query ? _search_bar.OuiSearchBar.Query.execute(query, items, executeQueryOptions) : items;
    ...
    value: function render() {
      ...
      /*#__PURE__*/
      // @ts-ignore complex relationship between pagination's existence and criteria, the code logic ensures this is correctly maintained
      _react.default.createElement(_basic_table.OuiBasicTable, (0, _extends2.default)({
        ref: this.tableRef,
        items: items,
        itemId: itemId,
        rowProps: rowProps,
  ...
  return OuiInMemoryTable;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiInMemoryTable = OuiInMemoryTable;
(0, _defineProperty2.default)(OuiInMemoryTable, "defaultProps", {
  responsive: true,
  tableLayout: 'fixed'
});
OuiInMemoryTable.propTypes = {
