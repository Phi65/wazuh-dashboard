...
var _basic_table = require("../../eui_components/basic_table/basic_table");
...
var OuiBasicTable = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiBasicTable, _Component);

  var _super = _createSuper(OuiBasicTable);

  (0, _createClass2.default)(OuiBasicTable, null, [{
  ...
  function OuiBasicTable(props) {
    var _this;

    (0, _classCallCheck2.default)(this, OuiBasicTable);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderSelectAll", function (isMobile) {
      ...
      return /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
        ...
        return /*#__PURE__*/_react.default.createElement(_form.OuiCheckbox, {
  ...
  (0, _createClass2.default)(OuiBasicTable, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiBasicTable', {
    ...
    value: function renderTable() {
      ...
      var mobileHeader = responsive ? /*#__PURE__*/_react.default.createElement(_table.OuiTableHeaderMobile, null, /*#__PURE__*/_react.default.createElement(_flex.OuiFlexGroup, {
        responsive: false,
        justifyContent: "spaceBetween",
        alignItems: "baseline"
      }, /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, {
        grow: false
      }, this.renderSelectAll(true)), /*#__PURE__*/_react.default.createElement(_flex.OuiFlexItem, {
        grow: false
      ...
      return /*#__PURE__*/_react.default.createElement("div", null, mobileHeader, /*#__PURE__*/_react.default.createElement(_table.OuiTable, {
        id: this.tableId,
    ...
    value: function renderTableMobileSort() {
      ...
      return items.length ? /*#__PURE__*/_react.default.createElement(_table.OuiTableSortMobile, {
        items: items
      }) : null;
    }
  }, {
    ...
    value: function renderTableCaption() {
      ...
      if (tableCaption) {
        if (pagination) {
          captionElement = /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
      ...
      return /*#__PURE__*/_react.default.createElement(_accessibility.OuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("caption", {
        className: "ouiTableCaption"
      }, /*#__PURE__*/_react.default.createElement(_delay_render.OuiDelayRender, null, captionElement)));
    }
  }, {
    key: "renderTableHead",
    value: function renderTableHead() {
      ...
      if (selection) {
        headers.push( /*#__PURE__*/_react.default.createElement(_table.OuiTableHeaderCellCheckbox, {
      ...
      columns.forEach(function (column, index) {
        ...
        if (column.actions) {
          headers.push( /*#__PURE__*/_react.default.createElement(_table.OuiTableHeaderCell, {
        ...
        if (!column.field) {
          ...
          headers.push( /*#__PURE__*/_react.default.createElement(_table.OuiTableHeaderCell, (0, _extends2.default)({
      ...
      return /*#__PURE__*/_react.default.createElement(_table.OuiTableHeader, null, headers);
    }
  }, {
    ...
    value: function renderTableFooter() {
      ...
      if (selection) {
        ...
        footers.push( /*#__PURE__*/_react.default.createElement(_table.OuiTableFooterCell, {
      ...
      return footers.length && hasDefinedFooter ? /*#__PURE__*/_react.default.createElement(_table.OuiTableFooter, null, footers) : null;
    }
  }, {
    key: "renderTableBody",
    value: function renderTableBody() {
      ...
      return /*#__PURE__*/_react.default.createElement(_table.OuiTableBody, {
    ...
    value: function renderErrorBody(error) {
      ...
      return /*#__PURE__*/_react.default.createElement(_table.OuiTableBody, null, /*#__PURE__*/_react.default.createElement(_table.OuiTableRow, null, /*#__PURE__*/_react.default.createElement(_table.OuiTableRowCell, {
        align: "center",
        colSpan: colSpan,
    ...
    value: function renderItemRow(item, rowIndex) {
      ...
      var expandedRow = hasExpandedRow ? /*#__PURE__*/_react.default.createElement(_table.OuiTableRow, {
        id: expandedRowId,
        isExpandedRow: true,
        isSelectable: isSelectable
      }, /*#__PURE__*/_react.default.createElement(_table.OuiTableRowCell, {
      ...
      var row = /*#__PURE__*/_react.default.createElement(_table.OuiTableRow, (0, _extends2.default)({
      ...
      }, rowProps.onClick ? /*#__PURE__*/_react.default.createElement(_accessibility.OuiKeyboardAccessible, null, row) : row, expandedRow);
    }
  }, {
    ...
    value: function renderItemSelectionCell(itemId, item, selected) {
      ...
      return /*#__PURE__*/_react.default.createElement(_table.OuiTableRowCellCheckbox, {
        key: key
    ...
    value: function renderItemActionsCell(itemId, item, column, columnIndex) {
      ...
      return /*#__PURE__*/_react.default.createElement(_table.OuiTableRowCell, {
        showOnHover: true,
        key: key,
        align: "right",
        textOnly: false,
    ...
    value: function renderItemCell(item, column, key, content, setScopeRow) {
      ...
      return /*#__PURE__*/_react.default.createElement(_table.OuiTableRowCell, (0, _extends2.default)({
        key: key,
        align: columnAlign,
    ...
    value: function renderPaginationBar() {
      ...
      if (!error && pagination && pagination.totalItemCount > 0) {
        ...
        if (tableCaption) {
          ariaLabel = /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
  ...
  return OuiBasicTable;
}(_react.Component);
/* OUI -> EUI Aliases: Build-Time */


exports.OuiBasicTable = OuiBasicTable;
(0, _defineProperty2.default)(OuiBasicTable, "defaultProps", {
  responsive: true,
  tableLayout: 'fixed',
  noItemsMessage: 'No items found'
});
OuiBasicTable.propTypes = {
