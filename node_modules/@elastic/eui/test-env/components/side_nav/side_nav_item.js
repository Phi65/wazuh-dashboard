...
exports.OuiSideNavItem = OuiSideNavItem;
Object.defineProperty(exports, "EuiSideNavItem", {
  enumerable: true,
  get: function get() {
    return _side_nav_item.EuiSideNavItem;
  }
});
...
var _side_nav_item = require("../../eui_components/side_nav/side_nav_item");
...
function OuiSideNavItem(_ref2) {
  ...
  if (items && itemIsOpen) {
    childItems = /*#__PURE__*/_react.default.createElement("div", {
      className: "ouiSideNavItem__items"
    }, items);
  }
  ...
  if (icon) {
    buttonIcon = /*#__PURE__*/(0, _react.cloneElement)(icon, {
      className: (0, _classnames.default)('ouiSideNavItemButton__icon', icon.props.className)
    });
  }

  var classes = (0, _classnames.default)('ouiSideNavItem', {
  ...
  var buttonClasses = (0, _classnames.default)('ouiSideNavItemButton', {
  ...
  if (depth > 0 && childrenOnly) {
    caret = /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, {
  ...
  var buttonContent = /*#__PURE__*/_react.default.createElement("span", {
    className: "ouiSideNavItemButton__content"
  }, buttonIcon, /*#__PURE__*/_react.default.createElement(_inner_text.OuiInnerText, null, function (ref, innerText) {
    return /*#__PURE__*/_react.default.createElement("span", {
      ref: ref,
      title: truncate ? innerText : undefined,
      className: (0, _classnames.default)('ouiSideNavItemButton__label', {
