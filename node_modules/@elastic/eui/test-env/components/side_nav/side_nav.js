...
var _side_nav = require("../../eui_components/side_nav/side_nav");
...
var OuiSideNav = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(OuiSideNav, _Component);
  ...
  function OuiSideNav() {
    ...
    (0, _classCallCheck2.default)(this, OuiSideNav);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderTree", function (items) {
      ...
      return items.map(function (item) {
        ...
        return /*#__PURE__*/_react.default.createElement(_side_nav_item.OuiSideNavItem, (0, _extends2.default)({
          isOpen: isOpen,
  ...
  (0, _createClass2.default)(OuiSideNav, [{
    key: "render",
    value: function render() {
      ...
      var classes = (0, _classnames.default)('ouiSideNav', className, {
      ...
      var contentClasses = (0, _classnames.default)('ouiSideNav__content', mobileBreakpoints === null || mobileBreakpoints === void 0 ? void 0 : mobileBreakpoints.map(function (breakpointName) {
        return "ouiSideNav__contentMobile-".concat(breakpointName);
      }));
      var sideNavContentId = (0, _services.htmlIdGenerator)('ouiSideNavContent')();
      ...
      var sharedHeadingProps = {
        id: (headingProps === null || headingProps === void 0 ? void 0 : headingProps.id) || (0, _services.htmlIdGenerator)('ouiSideNavHeading')(),
      ...
      if (hasHeader) {
        ...
        if (headingScreenReaderOnly) {
          headingNode = /*#__PURE__*/_react.default.createElement(_accessibility.OuiScreenReaderOnly, null, headingNode);
        } else {
          headingNode = /*#__PURE__*/_react.default.createElement(_title.OuiTitle, (0, _extends2.default)({
            size: "xs"
          }, titleProps, {
            className: (0, _classnames.default)('ouiSideNav__heading', headingProps === null || headingProps === void 0 ? void 0 : headingProps.className)
      ...
      if (hasMobileVersion) {
        mobileNode = /*#__PURE__*/_react.default.createElement(_responsive.OuiShowFor, {
          sizes: breakpoints || 'none'
        }, /*#__PURE__*/_react.default.createElement("nav", (0, _extends2.default)({
          "aria-labelledby": sharedHeadingProps.id,
          className: classes
        }, rest), /*#__PURE__*/_react.default.createElement(HeadingElement, sharedHeadingProps, /*#__PURE__*/_react.default.createElement(_button.OuiButtonEmpty, {
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, mobileNode, /*#__PURE__*/_react.default.createElement(_responsive.OuiHideFor, {
        sizes: breakpoints || 'none'
      }, /*#__PURE__*/_react.default.createElement("nav", (0, _extends2.default)({
...
exports.OuiSideNav = OuiSideNav;
(0, _defineProperty2.default)(OuiSideNav, "defaultProps", {
  items: [],
