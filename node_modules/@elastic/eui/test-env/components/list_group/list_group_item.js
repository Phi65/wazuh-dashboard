...
exports.OuiListGroupItem = exports.COLORS = exports.SIZES = void 0;
...
var _list_group_item = require("../../eui_components/list_group/list_group_item");
...
var OuiListGroupItem = function OuiListGroupItem(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiListGroupItem', sizeToClassNameMap[size], colorToClassNameMap[color], {
  ...
  if (iconType) {
    iconNode = /*#__PURE__*/_react.default.createElement(_icon.OuiIcon, (0, _extends2.default)({
      color: "inherit" // forces the icon to inherit its parent color

    }, iconProps, {
      type: iconType,
      className: (0, _classnames.default)('ouiListGroupItem__icon', iconProps === null || iconProps === void 0 ? void 0 : iconProps.className)
    }));

    if (icon) {
      console.warn('Both `iconType` and `icon` were passed to OuiListGroupItem but only one can exist. The `iconType` was used.');
    }
  } else if (icon) {
    iconNode = /*#__PURE__*/_react.default.cloneElement(icon, {
      className: (0, _classnames.default)('ouiListGroupItem__icon', icon.props.className)
    });
  }
  ...
  if (extraAction) {
    ...
    var extraActionClasses = (0, _classnames.default)('ouiListGroupItem__extraAction', {
      'ouiListGroupItem__extraAction-alwaysShow': alwaysShow
    }, _className);
    extraActionNode = /*#__PURE__*/_react.default.createElement(_button.OuiButtonIcon, (0, _extends2.default)({
  ...
  if (href && !isDisabled) {
    ...
    itemContent = /*#__PURE__*/_react.default.createElement("span", (0, _extends2.default)({
      className: "ouiListGroupItem__text"
    }, rest), iconNode, labelContent);
  }
  ...
  if (showToolTip) {
    itemContent = /*#__PURE__*/_react.default.createElement("li", {
      className: classes
    }, /*#__PURE__*/_react.default.createElement(_tool_tip.OuiToolTip, {
...
exports.OuiListGroupItem = OuiListGroupItem;
OuiListGroupItem.propTypes = {
