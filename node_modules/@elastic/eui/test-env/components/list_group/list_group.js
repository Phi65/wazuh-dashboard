...
exports.OuiListGroup = exports.GUTTER_SIZES = void 0;
...
var _list_group = require("../../eui_components/list_group/list_group");
...
var OuiListGroup = function OuiListGroup(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiListGroup', {
  ...
  if (listItems) {
    childrenOrListItems = listItems.map(function (item, index) {
      return [/*#__PURE__*/_react.default.createElement(_list_group_item.OuiListGroupItem, (0, _extends2.default)({
...
exports.OuiListGroup = OuiListGroup;
OuiListGroup.propTypes = {
