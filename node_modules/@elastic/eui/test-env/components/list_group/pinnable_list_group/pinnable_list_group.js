...
var OuiPinnableListGroup = function OuiPinnableListGroup(_ref) {
  ...
  var classes = (0, _classnames.default)('ouiPinnableListGroup', className); // Alter listItems object with extra props
  ...
  var getNewListItems = function getNewListItems(pinExtraActionLabel, pinnedExtraActionLabel) {
    return listItems.map(function (item) {
      ...
      itemProps.className = (0, _classnames.default)('ouiPinnableListGroup__item', item.className); // Add the pinning action unless the item has it's own extra action
  ...
  return /*#__PURE__*/_react.default.createElement(_i18n.OuiI18n, {
    ...
    return /*#__PURE__*/_react.default.createElement(_list_group.OuiListGroup, (0, _extends2.default)({
      className: classes,
