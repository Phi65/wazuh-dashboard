 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiBasicTable-loading{position:relative}.euiBasicTable-loading tbody{overflow:hidden}.euiBasicTable-loading tbody:before{position:absolute;content:"";width:100%;height:2px;background-color:#36a2ef;-webkit-animation:euiBasicTableLoading 1s linear;animation:euiBasicTableLoading 1s linear;-webkit-animation-iteration-count:infinite;animation-iteration-count:infinite}@-webkit-keyframes euiBasicTableLoading{0%{left:0;width:0}20%{left:0;width:40%}80%{left:60%;width:40%}to{left:100%;width:0}}@keyframes euiBasicTableLoading{0%{left:0;width:0}20%{left:0;width:40%}80%{left:60%;width:40%}to{left:100%;width:0}}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiCheckableCard{transition:border-color .25s ease-in}.euiCheckableCard:not(.euiCheckableCard-isDisabled).euiCheckableCard-isChecked{border-color:#36a2ef}.euiCheckableCard__label{cursor:pointer;display:block;width:calc(100% + 32px);padding:16px;margin:-16px}.euiCheckableCard__label-isDisabled{color:#535966;cursor:not-allowed}.euiCheckableCard__children{margin-top:16px}
/*!
 * SPDX-License-Identifier: Apache-2.0
 *
 * The OpenSearch Contributors require contributions made to
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiColorPickerSwatch{display:inline-block;height:24px;width:24px;border-radius:3px;cursor:pointer;border:1px solid hsla(0,0%,100%,.1);box-shadow:inset 0 0 0 1px rgba(29,30,36,.05)}.euiColorPickerSwatch:focus{outline:2px solid currentColor}.euiColorPickerSwatch:focus:focus-visible{outline-style:auto}.euiColorPickerSwatch:focus:not(:focus-visible){outline:none}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiComboBoxTitle{font-size:12px;padding:11px 8px 4px;width:100%;font-weight:700;color:#fff}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiDataGridColumnSorting__item-isDragging{box-shadow:0 1px 5px rgba(0,0,0,.25),0 3.6px 13px rgba(0,0,0,.175),0 8.4px 23px rgba(0,0,0,.15),0 23px 35px rgba(0,0,0,.125);background:#1d1e24}.euiDataGridColumnSortingPopover{-webkit-transform:none!important;transform:none!important;transition:none!important;margin-top:-8px;min-width:192px}.euiDataGridColumnSorting__fieldList{scrollbar-width:thin;height:100%;overflow-y:auto;overflow-x:hidden;-webkit-mask-image:linear-gradient(180deg,rgba(255,0,0,.1) 0,red 7.5px,red calc(100% - 7.5px),rgba(255,0,0,.1));mask-image:linear-gradient(180deg,rgba(255,0,0,.1) 0,red 7.5px,red calc(100% - 7.5px),rgba(255,0,0,.1));padding-top:4px;padding-bottom:4px;max-height:300px}.euiDataGridColumnSorting__fieldList::-webkit-scrollbar{width:16px;height:16px}.euiDataGridColumnSorting__fieldList::-webkit-scrollbar-thumb{background-color:rgba(152,162,179,.5);border:6px solid transparent;background-clip:content-box}.euiDataGridColumnSorting__fieldList::-webkit-scrollbar-corner,.euiDataGridColumnSorting__fieldList::-webkit-scrollbar-track{background-color:transparent}.euiDataGridColumnSorting__fieldList:focus{outline:none}.euiDataGridColumnSorting__fieldList[tabindex="0"]:focus:focus-visible{outline-style:auto}.euiDataGridColumnSorting__field{display:block;padding:4px 8px;width:100%;outline-offset:-2px}.euiDataGridColumnSorting__field:focus,.euiDataGridColumnSorting__field:hover{cursor:pointer;text-decoration:underline}.euiDataGridColumnSorting__field:focus{background-color:rgba(54,162,239,.3)}.euiDataGridColumnSorting__field:disabled{cursor:not-allowed;text-decoration:none;color:#515761}.euiDataGridColumnSorting__orderButtons{padding-left:24px}@media only screen and (max-width:574px){.euiDataGridColumnSorting__orderButtons{padding-left:4px}}@media only screen and (min-width:575px) and (max-width:767px){.euiDataGridColumnSorting__orderButtons{padding-left:4px}}.euiDataGridColumnSorting__orderButtons .euiDataGridColumnSorting__order{min-width:200px;border:none}@media only screen and (max-width:574px){.euiDataGridColumnSorting__orderButtons .euiDataGridColumnSorting__order{min-width:unset}}@media only screen and (min-width:575px) and (max-width:767px){.euiDataGridColumnSorting__orderButtons .euiDataGridColumnSorting__order{min-width:unset}}.euiDataGridColumnSorting__orderButtons .euiDataGridColumnSorting__order button{font-size:12px!important}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiErrorBoundary{background:repeating-linear-gradient(45deg,rgba(248,107,99,.25),rgba(248,107,99,.25) 1px,rgba(248,107,99,.05) 0,rgba(248,107,99,.05) 20px);overflow:auto;padding:16px}.euiErrorBoundary__text{background-color:#1d1e24;padding:8px}.euiErrorBoundary__stack{white-space:pre-wrap}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiFlyoutFooter{background:#25262e}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiFlyoutFooter,.euiFlyoutHeader{-webkit-flex-grow:0;flex-grow:0}.euiFlyoutHeader--hasBorder{border-bottom:1px solid #343741}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiFormControlLayoutIcons{pointer-events:none;position:absolute;top:0;bottom:0;left:12px;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center}.euiFormControlLayoutIcons>*+*{margin-left:6px}.euiFormControlLayout--compressed .euiFormControlLayoutIcons{left:8px}.euiFormControlLayoutIcons--right{left:auto;right:12px}.euiFormControlLayout--compressed .euiFormControlLayoutIcons--right{left:auto;right:8px}:disabled+.euiFormControlLayoutIcons{cursor:not-allowed;color:#535966}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiFormErrorText{padding-top:4px;color:#f86b63}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiFormErrorText,.euiFormLegend{font-size:12px;font-size:.85714rem;line-height:1.14286rem}.euiFormLegend{color:#dfe5ef;font-weight:600}.euiFormLegend:not(.euiFormLegend-isHidden){margin-bottom:8px}.euiFormLegend:not(.euiFormLegend-isHidden).euiFormLegend--compressed{margin-bottom:4px}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiFormHelpText{padding-top:4px;color:#98a2b3}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiRangeHighlight{position:absolute;left:0;width:100%;top:calc(50% - 3px);overflow:hidden}.euiRangeHighlight__progress{height:6px;border-radius:6px;background-color:#343741}.euiRangeHighlight--hasTicks{top:7px}.euiRangeHighlight--hasTicks.euiRangeHighlight--compressed{top:5px}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiRangeThumb{background:#1d1e24 no-repeat 50%;border-radius:14px;transition:background-color .15s ease-in,border-color .15s ease-in;cursor:pointer;padding:0;height:16px;width:16px;box-sizing:border-box;content:"";position:absolute;left:0;top:50%;margin-top:-8px;z-index:1}.euiRangeThumb:focus{outline:2px solid currentColor;outline-offset:2px;border-color:#36a2ef}.euiRangeThumb:focus:focus-visible{outline-style:auto}.euiRangeThumb:focus:not(:focus-visible){outline:none}.euiRangeThumb--hasTicks{top:25%}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiHeaderSectionItem{position:relative;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center}.euiHeaderSectionItem:after{position:absolute;content:"";top:16px;bottom:0;background:#343741;left:0}.euiHeaderSectionItem--borderLeft:after{left:0;width:1px}.euiHeaderSectionItem--borderRight:after{width:1px;left:auto;right:0}@media only screen and (max-width:574px){.euiHeaderSectionItem{min-width:30px}.euiHeaderSectionItem--borderLeft:after,.euiHeaderSectionItem--borderRight:after{display:none}}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiIcon{-webkit-flex-shrink:0;flex-shrink:0;display:inline-block;vertical-align:middle;fill:currentColor;-webkit-transform:translate(0);transform:translate(0)}.euiIcon:focus{opacity:1;background:rgba(54,162,239,.3)}.euiIcon--app{fill:#dfe5ef}.euiIcon--app .euiIcon__fillSecondary{fill:#7dded8}.euiIcon-isLoading{opacity:.05;background-color:currentColor;border-radius:6px}.euiIcon-isLoaded{-webkit-animation:euiIconLoading .25s ease-in 0s 1 forwards;animation:euiIconLoading .25s ease-in 0s 1 forwards}.euiIcon--accent{color:#f68fbe}.euiIcon--danger{color:#f86b63}.euiIcon--ghost{color:#fff}.euiIcon--primary{color:#36a2ef}.euiIcon--secondary,.euiIcon--success{color:#7dded8}.euiIcon--subdued{color:#7a7f89}.euiIcon--text{color:#dfe5ef}.euiIcon--warning{color:#f3d371}.euiIcon--inherit{color:inherit}.euiIcon--customColor,.euiIcon--customColor .euiIcon__fillSecondary,.euiIcon--primary,.euiIcon--primary .euiIcon__fillSecondary,.euiIcon--subdued,.euiIcon--subdued .euiIcon__fillSecondary,.euiIcon--text,.euiIcon--text .euiIcon__fillSecondary{fill:currentColor}.euiIcon__fillNegative{fill:#d4dae5}.euiIcon--small{width:12px;height:12px}.euiIcon--medium{width:16px;height:16px}.euiIcon--large{width:24px;height:24px}.euiIcon--xLarge{width:32px;height:32px}.euiIcon--xxLarge{width:40px;height:40px}@-webkit-keyframes euiIconLoading{0%{opacity:.05}to{opacity:1}}@keyframes euiIconLoading{0%{opacity:.05}to{opacity:1}}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiPinnableListGroup__itemExtraAction svg{-webkit-transform:rotate(45deg);transform:rotate(45deg)}.euiPinnableListGroup__itemExtraAction-pinned:not(:hover):not(:focus){color:#62656d}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiLoadingSpinner{-webkit-flex-shrink:0;flex-shrink:0;display:inline-block;width:32px;height:32px;border-radius:50%;border:2px solid #343741;border-top-color:#36a2ef}@media screen and (prefers-reduced-motion:no-preference){.euiLoadingSpinner{-webkit-animation:euiLoadingSpinner .6s linear infinite;animation:euiLoadingSpinner .6s linear infinite}}.euiLoadingSpinner--small{width:8px;height:8px;border-width:1px}.euiLoadingSpinner--medium{width:16px;height:16px;border-width:1px}.euiLoadingSpinner--large{width:24px;height:24px}.euiLoadingSpinner--xLarge{width:32px;height:32px}@-webkit-keyframes euiLoadingSpinner{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(359deg);transform:rotate(359deg)}}@keyframes euiLoadingSpinner{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(359deg);transform:rotate(359deg)}}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiMarkdownEditorFooter{display:-webkit-inline-flex;display:inline-flex;padding:4px;border:1px solid #343741;-webkit-align-items:center;align-items:center;background:#141519}.euiMarkdownEditorFooter__popover{width:300px}.euiMarkdownEditorFooter__actions{-webkit-flex:1;flex:1;display:-webkit-inline-flex;display:inline-flex}.euiMarkdownEditorFooter__actions>button,.euiMarkdownEditorFooter__actions>span{margin-right:4px;-webkit-align-self:center;align-self:center}.euiMarkdownEditorFooter__actions .euiMarkdownEditorFooter__uploadError{position:relative;left:-1px;line-height:1;border-radius:6px}.euiMarkdownEditorFooter__actions .euiMarkdownEditorFooter__uploadError>span{padding:0 4px}.euiMarkdownEditorFooter__help{justify-self:flex-end}.euiMarkdownEditorFooter__help>svg{width:26px}.euiMarkdownEditorFooter__errors>svg{color:#7a7f89}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiMarkdownEditorPreview{scrollbar-width:thin;background:#1d1e24;min-height:"150px";overflow-y:auto;border:1px solid #343741;padding:12px}.euiMarkdownEditorPreview::-webkit-scrollbar{width:16px;height:16px}.euiMarkdownEditorPreview::-webkit-scrollbar-thumb{background-color:rgba(152,162,179,.5);border:6px solid transparent;background-clip:content-box}.euiMarkdownEditorPreview::-webkit-scrollbar-corner,.euiMarkdownEditorPreview::-webkit-scrollbar-track{background-color:transparent}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiMarkdownEditorToolbar{display:-webkit-flex;display:flex;-webkit-flex-wrap:wrap;flex-wrap:wrap;background:#25262e;border:1px solid #343741;border-bottom:none;padding:4px}.euiMarkdownEditorToolbar__buttons{display:-webkit-flex;display:flex;-webkit-flex-wrap:wrap;flex-wrap:wrap;-webkit-flex:1;flex:1;-webkit-align-items:center;align-items:center}.euiMarkdownEditorToolbar__buttons>*{margin-right:4px}.euiMarkdownEditorToolbar__divider{content:"";height:24px;display:block;margin-left:4px;padding-right:4px;border-left:1px solid #343741}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiMark{background-color:transparent;font-weight:700;color:#dfe5ef}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiNotificationEvent{display:-webkit-flex;display:flex;padding:12px 0 12px 12px;border-bottom:1px solid #343741}.euiNotificationEvent:last-child{border-bottom:none}.euiNotificationEvent--withReadState{padding:12px 0 12px 8px}.euiNotificationEvent__title{color:#dfe5ef;font-size:16px;font-size:1.14286rem;line-height:1.71429rem;font-weight:700;display:-webkit-flex;display:flex}.euiNotificationEvent__title.euiLink{color:#36a2ef}.euiNotificationEvent__title--isRead{color:#98a2b3!important}.euiNotificationEvent__readButton{margin-right:8px}.euiNotificationEvent__content{-webkit-flex:1;flex:1}.euiNotificationEvent__content>*+*{margin-top:8px;margin-right:12px}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiNotificationEventMeta{position:relative;display:-webkit-flex;display:flex;-webkit-flex-direction:row;flex-direction:row;-webkit-justify-content:space-between;justify-content:space-between;-webkit-align-items:center;align-items:center;-webkit-flex-wrap:wrap;flex-wrap:wrap;margin-right:4px;min-height:24px}.euiNotificationEventMeta--hasContextMenu{padding-right:24px}.euiNotificationEventMeta__contextMenuWrapper{position:absolute;top:0;right:0}.euiNotificationEventMeta__section{margin-right:8px}.euiNotificationEventMeta__section:first-child{display:-webkit-flex;display:flex;-webkit-flex:1;flex:1;-webkit-align-items:center;align-items:center}.euiNotificationEventMeta__icon{margin-right:8px}.euiNotificationEventMeta__badge{max-width:100%;display:inline-grid}.euiNotificationEventMeta__time{font-size:12px;color:#7a7f89}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiNotificationEventMessages{font-size:14px}.euiNotificationEventMessages__accordion{color:#98a2b3}.euiNotificationEventMessages__accordionButton{color:#36a2ef}.euiNotificationEventMessages__accordionContent>*{padding-top:8px}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiNotificationEventReadButton--isRead svg{fill:transparent;stroke-width:1px;stroke:#343741}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiNotificationEventReadIcon{display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;height:24px;margin:0 4px}.euiNotificationEventReadIcon--isRead svg{fill:transparent;stroke-width:1px;stroke:#343741}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiPanel{-webkit-flex-grow:1;flex-grow:1}.euiPanel.euiPanel--flexGrowZero{-webkit-flex-grow:0;flex-grow:0}.euiPanel.euiPanel--hasShadow{box-shadow:0 .9px 4px -1px rgba(0,0,0,.2),0 2.6px 8px -1px rgba(0,0,0,.15),0 5.7px 12px -1px rgba(0,0,0,.125),0 15px 15px -1px rgba(0,0,0,.1)}.euiPanel.euiPanel--hasBorder{border:1px solid #343741;box-shadow:none}.euiPanel.euiPanel--isClickable{transition:all .15s cubic-bezier(.694,.0482,.335,1)}.euiPanel.euiPanel--isClickable:enabled{display:block;width:100%;text-align:left}.euiPanel.euiPanel--isClickable:focus,.euiPanel.euiPanel--isClickable:hover{box-shadow:0 1px 5px rgba(0,0,0,.25),0 3.6px 13px rgba(0,0,0,.175),0 8.4px 23px rgba(0,0,0,.15),0 23px 35px rgba(0,0,0,.125);-webkit-transform:translateY(-2px);transform:translateY(-2px);cursor:pointer}.euiPanel.euiPanel--borderRadiusNone{border-radius:0}.euiPanel.euiPanel--borderRadiusMedium{border-radius:6px}.euiPanel.euiPanel--transparent{background-color:transparent}.euiPanel.euiPanel--plain{background-color:#1d1e24}.euiPanel.euiPanel--subdued{background-color:#141519}.euiPanel.euiPanel--accent{background-color:#4a2b39}.euiPanel.euiPanel--primary{background-color:#103148}.euiPanel.euiPanel--success{background-color:#264341}.euiPanel.euiPanel--warning{background-color:#493f22}.euiPanel.euiPanel--danger{background-color:#4a201e}.euiPanel--paddingSmall{padding:8px}.euiPanel--paddingMedium{padding:16px}.euiPanel--paddingLarge{padding:24px}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiSelectableMessage{padding:8px;text-align:center;word-wrap:break-word;display:-webkit-flex;display:flex;-webkit-justify-content:center;justify-content:center;-webkit-align-items:center;align-items:center}.euiSelectableMessage--bordered{overflow:hidden;border:1px solid #343741;border-radius:6px}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiSubSteps{padding:16px;background-color:#25262e;margin-bottom:16px}.euiSubSteps>:last-child{margin-bottom:0}.euiSubSteps ol,.euiText .euiSubSteps ol{list-style-type:lower-alpha}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiTextDiff del{color:#f86b63}.euiTextDiff ins{color:#7dded8}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiTour--minWidth-default{min-width:240px}.euiTourHeader{border-bottom:none;margin-bottom:8px!important}.euiTourHeader .euiTourHeader__title{margin-top:0}.euiTourHeader__subtitle{color:#98a2b3}.euiTourFooter{background-color:#25262e;margin-top:24px!important}.euiTour .euiTour__beacon{pointer-events:none;position:absolute;opacity:0;transition:opacity 0s .35s}.euiTour .euiPopover__panelArrow.euiPopover__panelArrow--right .euiTour__beacon{opacity:1;top:6px;left:-24px}.euiTour .euiPopover__panelArrow.euiPopover__panelArrow--left .euiTour__beacon{opacity:1;top:6px;left:12px}.euiTour .euiPopover__panelArrow.euiPopover__panelArrow--top:after{border-top-color:#25262e}.euiTour .euiPopover__panelArrow.euiPopover__panelArrow--top .euiTour__beacon{opacity:1;top:12px;left:6px}.euiTour .euiPopover__panelArrow.euiPopover__panelArrow--bottom .euiTour__beacon{opacity:1;top:-24px;left:6px}
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiTextColor--default{color:#dfe5ef}.euiTextColor--subdued{color:#878b95}.euiTextColor--secondary,.euiTextColor--success{color:#7dded8}.euiTextColor--accent{color:#f68fbe}.euiTextColor--warning{color:#f3d371}.euiTextColor--danger{color:#f86b63}.euiTextColor--ghost{color:#fff;color:#fff!important}
/*!
 * SPDX-License-Identifier: Apache-2.0
 *
 * The OpenSearch Contributors require contributions made to
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiCodeBlock.euiCodeBlock--inline{border-radius:4px;color:#a184c2}.euiCodeBlock.euiCodeBlock--inline .euiCodeBlock__code{font-weight:700}
/*!
 * SPDX-License-Identifier: Apache-2.0
 *
 * The OpenSearch Contributors require contributions made to
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiMark{background:rgba(54,162,239,.3)}
/*!
 * SPDX-License-Identifier: Apache-2.0
 *
 * The OpenSearch Contributors require contributions made to
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiRangeHighlight{z-index:1;pointer-events:none}.euiRangeHighlight__progress{background-color:#98a2b3;border-color:#98a2b3}.euiRangeHighlight__progress--hasFocus{background-color:#36a2ef}.euiRangeHighlight--compressed{top:calc(50% - 2px)}.euiRangeHighlight--compressed .euiRangeHighlight__progress{height:4px}.euiRangeHighlight--compressed.euiRangeHighlight--hasTicks{top:6px}.euiRangeHighlight:not(.euiRangeHighlight--compressed).euiRangeHighlight--hasTicks{top:5px}
/*!
 * SPDX-License-Identifier: Apache-2.0
 *
 * The OpenSearch Contributors require contributions made to
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiRangeSlider:disabled~.euiRangeThumb,.euiRangeThumb{background-color:#98a2b3}.euiRangeThumb{box-shadow:0 0 0 1px #1d1e24,0 2px 2px -1px rgba(0,0,0,.2),0 1px 5px -2px rgba(0,0,0,.2);border:2px solid #1d1e24;z-index:2;pointer-events:none}.euiRangeThumb--hasTicks{top:0;margin-top:0}.euiRangeThumb:focus{border:2px solid #1d1e24;box-shadow:0 0 0 2px #36a2ef;background-color:#36a2ef;outline:none}.euiRangeThumb:focus:focus-visible{outline:none}
/*!
 * SPDX-License-Identifier: Apache-2.0
 *
 * The OpenSearch Contributors require contributions made to
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiRangeTicks:not(.euiRangeTicks--compressed) .euiRangeTick{padding-top:0}.euiRangeTicks:not(.euiRangeTicks--compressed) .euiRangeTick:not(.euiRangeTick--hasTickMark):before,.euiRangeTicks:not(.euiRangeTicks--compressed) .euiRangeTick__pseudo{width:4px;height:6px;background-color:#343741;border-radius:4px}.euiRangeTicks--compressed .euiRangeTick{padding-top:14px}.euiRangeTick:before,.euiRangeTicks--compressed .euiRangeTick .euiRangeTick__pseudo,.euiRangeTicks--compressed .euiRangeTick:before{background-color:#343741;border-radius:4px}.euiRangeTick--selected,.euiRangeTick:enabled:hover,.euiRangeTick:focus{color:#36a2ef}.euiRangeTick--selected{font-weight:500}
/*!
 * SPDX-License-Identifier: Apache-2.0
 *
 * The OpenSearch Contributors require contributions made to
 ...
 * Modifications Copyright OpenSearch Contributors. See
 * GitHub history for details.
 */.euiToast{border:none;border-radius:6px}.euiToast--primary{border-top:2px solid #36a2ef}.euiToast--success{border-top:2px solid #7dded8}.euiToast--warning{border-top:2px solid #f3d371}.euiToast--danger{border-top:2px solid #f86b63}.euiToastHeader__title{font-weight:700}
/*!
 * SPDX-License-Identifier: Apache-2.0
 *
 * The OpenSearch Contributors require contributions made to
