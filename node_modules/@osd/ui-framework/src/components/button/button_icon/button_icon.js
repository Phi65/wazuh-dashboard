...
var KuiButtonIcon = function KuiButtonIcon(props) {
  ...
  var iconClasses = classNames('kuiButton__icon kuiIcon', props.className, _defineProperty({}, typeToClassNameMap[props.type], props.type)); // Purely decorative icons should be hidden from screen readers. Button icons are purely
